...
.lbl_C3007A
	...
	jsl.l CODE_C30142                    ;C3008D|224201C3|C30142;  
	lda.b #$56                           ;C30091|A956    |      ;  
	sta.b $00                            ;C30093|8500    |000000;  
	lda.b #$6F                           ;C30095|A96F    |      ;  
	sta.b w0001                            ;C30097|8501    |000001;  
	jsl.l CODE_C30142                    ;C30099|224201C3|C30142;  
	lda.b #$7C                           ;C3009D|A97C    |      ;  
	sta.b $00                            ;C3009F|8500    |000000;  
	lda.b #$86                           ;C300A1|A986    |      ;  
	sta.b w0001                            ;C300A3|8501    |000001;  
	jsl.l CODE_C30142                    ;C300A5|224201C3|C30142;  
	lda.b #$93                           ;C300A9|A993    |      ;  
	sta.b $00                            ;C300AB|8500    |000000;  
	lda.b #$A1                           ;C300AD|A9A1    |      ;  
	sta.b w0001                            ;C300AF|8501    |000001;  
	jsl.l CODE_C30142                    ;C300B1|224201C3|C30142;  
	lda.b #$B4                           ;C300B5|A9B4    |      ;  
	sta.b $00                            ;C300B7|8500    |000000;  
...
CODE_C300D2:
	php                                  ;C300D2|08      |      ;  
	sep #$30                             ;C300D3|E230    |      ;  
	jsl.l CODE_C627E6                    ;C300D5|22E627C6|C627E6;  
	lda.b $00                            ;C300D9|A500    |000000;  
...
.lbl_C3014E
	...
	phy                                  ;C30154|5A      |      ;  
	jsl.l CODE_C3F69F                    ;C30155|229FF6C3|C3F69F;  
	ply                                  ;C30159|7A      |      ;  
	ldx.b $00                            ;C3015A|A600    |000000;  
	lda.w $90F2,y                        ;C3015C|B9F290  |7E90F2;  
	sta.b $00                            ;C3015F|8500    |000000;  
	lda.w $90F2,x                        ;C30161|BDF290  |7E90F2;  
	sta.w $90F2,y                        ;C30164|99F290  |7E90F2;  
	lda.b $00                            ;C30167|A500    |000000;  
...
CODE_C3035D:
	php                                  ;C3035D|08      |      ;  
	sep #$30                             ;C3035E|E230    |      ;  
	ldx.b $00                            ;C30360|A600    |000000;  
	lda.l DATA8_C3438B,x                 ;C30362|BF8B43C3|C3438B;  
	sta.b $00                            ;C30366|8500    |000000;  
...
.lbl_C3040E
	...
	jsl.l CODE_C30295                    ;C30414|229502C3|C30295;  
	plp                                  ;C30418|28      |      ;  
	rtl                                  ;C30419|6B      |      ;  
...
CODE_C304B4:
	...
	sep #$20                             ;C304B5|E220    |      ;  
	rep #$10                             ;C304B7|C210    |      ;  
	jsl.l CODE_C627E6                    ;C304B9|22E627C6|C627E6;  
...
CODE_C3050C:
	php                                  ;C3050C|08      |      ;  
	sep #$30                             ;C3050D|E230    |      ;  
	ldy.b $00                            ;C3050F|A400    |000000;  
	jsl.l CODE_C627E6                    ;C30511|22E627C6|C627E6;  
...
CODE_C305F3:
	...
	pha                                  ;C305FB|48      |      ;  
	jsl.l CODE_C3F683                    ;C305FC|2283F6C3|C3F683;  
	ldx.b $00                            ;C30600|A600    |000000;  
	sep #$20                             ;C30602|E220    |      ;  
	lda.b w0001,s                          ;C30604|A301    |000001;  
	sta.b w0001                            ;C30606|8501    |000001;  
	jsl.l CODE_C3E3CB                    ;C30608|22CBE3C3|C3E3CB;  
	lda.b w0001                            ;C3060C|A501    |000001;  
	sta.b w0001,s                          ;C3060E|8301    |000001;  
	stx.b $00                            ;C30610|8600    |000000;  
	lda.b $02,s                          ;C30612|A302    |000002;  
	sta.b w0001                            ;C30614|8501    |000001;  
	jsl.l CODE_C3E3CB                    ;C30616|22CBE3C3|C3E3CB;  
	lda.b #$00                           ;C3061A|A900    |      ;  
	sta.b $02,s                          ;C3061C|8302    |000002;  
	rep #$20                             ;C3061E|C220    |      ;  
	pla                                  ;C30620|68      |      ;  
	clc                                  ;C30621|18      |      ;  
	adc.b $00                            ;C30622|6500    |000000;  
	sta.b w0001                            ;C30624|8501    |000001;  
	ldx.b #$E5                           ;C30626|A2E5    |      ;  
	stx.b $00                            ;C30628|8600    |000000;  
	jsl.l CODE_C30295                    ;C3062A|229502C3|C30295;  
	plp                                  ;C3062E|28      |      ;  
	rtl                                  ;C3062F|6B      |      ;  
...
CODE_C30630:
	php                                  ;C30630|08      |      ;  
	sep #$30                             ;C30631|E230    |      ;  
	jsl.l CODE_C305F3                    ;C30633|22F305C3|C305F3;  
	ldx.b $00                            ;C30637|A600    |000000;  
...
CODE_C306C9:
	php                                  ;C306C9|08      |      ;  
	sep #$30                             ;C306CA|E230    |      ;  
	ldx.b $00                            ;C306CC|A600    |000000;  
	lda.l $7E8B8C,x                      ;C306CE|BF8C8B7E|7E8B8C;  
	sta.b $00                            ;C306D2|8500    |000000;  
...
CODE_C30710:
	...
	sta.b $07                            ;C30726|8507    |000007;  
	ldx.w $8B8C,y                        ;C30728|BE8C8B  |7E8B8C;  
	stx.b w0001                            ;C3072B|8601    |000001;  
	stx.b $05                            ;C3072D|8605    |000005;  
	cpx.b #$E7                           ;C3072F|E0E7    |      ;  
	beq UNREACH_C30773                   ;C30731|F040    |C30773;  
...
.lbl_C30837
	...
	sta.b $00                            ;C30883|8500    |000000;  
	pha                                  ;C30885|48      |      ;  
	lda.w $8D0C,y                        ;C30886|B90C8D  |7E8D0C;  
	sta.b w0001                            ;C30889|8501    |000001;  
	jsl.l CODE_C2414A                    ;C3088B|224A41C2|C2414A;  
	pla                                  ;C3088F|68      |      ;  
	cmp.b #$1A                           ;C30890|C91A    |      ;  
	beq UNREACH_C3089F                   ;C30892|F00B    |C3089F;  
	lda.b #$64                           ;C30894|A964    |      ;  
	sta.b $00                            ;C30896|8500    |000000;  
	stz.b w0001                            ;C30898|6401    |000001;  
	jsl.l CODE_C233BE                    ;C3089A|22BE33C2|C233BE;  
	rts                                  ;C3089E|60      |      ;  
...
CODE_C30AE5:
	...
	phy                                  ;C30B02|5A      |      ;  
	phb                                  ;C30B03|8B      |      ;  
	jsl.l CODE_C23C02                    ;C30B04|22023CC2|C23C02;  
	plb                                  ;C30B08|AB      |      ;  
	ply                                  ;C30B09|7A      |      ;  
	plx                                  ;C30B0A|FA      |      ;  
...
.lbl_C30B0D
	...
	phy                                  ;C30B14|5A      |      ;  
	phb                                  ;C30B15|8B      |      ;  
	jsl.l CODE_C23C10                    ;C30B16|22103CC2|C23C10;  
	plb                                  ;C30B1A|AB      |      ;  
	ply                                  ;C30B1B|7A      |      ;  
	plx                                  ;C30B1C|FA      |      ;  
...
.lbl_C30B1F
	...
	phy                                  ;C30B26|5A      |      ;  
	phb                                  ;C30B27|8B      |      ;  
	jsl.l CODE_C23C09                    ;C30B28|22093CC2|C23C09;  
	plb                                  ;C30B2C|AB      |      ;  
	ply                                  ;C30B2D|7A      |      ;  
	plx                                  ;C30B2E|FA      |      ;  
...
.lbl_C30C1D
	...
	lda.b $03,s                          ;C30C26|A303    |000003;  
	sta.b $00                            ;C30C28|8500    |000000;  
	...
	phy                                  ;C30C34|5A      |      ;  
	phb                                  ;C30C35|8B      |      ;  
	jsl.l CODE_C32FEE                    ;C30C36|22EE2FC3|C32FEE;  
	plb                                  ;C30C3A|AB      |      ;  
	ply                                  ;C30C3B|7A      |      ;  
	...
	phy                                  ;C30C5B|5A      |      ;  
	phb                                  ;C30C5C|8B      |      ;  
	jsl.l CODE_C626CA                    ;C30C5D|22CA26C6|C626CA;  
	plb                                  ;C30C61|AB      |      ;  
	ply                                  ;C30C62|7A      |      ;  
	pla                                  ;C30C63|68      |      ;  
...
.lbl_C30CCE
	...
	phb                                  ;C30CCF|8B      |      ;  
	phy                                  ;C30CD0|5A      |      ;  
	sta.b $00                            ;C30CD1|8500    |000000;  
	pha                                  ;C30CD3|48      |      ;  
	jsl.l CODE_C27FAA                    ;C30CD4|22AA7FC2|C27FAA;  
...
.lbl_C30D55
	...
	phy                                  ;C30D58|5A      |      ;  
	phb                                  ;C30D59|8B      |      ;  
	jsl.l CODE_C30710                    ;C30D5A|221007C3|C30710;  
	plb                                  ;C30D5E|AB      |      ;  
	ply                                  ;C30D5F|7A      |      ;  
	plx                                  ;C30D60|FA      |      ;  
...
.lbl_C30D73
	...
	phy                                  ;C30D96|5A      |      ;  
	phb                                  ;C30D97|8B      |      ;  
	jsl.l CODE_C62565                    ;C30D98|226525C6|C62565;  
	plb                                  ;C30D9C|AB      |      ;  
	ply                                  ;C30D9D|7A      |      ;  
	plx                                  ;C30D9E|FA      |      ;  
	lda.b #$32                           ;C30D9F|A932    |      ;  
	sta.b $00                            ;C30DA1|8500    |000000;  
	stz.b w0001                            ;C30DA3|6401    |000001;  
	phx                                  ;C30DA5|DA      |      ;  
	phy                                  ;C30DA6|5A      |      ;  
	phb                                  ;C30DA7|8B      |      ;  
	jsl.l CODE_C233BE                    ;C30DA8|22BE33C2|C233BE;  
	plb                                  ;C30DAC|AB      |      ;  
	ply                                  ;C30DAD|7A      |      ;  
	plx                                  ;C30DAE|FA      |      ;  
...
.lbl_C30DB1
	...
	phx                                  ;C30DB9|DA      |      ;  
	phy                                  ;C30DBA|5A      |      ;  
	jsl.l CODE_C285A2                    ;C30DBB|22A285C2|C285A2;  
	ply                                  ;C30DBF|7A      |      ;  
	plx                                  ;C30DC0|FA      |      ;  
	lda.b $00                            ;C30DC1|A500    |000000;  
	bne UNREACH_C30D67                   ;C30DC3|D0A2    |C30D67;  
	...
	phy                                  ;C30DE0|5A      |      ;  
	phb                                  ;C30DE1|8B      |      ;  
	jsl.l CODE_C62565                    ;C30DE2|226525C6|C62565;  
	plb                                  ;C30DE6|AB      |      ;  
	ply                                  ;C30DE7|7A      |      ;  
	plx                                  ;C30DE8|FA      |      ;  
...
CODE_C30E3C:
	...
	beq UNREACH_C30E65                   ;C30E59|F00A    |C30E65;  
	stx.b $00                            ;C30E5B|8600    |000000;  
	jsl.l CODE_C306F4                    ;C30E5D|22F406C3|C306F4;  
	stz.b $00                            ;C30E61|6400    |000000;  
	plp                                  ;C30E63|28      |      ;  
	rtl                                  ;C30E64|6B      |      ;  
...
CODE_C30E71:
	...
	phy                                  ;C30E7F|5A      |      ;  
	phb                                  ;C30E80|8B      |      ;  
	jsl.l CODE_C62565                    ;C30E81|226525C6|C62565;  
	plb                                  ;C30E85|AB      |      ;  
	ply                                  ;C30E86|7A      |      ;  
	plx                                  ;C30E87|FA      |      ;  
	pla                                  ;C30E88|68      |      ;  
	...
	sta.b $00                            ;C30E9D|8500    |000000;  
	plp                                  ;C30E9F|28      |      ;  
	rtl                                  ;C30EA0|6B      |      ;  
	sep #$20                             ;C30EA1|E220    |      ;  
	rep #$10                             ;C30EA3|C210    |      ;  
	lda.b #$13                           ;C30EA5|A913    |      ;  
	sta.b $00                            ;C30EA7|8500    |000000;  
	jsl.l CODE_C21128                    ;C30EA9|222811C2|C21128;  
...
CODE_C31004:
	sep #$20                             ;C31004|E220    |      ;  
	jsl.l CODE_C21167                    ;C31006|226711C2|C21167;  
...
CODE_C312FF:
	jsr.w CODE_C328E9                    ;C312FF|20E928  |C328E9;  
	jsr.w CODE_C31004                    ;C31302|200410  |C31004;  
	rtl                                  ;C31305|6B      |      ;  
...
.lbl_C31315
	...
	stx.b $00                            ;C31326|8600    |000000;  
	phx                                  ;C31328|DA      |      ;  
	jsl.l CODE_C234AB                    ;C31329|22AB34C2|C234AB;  
	plx                                  ;C3132D|FA      |      ;  
	stx.b $00                            ;C3132E|8600    |000000;  
	jsl.l CODE_C240D6                    ;C31330|22D640C2|C240D6;  
	jsl.l CODE_C25DA2                    ;C31334|22A25DC2|C25DA2;  
	rep #$10                             ;C31338|C210    |      ;  
	ldy.w #$0164                         ;C3133A|A06401  |      ;  
	sty.b $00                            ;C3133D|8400    |000000;  
	...
	jsl.l CODE_C210AC                    ;C314D1|22AC10C2|C210AC;  
	lda.b $00                            ;C314D5|A500    |000000;  
	pha                                  ;C314D7|48      |      ;  
...
UNREACH_C31552:
	...
	sta.b $00                            ;C31562|8500    |000000;  
	jsl.l DisplayMessage                    ;C31564|222525C6|C62525;  
	jsl.l CODE_C283A0                    ;C31568|22A083C2|C283A0;  
	lda.w #$0013                         ;C3156C|A91300  |      ;  
	sta.b $00                            ;C3156F|8500    |000000;  
	jsl.l CODE_C240A7                    ;C31571|22A740C2|C240A7;  
	jsl.l CODE_C35FA2                    ;C31575|22A25FC3|C35FA2;  
	rts                                  ;C31579|60      |      ;  
...
CODE_C315BC:
	sta.b $00                            ;C315BC|8500    |000000;  
	jsl.l CODE_C233BE                    ;C315BE|22BE33C2|C233BE;  
	jsl.l CODE_C21167                    ;C315C2|226711C2|C21167;  
	lda.b $06                            ;C315C6|A506    |000006;  
	pha                                  ;C315C8|48      |      ;  
	jsl.l CODE_C2338A                    ;C315C9|228A33C2|C2338A;  
	pla                                  ;C315CD|68      |      ;  
...
CODE_C315DF:
	rep #$30                             ;C315DF|C230    |      ;  
	phx                                  ;C315E1|DA      |      ;  
	jsl.l CODE_C21167                    ;C315E2|226711C2|C21167;  
	lda.b $06                            ;C315E6|A506    |000006;  
	clc                                  ;C315E8|18      |      ;  
	adc.w #$0005                         ;C315E9|690500  |      ;  
	pha                                  ;C315EC|48      |      ;  
	jsl.l CODE_C2338A                    ;C315ED|228A33C2|C2338A;  
	pla                                  ;C315F1|68      |      ;  
	cmp.b $00                            ;C315F2|C500    |000000;  
	bcs UNREACH_C315F9                   ;C315F4|B003    |C315F9;  
	plx                                  ;C315F6|FA      |      ;  
	clc                                  ;C315F7|18      |      ;  
	rts                                  ;C315F8|60      |      ;  
...
UNREACH_C315F9:
	...
	jsl.l CODE_C35E5A                    ;C3183B|225A5EC3|C35E5A;  
	jsl.l CODE_C35F6D                    ;C3183F|226D5FC3|C35F6D;  
	jsl.l CODE_C35EF8                    ;C31843|22F85EC3|C35EF8;  
	bra CODE_C31849                      ;C31847|8000    |C31849;  
...
.lbl_C31862
	...
	.db $60                               ;C318B3
	jsl.l CODE_C28790                    ;C318B4|229087C2|C28790;  
	rts                                  ;C318B8|60      |      ;  
	...
	jsl.l CODE_C28418                    ;C318F3|221884C2|C28418;  
	rts                                  ;C318F7|60      |      ;  
...
.lbl_C31968
	...
	jsl.l CODE_C359AF                    ;C31970|22AF59C3|C359AF;  
	lda.b w0001                            ;C31974|A501    |000001;  
	sta.b $00                            ;C31976|8500    |000000;  
	plp                                  ;C31978|28      |      ;  
	rts                                  ;C31979|60      |      ;  
	...
	sep #$30                             ;C31A90|E230    |      ;  
	lda.b $00                            ;C31A92|A500    |000000;  
	pha                                  ;C31A94|48      |      ;  
	phy                                  ;C31A95|5A      |      ;  
	jsr.w CODE_C31AB4                    ;C31A96|20B41A  |C31AB4;  
	lda.b #$00                           ;C31A99|A900    |      ;  
	sta.b $00                            ;C31A9B|8500    |000000;  
...
.lbl_C31AC8
	...
	.db $60                               ;C31B37
	sep #$30                             ;C31B38|E230    |      ;  
	lda.b $00                            ;C31B3A|A500    |000000;  
	pha                                  ;C31B3C|48      |      ;  
	phy                                  ;C31B3D|5A      |      ;  
	jsr.w CODE_C31B5C                    ;C31B3E|205C1B  |C31B5C;  
	lda.b #$00                           ;C31B41|A900    |      ;  
	sta.b $00                            ;C31B43|8500    |000000;  
...
.lbl_C31B70
	...
	jsl.l CODE_C234BF                    ;C31B76|22BF34C2|C234BF;  
	rts                                  ;C31B7A|60      |      ;  
...
.lbl_C31CAD
	...
	ply                                  ;C31CBF|7A      |      ;  
	dey                                  ;C31CC0|88      |      ;  
	bne UNREACH_C31CA5                   ;C31CC1|D0E2    |C31CA5;  
	rts                                  ;C31CC3|60      |      ;  
	...
	sep #$30                             ;C31D83|E230    |      ;  
	jsl.l CODE_C283D2                    ;C31D85|22D283C2|C283D2;  
	rts                                  ;C31D89|60      |      ;  
	...
	.db $28,$C2,$60                       ;C31DEA
	jsl.l CODE_C24390                    ;C31DED|229043C2|C24390;  
	rts                                  ;C31DF1|60      |      ;  
	.db $22,$D6,$40,$C2,$22,$A2,$5D,$C2   ;C31DF2|        |C240D6;  
	.db $60                               ;C31DFA
	jsl.l CODE_C240BC                    ;C31DFB|22BC40C2|C240BC;  
	rts                                  ;C31DFF|60      |      ;  
	.db $E2,$20,$A9,$06,$85,$01,$22,$80   ;C31E00
	.db $40,$C2,$60,$60                   ;C31E08
	jsl.l CODE_C2444B                    ;C31E0C|224B44C2|C2444B;  
	rts                                  ;C31E10|60      |      ;  
	sep #$20                             ;C31E11|E220    |      ;  
	lda.b #$32                           ;C31E13|A932    |      ;  
	sta.b w0001                            ;C31E15|8501    |000001;  
	jsl.l CODE_C2402A                    ;C31E17|222A40C2|C2402A;  
	rts                                  ;C31E1B|60      |      ;  
	rep #$20                             ;C31E1C|C220    |      ;  
	sep #$10                             ;C31E1E|E210    |      ;  
	lda.b $00                            ;C31E20|A500    |000000;  
	pha                                  ;C31E22|48      |      ;  
	xba                                  ;C31E23|EB      |      ;  
	sta.b $00                            ;C31E24|8500    |000000;  
	jsl.l CODE_C210AC                    ;C31E26|22AC10C2|C210AC;  
	lda.b $00                            ;C31E2A|A500    |000000;  
	pha                                  ;C31E2C|48      |      ;  
	...
	jsl.l CODE_C626A0                    ;C31E52|22A026C6|C626A0;  
	pla                                  ;C31E56|68      |      ;  
	sta.b $00                            ;C31E57|8500    |000000;  
	jsl.l CODE_C289F5                    ;C31E59|22F589C2|C289F5;  
	rts                                  ;C31E5D|60      |      ;  
	rep #$20                             ;C31E5E|C220    |      ;  
	sep #$10                             ;C31E60|E210    |      ;  
	ldx.b $00                            ;C31E62|A600    |000000;  
	cpx.b #$13                           ;C31E64|E013    |      ;  
	beq UNREACH_C31EB5                   ;C31E66|F04D    |C31EB5;  
	stx.b $00                            ;C31E68|8600    |000000;  
	phx                                  ;C31E6A|DA      |      ;  
	jsl.l CODE_C210AC                    ;C31E6B|22AC10C2|C210AC;  
	plx                                  ;C31E6F|FA      |      ;  
	ldy.b $03                            ;C31E70|A403    |000003;  
	cpy.b #$3C                           ;C31E72|C03C    |      ;  
	bcs UNREACH_C31EB4                   ;C31E74|B03E    |C31EB4;  
	cpy.b #$28                           ;C31E76|C028    |      ;  
	beq UNREACH_C31EB4                   ;C31E78|F03A    |C31EB4;  
	lda.b $00                            ;C31E7A|A500    |000000;  
	pha                                  ;C31E7C|48      |      ;  
	phy                                  ;C31E7D|5A      |      ;  
	stx.b $00                            ;C31E7E|8600    |000000;  
	phx                                  ;C31E80|DA      |      ;  
	jsl.l CODE_C20F35                    ;C31E81|22350FC2|C20F35;  
	plx                                  ;C31E85|FA      |      ;  
	stx.b $00                            ;C31E86|8600    |000000;  
	phx                                  ;C31E88|DA      |      ;  
	jsl.l CODE_C625B9                    ;C31E89|22B925C6|C625B9;  
	plx                                  ;C31E8D|FA      |      ;  
	stx.b $00                            ;C31E8E|8600    |000000;  
	jsl.l CODE_C21128                    ;C31E90|222811C2|C21128;  
	ply                                  ;C31E94|7A      |      ;  
...
UNREACH_C31F29:
	...
	sep #$20                             ;C31F99|E220    |      ;  
	jsl.l CODE_C625CE                    ;C31F9B|22CE25C6|C625CE;  
	lda.b #$FF                           ;C31F9F|A9FF    |      ;  
	sta.b w0001                            ;C31FA1|8501    |000001;  
	lda.b $00                            ;C31FA3|A500    |000000;  
	pha                                  ;C31FA5|48      |      ;  
	jsl.l CODE_C23579                    ;C31FA6|227935C2|C23579;  
	pla                                  ;C31FAA|68      |      ;  
	...
	pla                                  ;C32055|68      |      ;  
	sta.b $00                            ;C32056|8500    |000000;  
	lda.b $00                            ;C32058|A500    |000000;  
	pha                                  ;C3205A|48      |      ;  
	jsl.l CODE_C27EA9                    ;C3205B|22A97EC2|C27EA9;  
	pla                                  ;C3205F|68      |      ;  
	...
	bmi UNREACH_C320A8                   ;C32088|301E    |C320A8;  
	jsl.l CODE_C3631A                    ;C3208A|221A63C3|C3631A;  
	lda.b $00                            ;C3208E|A500    |000000;  
	...
	phx                                  ;C3209B|DA      |      ;  
	jsl.l CODE_C24380                    ;C3209C|228043C2|C24380;  
	plx                                  ;C320A0|FA      |      ;  
	stx.b $00                            ;C320A1|8600    |000000;  
	jsl.l CODE_C27E92                    ;C320A3|22927EC2|C27E92;  
	rts                                  ;C320A7|60      |      ;  

UNREACH_C320A8:
	.db $FA,$86,$00,$22,$90,$43,$C2,$60   ;C320A8
	sep #$30                             ;C320B0|E230    |      ;  
	jsl.l CODE_C28451                    ;C320B2|225184C2|C28451;  
	rts                                  ;C320B6|60      |      ;  
	...
	sta.b $00                            ;C3216D|8500    |000000;  
	jsl.l CODE_C21128                    ;C3216F|222811C2|C21128;  
...
.lbl_C321BD
	...
	phy                                  ;C321C1|5A      |      ;  
	jsl.l CODE_C285A2                    ;C321C2|22A285C2|C285A2;  
	ply                                  ;C321C6|7A      |      ;  
...
CODE_C324F9:
	php                                  ;C324F9|08      |      ;  
	sep #$30                             ;C324FA|E230    |      ;  
	ldx.b $00                            ;C324FC|A600    |000000;  
	ldy.b $00                            ;C324FE|A400    |000000;  
	lda.l $7E8B8C,x                      ;C32500|BF8C8B7E|7E8B8C;  
	tax                                  ;C32504|AA      |      ;  
	lda.l $7E900C,x                      ;C32505|BF0C907E|7E900C;  
	bne UNREACH_C3252F                   ;C32509|D024    |C3252F;  
	...
	ply                                  ;C32518|7A      |      ;  
	sty.b $00                            ;C32519|8400    |000000;  
	phy                                  ;C3251B|5A      |      ;  
	jsl.l CODE_C30192                    ;C3251C|229201C3|C30192;  
	ply                                  ;C32520|7A      |      ;  
...
.lbl_C326C6
	...
	phy                                  ;C326C9|5A      |      ;  
	phb                                  ;C326CA|8B      |      ;  
	jsl.l CODE_C62B69                    ;C326CB|22692BC6|C62B69;  
	plb                                  ;C326CF|AB      |      ;  
	ply                                  ;C326D0|7A      |      ;  
	plx                                  ;C326D1|FA      |      ;  
	stx.b $00                            ;C326D2|8600    |000000;  
	phx                                  ;C326D4|DA      |      ;  
	phy                                  ;C326D5|5A      |      ;  
	phb                                  ;C326D6|8B      |      ;  
	jsr.w CODE_C31959                    ;C326D7|205919  |C31959;  
	plb                                  ;C326DA|AB      |      ;  
	ply                                  ;C326DB|7A      |      ;  
	plx                                  ;C326DC|FA      |      ;  
	lda.b $00                            ;C326DD|A500    |000000;  
	stx.b $00                            ;C326DF|8600    |000000;  
	tax                                  ;C326E1|AA      |      ;  
...
.lbl_C3270C
	...
	phy                                  ;C3270D|5A      |      ;  
	phb                                  ;C3270E|8B      |      ;  
	jsr.w CODE_C32AFC                    ;C3270F|20FC2A  |C32AFC;  
	plb                                  ;C32712|AB      |      ;  
	ply                                  ;C32713|7A      |      ;  
	plx                                  ;C32714|FA      |      ;  
...
.lbl_C3278C
	...
	phy                                  ;C3278E|5A      |      ;  
	phb                                  ;C3278F|8B      |      ;  
	stx.b $00                            ;C32790|8600    |000000;  
	jsl.l CODE_C306F4                    ;C32792|22F406C3|C306F4;  
...
.lbl_C327B4
	...
	pha                                  ;C327C3|48      |      ;  
	phy                                  ;C327C4|5A      |      ;  
	bra CODE_C327C8                      ;C327C5|8001    |C327C8;  
...
CODE_C327C8:
	...
	bne UNREACH_C327C7                   ;C327CD|D0F8    |C327C7;  
	txa                                  ;C327CF|8A      |      ;  
	...
	tyx                                  ;C328C6|BB      |      ;  
	phx                                  ;C328C7|DA      |      ;  
	jsr.w CODE_C32BAD                    ;C328C8|20AD2B  |C32BAD;  
	plx                                  ;C328CB|FA      |      ;  
	lda.l $7E8C8C,x                      ;C328CC|BF8C8C7E|7E8C8C;  
	beq UNREACH_C328DE                   ;C328D0|F00C    |C328DE;  
	dec a                                ;C328D2|3A      |      ;  
	sta.l $7E8C8C,x                      ;C328D3|9F8C8C7E|7E8C8C;  
	jsr.w CODE_C328E9                    ;C328D7|20E928  |C328E9;  
	jsr.w CODE_C31004                    ;C328DA|200410  |C31004;  
	rts                                  ;C328DD|60      |      ;  
...
CODE_C328E9:
	...
	sta.b $00                            ;C328EF|8500    |000000;  
	jsl.l CODE_C21128                    ;C328F1|222811C2|C21128;  
...
.lbl_C32B0B
	...
	rep #$20                             ;C32B13|C220    |      ;  
	lda.b $00                            ;C32B15|A500    |000000;  
	pha                                  ;C32B17|48      |      ;  
	jsl.l CODE_C359AF                    ;C32B18|22AF59C3|C359AF;  
	ldx.b w0001                            ;C32B1C|A601    |000001;  
	stx.b $00                            ;C32B1E|8600    |000000;  
	phx                                  ;C32B20|DA      |      ;  
...
.lbl_C32B3A
	...
	plx                                  ;C32B41|FA      |      ;  
	stz.b $00                            ;C32B42|6400    |000000;  
	stx.b $00                            ;C32B44|8600    |000000;  
	phx                                  ;C32B46|DA      |      ;  
	...
	plx                                  ;C32B93|FA      |      ;  
	jsl.l CODE_C240FC                    ;C32B94|22FC40C2|C240FC;  
	plx                                  ;C32B98|FA      |      ;  
	stx.b $00                            ;C32B99|8600    |000000;  
	phx                                  ;C32B9B|DA      |      ;  
	jsl.l CODE_C30192                    ;C32B9C|229201C3|C30192;  
	plx                                  ;C32BA0|FA      |      ;  
	stx.b $00                            ;C32BA1|8600    |000000;  
	jsl.l CODE_C306F4                    ;C32BA3|22F406C3|C306F4;  
	pla                                  ;C32BA7|68      |      ;  
	pla                                  ;C32BA8|68      |      ;  
	stz.b $00                            ;C32BA9|6400    |000000;  
	plp                                  ;C32BAB|28      |      ;  
	rtl                                  ;C32BAC|6B      |      ;  
...
CODE_C32CCB:
	php                                  ;C32CCB|08      |      ;  
	sep #$30                             ;C32CCC|E230    |      ;  
	ldx.b $00                            ;C32CCE|A600    |000000;  
	lda.l $7E8F0C,x                      ;C32CD0|BF0C8F7E|7E8F0C;  
	sta.b $00                            ;C32CD4|8500    |000000;  
...
CODE_C32CFE:
	...
	beq UNREACH_C32D6A                   ;C32D11|F057    |C32D6A;  
	stx.b $00                            ;C32D13|8600    |000000;  
	phx                                  ;C32D15|DA      |      ;  
	jsl.l CODE_C30710                    ;C32D16|221007C3|C30710;  
	plx                                  ;C32D1A|FA      |      ;  
	lda.l $7E8F0C,x                      ;C32D1B|BF0C8F7E|7E8F0C;  
	bit.b #$04                           ;C32D1F|8904    |      ;  
	bne UNREACH_C32D50                   ;C32D21|D02D    |C32D50;  
	...
	sta.b $00                            ;C32D3A|8500    |000000;  
	lda.b #$FF                           ;C32D3C|A9FF    |      ;  
	sta.b w0001                            ;C32D3E|8501    |000001;  
	jsl.l CODE_C234BF                    ;C32D40|22BF34C2|C234BF;  
...
.lbl_C3302C
	...
	pha                                  ;C3302E|48      |      ;  
	phx                                  ;C3302F|DA      |      ;  
	jsl.l CODE_C20E3A                    ;C33030|223A0EC2|C20E3A;  
	plx                                  ;C33034|FA      |      ;  
	pla                                  ;C33035|68      |      ;  
...
CODE_C330D1:
	...
	bra CODE_C330FC                      ;C330D8|8022    |C330FC;  

CODE_C330DA:
	php                                  ;C330DA|08      |      ;  
	sep #$30                             ;C330DB|E230    |      ;  
	ldx.b $00                            ;C330DD|A600    |000000;  
...
CODE_C33170:
	...
	plx                                  ;C3318E|FA      |      ;  
	pla                                  ;C3318F|68      |      ;  
	jsr.w CODE_C331B2                    ;C33190|20B231  |C331B2;  
	stx.b $00                            ;C33193|8600    |000000;  
	jsl.l CODE_C306F4                    ;C33195|22F406C3|C306F4;  
	plp                                  ;C33199|28      |      ;  
	rtl                                  ;C3319A|6B      |      ;  
...
CODE_C33382:
	php                                  ;C33382|08      |      ;  
	sep #$30                             ;C33383|E230    |      ;  
	ldx.b $05                            ;C33385|A605    |000005;  
	phx                                  ;C33387|DA      |      ;  
	ldx.b $00                            ;C33388|A600    |000000;  
	phx                                  ;C3338A|DA      |      ;  
...
.lbl_C333D5
	...
	sep #$20                             ;C333F5|E220    |      ;  
	lda.b $06,s                          ;C333F7|A306    |000006;  
	sta.b $00                            ;C333F9|8500    |000000;  
	lda.b $05,s                          ;C333FB|A305    |000005;  
	tax                                  ;C333FD|AA      |      ;  
...
.lbl_C33463
	...
	ply                                  ;C3346A|7A      |      ;  
	sty.b $00                            ;C3346B|8400    |000000;  
	lda.b $04,s                          ;C3346D|A304    |000004;  
	sta.b w0001                            ;C3346F|8501    |000001;  
	lda.b $06,s                          ;C33471|A306    |000006;  
	tay                                  ;C33473|A8      |      ;  
	lda.b $05,s                          ;C33474|A305    |000005;  
	rep #$30                             ;C33476|C230    |      ;  
...
.lbl_C33611
	...
	phx                                  ;C33633|DA      |      ;  
	phy                                  ;C33634|5A      |      ;  
	jsl.l CODE_C626CA                    ;C33635|22CA26C6|C626CA;  
	ply                                  ;C33639|7A      |      ;  
	plx                                  ;C3363A|FA      |      ;  
...
.lbl_C336A9
	...
	bra CODE_C3369C                      ;C336C6|80D4    |C3369C;  
...
CODE_C33AD5:
	php                                  ;C33AD5|08      |      ;  
	sep #$30                             ;C33AD6|E230    |      ;  
	ldx.b $00                            ;C33AD8|A600    |000000;  
	lda.l $7E8E8C,x                      ;C33ADA|BF8C8E7E|7E8E8C;  
	sta.b $00                            ;C33ADE|8500    |000000;  
	plp                                  ;C33AE0|28      |      ;  
	rtl                                  ;C33AE1|6B      |      ;  
...
CODE_C33AE2:
	php                                  ;C33AE2|08      |      ;  
	sep #$30                             ;C33AE3|E230    |      ;  
	ldx.b $00                            ;C33AE5|A600    |000000;  
	lda.l $7E8E0C,x                      ;C33AE7|BF0C8E7E|7E8E0C;  
	sta.b $00                            ;C33AEB|8500    |000000;  
	plp                                  ;C33AED|28      |      ;  
	rtl                                  ;C33AEE|6B      |      ;  
...
.lbl_C33B77
	...
	jsl.l CODE_C306F4                    ;C33B7F|22F406C3|C306F4;  
	plp                                  ;C33B83|28      |      ;  
	rtl                                  ;C33B84|6B      |      ;  
...
CODE_C33CA0:
	php                                  ;C33CA0|08      |      ;  
	rep #$20                             ;C33CA1|C220    |      ;  
	lda.b $00                            ;C33CA3|A500    |000000;  
	and.w #$00FF                         ;C33CA5|29FF00  |      ;  
	pha                                  ;C33CA8|48      |      ;  
	lda.b $00                            ;C33CA9|A500    |000000;  
	xba                                  ;C33CAB|EB      |      ;  
...
UNREACH_C33CD1:
	...
	sta.b $00                            ;C33CFD|8500    |000000;  
	pla                                  ;C33CFF|68      |      ;  
	pla                                  ;C33D00|68      |      ;  
	plp                                  ;C33D01|28      |      ;  
	rtl                                  ;C33D02|6B      |      ;  
	lda.b $00                            ;C33D03|A500    |000000;  
	xba                                  ;C33D05|EB      |      ;  
	...
	sta.b $00                            ;C33D17|8500    |000000;  
	pla                                  ;C33D19|68      |      ;  
	pla                                  ;C33D1A|68      |      ;  
	plp                                  ;C33D1B|28      |      ;  
	rtl                                  ;C33D1C|6B      |      ;  
	lda.b $00                            ;C33D1D|A500    |000000;  
	xba                                  ;C33D1F|EB      |      ;  
	...
	sta.b $06                            ;C33D52|8506    |000006;  
	lda.b $03,s                          ;C33D54|A303    |000003;  
	sta.b $00                            ;C33D56|8500    |000000;  
	phx                                  ;C33D58|DA      |      ;  
	jsl.l CODE_C32CCB                    ;C33D59|22CB2CC3|C32CCB;  
	plx                                  ;C33D5D|FA      |      ;  
...
CODE_C33DE0:
	...
	sta.b $06                            ;C33E29|8506    |000006;  
	lda.b $03,s                          ;C33E2B|A303    |000003;  
	sta.b $00                            ;C33E2D|8500    |000000;  
	phx                                  ;C33E2F|DA      |      ;  
	jsl.l CODE_C32CCB                    ;C33E30|22CB2CC3|C32CCB;  
	plx                                  ;C33E34|FA      |      ;  
...
CODE_C33EB7:
	sta.b $00                            ;C33EB7|8500    |000000;  
	pla                                  ;C33EB9|68      |      ;  
	pla                                  ;C33EBA|68      |      ;  
	plp                                  ;C33EBB|28      |      ;  
	rtl                                  ;C33EBC|6B      |      ;  
	lda.b $00                            ;C33EBD|A500    |000000;  
	xba                                  ;C33EBF|EB      |      ;  
	...
	sta.b $00                            ;C33ED1|8500    |000000;  
	pla                                  ;C33ED3|68      |      ;  
	pla                                  ;C33ED4|68      |      ;  
	plp                                  ;C33ED5|28      |      ;  
	rtl                                  ;C33ED6|6B      |      ;  
	lda.b $00                            ;C33ED7|A500    |000000;  
	xba                                  ;C33ED9|EB      |      ;  
...
.lbl_C33F3A
	...
	asl a                                ;C33F48|0A      |      ;  
	asl a                                ;C33F49|0A      |      ;  
	sta.b $00                            ;C33F4A|8500    |000000;  
	asl a                                ;C33F4C|0A      |      ;  
	clc                                  ;C33F4D|18      |      ;  
	adc.b $00                            ;C33F4E|6500    |000000;  
	clc                                  ;C33F50|18      |      ;  
	adc.b $06                            ;C33F51|6506    |000006;  
	tax                                  ;C33F53|AA      |      ;  
...
CODE_C3544E:
	php                                  ;C3544E|08      |      ;  
	sep #$30                             ;C3544F|E230    |      ;  
	jsl.l CODE_C35488                    ;C35451|228854C3|C35488;  
	jsr.w CODE_C35561                    ;C35455|206155  |C35561;  
	asl a                                ;C35458|0A      |      ;  
	tax                                  ;C35459|AA      |      ;  
	...
	jsl.l CODE_C150D7                    ;C35466|22D750C1|C150D7;  
	plp                                  ;C3546A|28      |      ;  
	rtl                                  ;C3546B|6B      |      ;  
...
.lbl_C354E3
	...
	jsl.l CODE_C3F69F                    ;C354F0|229FF6C3|C3F69F;  
	ldx.b $00                            ;C354F4|A600    |000000;  
...
CODE_C35561:
	jsr.w CODE_C3575D                    ;C35561|205D57  |C3575D;  
	tya                                  ;C35564|98      |      ;  
	asl a                                ;C35565|0A      |      ;  
	tax                                  ;C35566|AA      |      ;  
...
.lbl_C3577B
	...
	beq UNREACH_C3578E                   ;C35781|F00B    |C3578E;  
...
UNREACH_C3578E:
	...
	jsl.l CODE_C627DB                    ;C3579B|22DB27C6|C627DB;  
	lda.b $00                            ;C3579F|A500    |000000;  
	cmp.b #$0A                           ;C357A1|C90A    |      ;  
	bne UNREACH_C357AF                   ;C357A3|D00A    |C357AF;  
	jsl.l CODE_C38D18                    ;C357A5|22188DC3|C38D18;  
	jsl.l CODE_C38D72                    ;C357A9|22728DC3|C38D72;  
	bra CODE_C357D3                      ;C357AD|8024    |C357D3;  
UNREACH_C357AF:
...
CODE_C357D3:
	jsl.l CODE_C38AD6                    ;C357D3|22D68AC3|C38AD6;  
	jsl.l CODE_C38B2F                    ;C357D7|222F8BC3|C38B2F;  
	jsl.l CODE_C38C9F                    ;C357DB|229F8CC3|C38C9F;  
	jsr.w CODE_C38BAE                    ;C357DF|20AE8B  |C38BAE;  
	jsr.w CODE_C38C70                    ;C357E2|20708C  |C38C70;  
...
.lbl_C35807
	...
	dec a                                ;C35817|3A      |      ;  
	sta.b $00                            ;C35818|8500    |000000;  
	asl a                                ;C3581A|0A      |      ;  
	clc                                  ;C3581B|18      |      ;  
	adc.b $00                            ;C3581C|6500    |000000;  
	tax                                  ;C3581E|AA      |      ;  
	phx                                  ;C3581F|DA      |      ;  
	jsl.l CODE_C38FB7                    ;C35820|22B78FC3|C38FB7;  
	plx                                  ;C35824|FA      |      ;  
	phx                                  ;C35825|DA      |      ;  
	jsl.l CODE_C38DD4                    ;C35826|22D48DC3|C38DD4;  
	plx                                  ;C3582A|FA      |      ;  
	phx                                  ;C3582B|DA      |      ;  
	jsl.l CODE_C38E07                    ;C3582C|22078EC3|C38E07;  
	plx                                  ;C35830|FA      |      ;  
	phx                                  ;C35831|DA      |      ;  
	jsl.l CODE_C38ECC                    ;C35832|22CC8EC3|C38ECC;  
	plx                                  ;C35836|FA      |      ;  
	phx                                  ;C35837|DA      |      ;  
	jsl.l CODE_C38F01                    ;C35838|22018FC3|C38F01;  
	plx                                  ;C3583C|FA      |      ;  
	jsl.l CODE_C38F34                    ;C3583D|22348FC3|C38F34;  
	jsl.l CODE_C371AB                    ;C35841|22AB71C3|C371AB;  
	jsl.l CODE_C3893E                    ;C35845|223E89C3|C3893E;  
	rts                                  ;C35849|60      |      ;  
	.db $60                               ;C3584A
	jsl.l CODE_C2CAF4                    ;C3584B|22F4CAC2|C2CAF4;  
	jsl.l CODE_C39021                    ;C3584F|222190C3|C39021;  
	jsl.l CODE_C38AD6                    ;C35853|22D68AC3|C38AD6;  
	jsr.w CODE_C36FF0                    ;C35857|20F06F  |C36FF0;  
	jsl.l CODE_C371AB                    ;C3585A|22AB71C3|C371AB;  
	jsr.w CODE_C3737C                    ;C3585E|207C73  |C3737C;  
	jsr.w CODE_C39382                    ;C35861|208293  |C39382;  
	jsr.w CODE_C39AAA                    ;C35864|20AA9A  |C39AAA;  
	jsr.w CODE_C38011                    ;C35867|201180  |C38011;  
	jsr.w CODE_C39C97                    ;C3586A|20979C  |C39C97;  
	jsr.w CODE_C39D8C                    ;C3586D|208C9D  |C39D8C;  
	jsr.w CODE_C39FB2                    ;C35870|20B29F  |C39FB2;  
	jsl.l CODE_C38981                    ;C35873|228189C3|C38981;  
	jsl.l CODE_C389AA                    ;C35877|22AA89C3|C389AA;  
	jsl.l CODE_C389DB                    ;C3587B|22DB89C3|C389DB;  
	jsl.l CODE_C3D219                    ;C3587F|2219D2C3|C3D219;  
	jsl.l CODE_C38A3C                    ;C35883|223C8AC3|C38A3C;  
	jsl.l CODE_C391FA                    ;C35887|22FA91C3|C391FA;  
	jsl.l CODE_C3893E                    ;C3588B|223E89C3|C3893E;  
	jsr.w CODE_C399F2                    ;C3588F|20F299  |C399F2;  
	jsr.w CODE_C39E1D                    ;C35892|201D9E  |C39E1D;  
	rts                                  ;C35895|60      |      ;  
...
CODE_C359AF:
	php                                  ;C359AF|08      |      ;  
	rep #$30                             ;C359B0|C230    |      ;  
	lda.b $00                            ;C359B2|A500    |000000;  
	lsr a                                ;C359B4|4A      |      ;  
	lsr a                                ;C359B5|4A      |      ;  
	sep #$20                             ;C359B6|E220    |      ;  
	and.b #$C0                           ;C359B8|29C0    |      ;  
	ora.b $00                            ;C359BA|0500    |000000;  
	tax                                  ;C359BC|AA      |      ;  
	lda.l $7E945F,x                      ;C359BD|BF5F947E|7E945F;  
	sta.b $00                            ;C359C1|8500    |000000;  
...
CODE_C35A44:
	...
	pha                                  ;C35A49|48      |      ;  
	plb                                  ;C35A4A|AB      |      ;  
	jsl.l CODE_C28597                    ;C35A4B|229785C2|C28597;  
	lda.b $00                            ;C35A4F|A500    |000000;  
...
.lbl_C35AA1
	...
	phy                                  ;C35AA8|5A      |      ;  
	jsl.l CODE_C3079A                    ;C35AA9|229A07C3|C3079A;  
	ply                                  ;C35AAD|7A      |      ;  
...
.lbl_C35B4D
	...
	plb                                  ;C35B63|AB      |      ;  
	ply                                  ;C35B64|7A      |      ;  
	jmp.w CODE_C35A73                    ;C35B65|4C735A  |C35A73;  
...
CODE_C35C9A:
	...
	pha                                  ;C35C9F|48      |      ;  
	plb                                  ;C35CA0|AB      |      ;  
	jsl.l CODE_C28597                    ;C35CA1|229785C2|C28597;  
	lda.b $00                            ;C35CA5|A500    |000000;  
	sta.w $BE65                          ;C35CA7|8D65BE  |7EBE65;  
	lda.b #$13                           ;C35CAA|A913    |      ;  
	sta.b $00                            ;C35CAC|8500    |000000;  
	phb                                  ;C35CAE|8B      |      ;  
	jsl.l CODE_C210AC                    ;C35CAF|22AC10C2|C210AC;  
	plb                                  ;C35CB3|AB      |      ;  
	rep #$30                             ;C35CB4|C230    |      ;  
	lda.b $00                            ;C35CB6|A500    |000000;  
	lsr a                                ;C35CB8|4A      |      ;  
	lsr a                                ;C35CB9|4A      |      ;  
	sep #$20                             ;C35CBA|E220    |      ;  
	and.b #$C0                           ;C35CBC|29C0    |      ;  
	tay                                  ;C35CBE|A8      |      ;  
	ora.b $00                            ;C35CBF|0500    |000000;  
	tax                                  ;C35CC1|AA      |      ;  
...
.lbl_C35CCD
	...
	jsl.l CODE_C2334F                    ;C35CD8|224F33C2|C2334F;  
...
.lbl_C35E41
	...
	bra CODE_C35E3C                      ;C35E58|80E2    |C35E3C;  
...
.lbl_C35F0C
	...
	phy                                  ;C35F18|5A      |      ;  
	phb                                  ;C35F19|8B      |      ;  
	jsl.l CODE_C30710                    ;C35F1A|221007C3|C30710;  
	plb                                  ;C35F1E|AB      |      ;  
	ply                                  ;C35F1F|7A      |      ;  
...
.lbl_C35F8B
	...
	bra CODE_C35F86                      ;C35FA0|80E4    |C35F86;  
...
.lbl_C36092
	...
	xba                                  ;C36098|EB      |      ;  
	pha                                  ;C36099|48      |      ;  
	jsl.l CODE_C3F65F                    ;C3609A|225FF6C3|C3F65F;  
	pla                                  ;C3609E|68      |      ;  
	...
	phx                                  ;C360BC|DA      |      ;  
	jsl.l CODE_C366B7                    ;C360BD|22B766C3|C366B7;  
	plx                                  ;C360C1|FA      |      ;  
...
.lbl_C360E7
	...
	xba                                  ;C360ED|EB      |      ;  
	pha                                  ;C360EE|48      |      ;  
	jsl.l CODE_C3F65F                    ;C360EF|225FF6C3|C3F65F;  
	pla                                  ;C360F3|68      |      ;  
	...
	phx                                  ;C36111|DA      |      ;  
	phy                                  ;C36112|5A      |      ;  
	jsl.l CODE_C366B7                    ;C36113|22B766C3|C366B7;  
	ply                                  ;C36117|7A      |      ;  
	plx                                  ;C36118|FA      |      ;  
...
.lbl_C36208
	...
	xba                                  ;C3620E|EB      |      ;  
	pha                                  ;C3620F|48      |      ;  
	jsl.l CODE_C3F65F                    ;C36210|225FF6C3|C3F65F;  
	pla                                  ;C36214|68      |      ;  
	...
	phx                                  ;C36232|DA      |      ;  
	jsl.l CODE_C366B7                    ;C36233|22B766C3|C366B7;  
	plx                                  ;C36237|FA      |      ;  
...
.lbl_C36297
	...
	xba                                  ;C3629D|EB      |      ;  
	pha                                  ;C3629E|48      |      ;  
	jsl.l CODE_C3F65F                    ;C3629F|225FF6C3|C3F65F;  
	pla                                  ;C362A3|68      |      ;  
...
.lbl_C36339
	...
	sta.b $00                            ;C36340|8500    |000000;  
	lda.b $02,s                          ;C36342|A302    |000002;  
	clc                                  ;C36344|18      |      ;  
...
.lbl_C363A1
	...
	sta.b $00                            ;C363A8|8500    |000000;  
	lda.b $02,s                          ;C363AA|A302    |000002;  
	clc                                  ;C363AC|18      |      ;  
...
CODE_C36410:
	...
	sep #$20                             ;C36411|E220    |      ;  
	rep #$10                             ;C36413|C210    |      ;  
	jsl.l CODE_C36BBD                    ;C36415|22BD6BC3|C36BBD;  
	phy                                  ;C36419|5A      |      ;  
	tyx                                  ;C3641A|BB      |      ;  
	...
	jsl.l CODE_C3E3CB                    ;C3642C|22CBE3C3|C3E3CB;  
...
CODE_C3653C:
	php                                  ;C3653C|08      |      ;  
	sep #$30                             ;C3653D|E230    |      ;  
	ldx.b $00                            ;C3653F|A600    |000000;  
	lda.l $7EC134,x                      ;C36541|BF34C17E|7EC134;  
	sta.b $00                            ;C36545|8500    |000000;  
	plp                                  ;C36547|28      |      ;  
	rtl                                  ;C36548|6B      |      ;  
...
CODE_C36698:
	php                                  ;C36698|08      |      ;  
	sep #$30                             ;C36699|E230    |      ;  
	ldx.b $00                            ;C3669B|A600    |000000;  
	lda.l $7EBE66,x                      ;C3669D|BF66BE7E|7EBE66;  
	sta.b $00                            ;C366A1|8500    |000000;  
...
CODE_C366B7:
	php                                  ;C366B7|08      |      ;  
	sep #$30                             ;C366B8|E230    |      ;  
	ldx.b $00                            ;C366BA|A600    |000000;  
	lda.l $7EC166,x                      ;C366BC|BF66C17E|7EC166;  
	sta.b $00                            ;C366C0|8500    |000000;  
	plp                                  ;C366C2|28      |      ;  
	rtl                                  ;C366C3|6B      |      ;  
...
CODE_C36783:
	php                                  ;C36783|08      |      ;  
	sep #$30                             ;C36784|E230    |      ;  
	ldx.b $00                            ;C36786|A600    |000000;  
	ldy.b w0001                            ;C36788|A401    |000001;  
	phx                                  ;C3678A|DA      |      ;  
	phy                                  ;C3678B|5A      |      ;  
	jsl.l CODE_C36382                    ;C3678C|228263C3|C36382;  
	ply                                  ;C36790|7A      |      ;  
	plx                                  ;C36791|FA      |      ;  
	lda.b $00                            ;C36792|A500    |000000;  
	bmi UNREACH_C36798                   ;C36794|3002    |C36798;  
	plp                                  ;C36796|28      |      ;  
	rtl                                  ;C36797|6B      |      ;  
...
CODE_C36870:
	pha                                  ;C36870|48      |      ;  
	jsl.l CODE_C371AB                    ;C36871|22AB71C3|C371AB;  
	pla                                  ;C36875|68      |      ;  
...
.lbl_C36C0D
	...
	phy                                  ;C36C15|5A      |      ;  
	phb                                  ;C36C16|8B      |      ;  
	jsl.l CODE_C27DE4                    ;C36C17|22E47DC2|C27DE4;  
	plb                                  ;C36C1B|AB      |      ;  
	ply                                  ;C36C1C|7A      |      ;  
	plx                                  ;C36C1D|FA      |      ;  
.lbl_C36C1E
...
CODE_C370AC:
	php                                  ;C370AC|08      |      ;  
	sep #$30                             ;C370AD|E230    |      ;  
	lda.b $00                            ;C370AF|A500    |000000;  
	asl a                                ;C370B1|0A      |      ;  
	asl a                                ;C370B2|0A      |      ;  
	asl a                                ;C370B3|0A      |      ;  
	pha                                  ;C370B4|48      |      ;  
	ldx.b $00                            ;C370B5|A600    |000000;  
	...
	sta.b $06                            ;C370CD|8506    |000006;  
	lda.b $04,s                          ;C370CF|A304    |000004;  
	inc a                                ;C370D1|1A      |      ;  
	tax                                  ;C370D2|AA      |      ;  
...
.lbl_C371E2
	...
	lda.b $06                            ;C371EA|A506    |000006;  
	pha                                  ;C371EC|48      |      ;  
	jsl.l CODE_C3F69F                    ;C371ED|229FF6C3|C3F69F;  
	pla                                  ;C371F1|68      |      ;  
	sta.b $06                            ;C371F2|8506    |000006;  
	ldx.b $00                            ;C371F4|A600    |000000;  
	lda.b $03,s                          ;C371F6|A303    |000003;  
	sta.b $00                            ;C371F8|8500    |000000;  
	lda.b w0001,s                          ;C371FA|A301    |000001;  
	sta.b w0001                            ;C371FC|8501    |000001;  
	lda.b $06                            ;C371FE|A506    |000006;  
	pha                                  ;C37200|48      |      ;  
	phx                                  ;C37201|DA      |      ;  
	jsl.l CODE_C3F69F                    ;C37202|229FF6C3|C3F69F;  
	plx                                  ;C37206|FA      |      ;  
	pla                                  ;C37207|68      |      ;  
	sta.b $06                            ;C37208|8506    |000006;  
	ldy.b $00                            ;C3720A|A400    |000000;  
	stx.b $00                            ;C3720C|8600    |000000;  
...
.lbl_C37255
	...
	lda.b $06                            ;C3725D|A506    |000006;  
	pha                                  ;C3725F|48      |      ;  
	jsl.l CODE_C3F69F                    ;C37260|229FF6C3|C3F69F;  
	pla                                  ;C37264|68      |      ;  
	sta.b $06                            ;C37265|8506    |000006;  
	ldx.b $00                            ;C37267|A600    |000000;  
	lda.b $03,s                          ;C37269|A303    |000003;  
	sta.b $00                            ;C3726B|8500    |000000;  
	lda.b w0001,s                          ;C3726D|A301    |000001;  
	sta.b w0001                            ;C3726F|8501    |000001;  
	lda.b $06                            ;C37271|A506    |000006;  
	pha                                  ;C37273|48      |      ;  
	phx                                  ;C37274|DA      |      ;  
	jsl.l CODE_C3F69F                    ;C37275|229FF6C3|C3F69F;  
	plx                                  ;C37279|FA      |      ;  
	pla                                  ;C3727A|68      |      ;  
	sta.b $06                            ;C3727B|8506    |000006;  
	ldy.b $00                            ;C3727D|A400    |000000;  
	stx.b $00                            ;C3727F|8600    |000000;  
...
CODE_C3737C:
	...
	sep #$20                             ;C3737D|E220    |      ;  
	rep #$10                             ;C3737F|C210    |      ;  
	jsl.l CODE_C627E6                    ;C37381|22E627C6|C627E6;  
	lda.b $00                            ;C37385|A500    |000000;  
	cmp.b #$01                           ;C37387|C901    |      ;  
	bne UNREACH_C37399                   ;C37389|D00E    |C37399;  
...
.lbl_C38093
	...
	pla                                  ;C38099|68      |      ;  
	sta.b $00                            ;C3809A|8500    |000000;  
	rep #$10                             ;C3809C|C210    |      ;  
	jsl.l CODE_C36BBD                    ;C3809E|22BD6BC3|C36BBD;  
	phy                                  ;C380A2|5A      |      ;  
	ldx.w #$0901                         ;C380A3|A20109  |      ;  
	stx.b $00                            ;C380A6|8600    |000000;  
	jsl.l CODE_C3F69F                    ;C380A8|229FF6C3|C3F69F;  
	stz.b w0001                            ;C380AC|6401    |000001;  
	ldx.b $00                            ;C380AE|A600    |000000;  
	stz.b $00                            ;C380B0|6400    |000000;  
	lda.l UNREACH_C380F1,x               ;C380B2|BFF180C3|C380F1;  
	sta.b w0001                            ;C380B6|8501    |000001;  
	phx                                  ;C380B8|DA      |      ;  
	jsl.l CODE_C3F69F                    ;C380B9|229FF6C3|C3F69F;  
	plx                                  ;C380BD|FA      |      ;  
	stx.b w0001                            ;C380BE|8601    |000001;  
	jsl.l CODE_C3E3CB                    ;C380C0|22CBE3C3|C3E3CB;  
	asl.b $00                            ;C380C4|0600    |000000;  
...
.lbl_C38989
	...
	ply                                  ;C3898E|7A      |      ;  
	ldx.b $00                            ;C3898F|A600    |000000;  
	phx                                  ;C38991|DA      |      ;  
	phy                                  ;C38992|5A      |      ;  
	jsl.l CODE_C20BE7                    ;C38993|22E70BC2|C20BE7;  
	ply                                  ;C38997|7A      |      ;  
	plx                                  ;C38998|FA      |      ;  
...
.lbl_C389BA
	...
	ply                                  ;C389BF|7A      |      ;  
	ldx.b $00                            ;C389C0|A600    |000000;  
	phx                                  ;C389C2|DA      |      ;  
	phy                                  ;C389C3|5A      |      ;  
	jsl.l CODE_C303D0                    ;C389C4|22D003C3|C303D0;  
	ply                                  ;C389C8|7A      |      ;  
	plx                                  ;C389C9|FA      |      ;  
...
CODE_C38A3C:
	...
	sep #$20                             ;C38A3D|E220    |      ;  
	rep #$10                             ;C38A3F|C210    |      ;  
	jsl.l CODE_C62771                    ;C38A41|227127C6|C62771;  
	lda.b $00                            ;C38A45|A500    |000000;  
	pha                                  ;C38A47|48      |      ;  
	jsl.l CODE_C627E6                    ;C38A48|22E627C6|C627E6;  
	lda.b #$00                           ;C38A4C|A900    |      ;  
	xba                                  ;C38A4E|EB      |      ;  
	lda.b $00                            ;C38A4F|A500    |000000;  
	asl a                                ;C38A51|0A      |      ;  
	tax                                  ;C38A52|AA      |      ;  
...
.lbl_C38A81
	...
	ply                                  ;C38A86|7A      |      ;  
	ldx.b $00                            ;C38A87|A600    |000000;  
	lda.b w0001,s                          ;C38A89|A301    |000001;  
	sta.b $00                            ;C38A8B|8500    |000000;  
	phx                                  ;C38A8D|DA      |      ;  
	phy                                  ;C38A8E|5A      |      ;  
	jsl.l CODE_C3D3AB                    ;C38A8F|22ABD3C3|C3D3AB;  
	ply                                  ;C38A93|7A      |      ;  
	plx                                  ;C38A94|FA      |      ;  
...
CODE_C38B2F:
	php                                  ;C38B2F|08      |      ;  
	rep #$30                             ;C38B30|C230    |      ;  
	jsl.l CODE_C627DB                    ;C38B32|22DB27C6|C627DB;  
	lda.b $00                            ;C38B36|A500    |000000;  
	and.w #$00FF                         ;C38B38|29FF00  |      ;  
	sec                                  ;C38B3B|38      |      ;  
	sbc.w #$000A                         ;C38B3C|E90A00  |      ;  
	sta.b $00                            ;C38B3F|8500    |000000;  
	asl a                                ;C38B41|0A      |      ;  
	clc                                  ;C38B42|18      |      ;  
	adc.b $00                            ;C38B43|6500    |000000;  
	tax                                  ;C38B45|AA      |      ;  
	jsl.l CODE_C36BB0                    ;C38B46|22B06BC3|C36BB0;  
	lda.b $00                            ;C38B4A|A500    |000000;  
	dec a                                ;C38B4C|3A      |      ;  
	sta.b $00                            ;C38B4D|8500    |000000;  
	asl a                                ;C38B4F|0A      |      ;  
	clc                                  ;C38B50|18      |      ;  
	adc.b $00                            ;C38B51|6500    |000000;  
	tay                                  ;C38B53|A8      |      ;  
	sep #$20                             ;C38B54|E220    |      ;  
	lda.l DATA8_C3A15F,x                 ;C38B56|BF5FA1C3|C3A15F;  
	sta.b $00                            ;C38B5A|8500    |000000;  
	...
	iny                                  ;C38B6C|C8      |      ;  
	lda.b [$00],y                        ;C38B6D|B700    |000000;  
	sta.b $AA                            ;C38B6F|85AA    |0000AA;  
	iny                                  ;C38B71|C8      |      ;  
	lda.b [$00],y                        ;C38B72|B700    |000000;  
...
CODE_C38C08:
	...
	phx                                  ;C38C1A|DA      |      ;  
	jsl.l CODE_C36CBE                    ;C38C1B|22BE6CC3|C36CBE;  
	plx                                  ;C38C1F|FA      |      ;  
	pla                                  ;C38C20|68      |      ;  
	dec a                                ;C38C21|3A      |      ;  
	dex                                  ;C38C22|CA      |      ;  
...
CODE_C38C9F:
	php                                  ;C38C9F|08      |      ;  
	rep #$30                             ;C38CA0|C230    |      ;  
	jsl.l CODE_C627DB                    ;C38CA2|22DB27C6|C627DB;  
	lda.b $00                            ;C38CA6|A500    |000000;  
	and.w #$00FF                         ;C38CA8|29FF00  |      ;  
	sec                                  ;C38CAB|38      |      ;  
	sbc.w #$000A                         ;C38CAC|E90A00  |      ;  
	sta.b $00                            ;C38CAF|8500    |000000;  
	asl a                                ;C38CB1|0A      |      ;  
	clc                                  ;C38CB2|18      |      ;  
	adc.b $00                            ;C38CB3|6500    |000000;  
	tax                                  ;C38CB5|AA      |      ;  
	jsl.l CODE_C36BB0                    ;C38CB6|22B06BC3|C36BB0;  
	lda.b $00                            ;C38CBA|A500    |000000;  
	dec a                                ;C38CBC|3A      |      ;  
	sta.b $00                            ;C38CBD|8500    |000000;  
	asl a                                ;C38CBF|0A      |      ;  
	clc                                  ;C38CC0|18      |      ;  
	adc.b $00                            ;C38CC1|6500    |000000;  
	tay                                  ;C38CC3|A8      |      ;  
	sep #$20                             ;C38CC4|E220    |      ;  
	lda.l DATA8_C3A454,x                 ;C38CC6|BF54A4C3|C3A454;  
	sta.b $00                            ;C38CCA|8500    |000000;  
	...
	iny                                  ;C38CDC|C8      |      ;  
	lda.b [$00],y                        ;C38CDD|B700    |000000;  
	sta.b $AA                            ;C38CDF|85AA    |0000AA;  
	iny                                  ;C38CE1|C8      |      ;  
	lda.b [$00],y                        ;C38CE2|B700    |000000;  
...
CODE_C38D18:
	php                                  ;C38D18|08      |      ;  
	rep #$30                             ;C38D19|C230    |      ;  
	jsl.l CODE_C36BB0                    ;C38D1B|22B06BC3|C36BB0;  
	lda.b $00                            ;C38D1F|A500    |000000;  
	dec a                                ;C38D21|3A      |      ;  
	sta.b $00                            ;C38D22|8500    |000000;  
	asl a                                ;C38D24|0A      |      ;  
	clc                                  ;C38D25|18      |      ;  
	adc.b $00                            ;C38D26|6500    |000000;  
	tax                                  ;C38D28|AA      |      ;  
	sep #$20                             ;C38D29|E220    |      ;  
...
CODE_C38D72:
	php                                  ;C38D72|08      |      ;  
	rep #$30                             ;C38D73|C230    |      ;  
	jsl.l CODE_C36BB0                    ;C38D75|22B06BC3|C36BB0;  
	lda.b $00                            ;C38D79|A500    |000000;  
	dec a                                ;C38D7B|3A      |      ;  
	sta.b $00                            ;C38D7C|8500    |000000;  
	asl a                                ;C38D7E|0A      |      ;  
	clc                                  ;C38D7F|18      |      ;  
	adc.b $00                            ;C38D80|6500    |000000;  
	tax                                  ;C38D82|AA      |      ;  
	sep #$20                             ;C38D83|E220    |      ;  
...
CODE_C38E07:
	...
	bpl UNREACH_C38E27                   ;C38E23|1002    |C38E27;  
	plp                                  ;C38E25|28      |      ;  
	rtl                                  ;C38E26|6B      |      ;  
...
CODE_C38F34:
	...
	bpl UNREACH_C38F54                   ;C38F50|1002    |C38F54;  
	plp                                  ;C38F52|28      |      ;  
	rtl                                  ;C38F53|6B      |      ;  
...
CODE_C398C4:
	...
	sep #$20                             ;C398C5|E220    |      ;  
	rep #$10                             ;C398C7|C210    |      ;  
	jsl.l CODE_C62771                    ;C398C9|227127C6|C62771;  
	lda.b $00                            ;C398CD|A500    |000000;  
	pha                                  ;C398CF|48      |      ;  
...
.lbl_C398EC
	...
	phx                                  ;C39900|DA      |      ;  
	phy                                  ;C39901|5A      |      ;  
	jsl.l CODE_C3D3AB                    ;C39902|22ABD3C3|C3D3AB;  
	ply                                  ;C39906|7A      |      ;  
	plx                                  ;C39907|FA      |      ;  
	lda.b $00                            ;C39908|A500    |000000;  
...
.lbl_C399B3
	...
	beq UNREACH_C399E0                   ;C399BD|F021    |C399E0;  
...
CODE_C399EC:
	...
	bra CODE_C399A6                      ;C399F0|80B4    |C399A6;  
...
DATA8_C39A17:
	...
	jsr.w CODE_C396F1                    ;C39A1D|20F196  |C396F1;  
	jsr.w CODE_C3988B                    ;C39A20|208B98  |C3988B;  
	jsr.w CODE_C398C4                    ;C39A23|20C498  |C398C4;  
	rts                                  ;C39A26|60      |      ;  
...
.lbl_C39BA9
	...
	pha                                  ;C39BB8|48      |      ;  
	lda.b $04,s                          ;C39BB9|A304    |000004;  
	sta.b $00                            ;C39BBB|8500    |000000;  
	...
	lda.b $04,s                          ;C39BCD|A304    |000004;  
	sta.b $00                            ;C39BCF|8500    |000000;  
	...
	lda.b $04,s                          ;C39BE1|A304    |000004;  
	sta.b $00                            ;C39BE3|8500    |000000;  
	...
	lda.b $03,s                          ;C39BF5|A303    |000003;  
	sta.b $00                            ;C39BF7|8500    |000000;  
	...
	lda.b $04,s                          ;C39C09|A304    |000004;  
	inc a                                ;C39C0B|1A      |      ;  
	sta.b $00                            ;C39C0C|8500    |000000;  
	lda.b $03,s                          ;C39C0E|A303    |000003;  
	dec a                                ;C39C10|3A      |      ;  
	sta.b w0001                            ;C39C11|8501    |000001;  
	jsl.l CODE_C3F69F                    ;C39C13|229FF6C3|C3F69F;  
	ldx.b $00                            ;C39C17|A600    |000000;  
	lda.b $02,s                          ;C39C19|A302    |000002;  
	inc a                                ;C39C1B|1A      |      ;  
	sta.b $00                            ;C39C1C|8500    |000000;  
	lda.b w0001,s                          ;C39C1E|A301    |000001;  
	dec a                                ;C39C20|3A      |      ;  
	sta.b w0001                            ;C39C21|8501    |000001;  
	phx                                  ;C39C23|DA      |      ;  
	jsl.l CODE_C3F69F                    ;C39C24|229FF6C3|C3F69F;  
	plx                                  ;C39C28|FA      |      ;  
	ldy.b $00                            ;C39C29|A400    |000000;  
...
CODE_C39C44:
	...
	phx                                  ;C39C4D|DA      |      ;  
	jsl.l CODE_C359AF                    ;C39C4E|22AF59C3|C359AF;  
	plx                                  ;C39C52|FA      |      ;  
...
.lbl_C39E61
	...
	phx                                  ;C39E6D|DA      |      ;  
	jsl.l CODE_C3F69F                    ;C39E6E|229FF6C3|C3F69F;  
	plx                                  ;C39E72|FA      |      ;  
	lda.b $00                            ;C39E73|A500    |000000;  
	dec a                                ;C39E75|3A      |      ;  
	pha                                  ;C39E76|48      |      ;  
	clc                                  ;C39E77|18      |      ;  
	...
	sta.b $00                            ;C39E7F|8500    |000000;  
	clc                                  ;C39E81|18      |      ;  
	adc.b #$06                           ;C39E82|6906    |      ;  
	sta.b w0001                            ;C39E84|8501    |000001;  
	phx                                  ;C39E86|DA      |      ;  
	jsl.l CODE_C3F69F                    ;C39E87|229FF6C3|C3F69F;  
	plx                                  ;C39E8B|FA      |      ;  
	lda.b $00                            ;C39E8C|A500    |000000;  
	dec a                                ;C39E8E|3A      |      ;  
	pha                                  ;C39E8F|48      |      ;  
	clc                                  ;C39E90|18      |      ;  
	...
	lda.b $04,s                          ;C39EA3|A304    |000004;  
	sta.l $7EBE66,x                      ;C39EA5|9F66BE7E|7EBE66;  
	inc a                                ;C39EA9|1A      |      ;  
	sta.b $00                            ;C39EAA|8500    |000000;  
	lda.b $02,s                          ;C39EAC|A302    |000002;  
	...
	lda.b $04,s                          ;C39ED5|A304    |000004;  
	inc a                                ;C39ED7|1A      |      ;  
	sta.b $00                            ;C39ED8|8500    |000000;  
	lda.b $03,s                          ;C39EDA|A303    |000003;  
	dec a                                ;C39EDC|3A      |      ;  
	sta.b w0001                            ;C39EDD|8501    |000001;  
	jsl.l CODE_C3F69F                    ;C39EDF|229FF6C3|C3F69F;  
	ldx.b $00                            ;C39EE3|A600    |000000;  
	lda.b $02,s                          ;C39EE5|A302    |000002;  
	inc a                                ;C39EE7|1A      |      ;  
	sta.b $00                            ;C39EE8|8500    |000000;  
	lda.b w0001,s                          ;C39EEA|A301    |000001;  
	dec a                                ;C39EEC|3A      |      ;  
	sta.b w0001                            ;C39EED|8501    |000001;  
	phx                                  ;C39EEF|DA      |      ;  
	jsl.l CODE_C3F69F                    ;C39EF0|229FF6C3|C3F69F;  
	plx                                  ;C39EF4|FA      |      ;  
	ldy.b $00                            ;C39EF5|A400    |000000;  
...
CODE_C39F10:
	...
	phx                                  ;C39F19|DA      |      ;  
	jsl.l CODE_C359AF                    ;C39F1A|22AF59C3|C359AF;  
	plx                                  ;C39F1E|FA      |      ;  
...
.lbl_C39F43
	...
	lda.b $03,s                          ;C39F48|A303    |000003;  
	dec a                                ;C39F4A|3A      |      ;  
	sta.b w0001                            ;C39F4B|8501    |000001;  
	jsl.l CODE_C3F69F                    ;C39F4D|229FF6C3|C3F69F;  
	ldx.b $00                            ;C39F51|A600    |000000;  
	lda.b $02,s                          ;C39F53|A302    |000002;  
	inc a                                ;C39F55|1A      |      ;  
	sta.b $00                            ;C39F56|8500    |000000;  
	lda.b w0001,s                          ;C39F58|A301    |000001;  
	dec a                                ;C39F5A|3A      |      ;  
	sta.b w0001                            ;C39F5B|8501    |000001;  
	phx                                  ;C39F5D|DA      |      ;  
	jsl.l CODE_C3F69F                    ;C39F5E|229FF6C3|C3F69F;  
	plx                                  ;C39F62|FA      |      ;  
	ldy.b $00                            ;C39F63|A400    |000000;  
	stx.b $00                            ;C39F65|8600    |000000;  
	sty.b w0001                            ;C39F67|8401    |000001;  
	phx                                  ;C39F69|DA      |      ;  
	phy                                  ;C39F6A|5A      |      ;  
	jsl.l CODE_C20BE7                    ;C39F6B|22E70BC2|C20BE7;  
	ply                                  ;C39F6F|7A      |      ;  
	plx                                  ;C39F70|FA      |      ;  
...
CODE_C3D3AB:
	php                                  ;C3D3AB|08      |      ;  
	sep #$30                             ;C3D3AC|E230    |      ;  
	lda.b $00                            ;C3D3AE|A500    |000000;  
	pha                                  ;C3D3B0|48      |      ;  
	jsl.l CODE_C627DB                    ;C3D3B1|22DB27C6|C627DB;  
	lda.b $00                            ;C3D3B5|A500    |000000;  
...
CODE_C3D41F:
	php                                  ;C3D41F|08      |      ;  
	sep #$30                             ;C3D420|E230    |      ;  
	lda.b $00                            ;C3D422|A500    |000000;  
	tay                                  ;C3D424|A8      |      ;  
	asl a                                ;C3D425|0A      |      ;  
	pha                                  ;C3D426|48      |      ;  
	lda.b #$13                           ;C3D427|A913    |      ;  
	sta.b $00                            ;C3D429|8500    |000000;  
	jsl.l CODE_C210FF                    ;C3D42B|22FF10C2|C210FF;  
	sty.b $00                            ;C3D42F|8400    |000000;  
...
CODE_C3D43B:
	php                                  ;C3D43B|08      |      ;  
	sep #$30                             ;C3D43C|E230    |      ;  
	lda.b $00                            ;C3D43E|A500    |000000;  
	pha                                  ;C3D440|48      |      ;  
	lda.b #$13                           ;C3D441|A913    |      ;  
	sta.b $00                            ;C3D443|8500    |000000;  
	jsl.l CODE_C210FF                    ;C3D445|22FF10C2|C210FF;  
	lda.b w0001,s                          ;C3D449|A301    |000001;  
	sta.b $00                            ;C3D44B|8500    |000000;  
	jsl.l CODE_C62735                    ;C3D44D|223527C6|C62735;  
	jsl.l CODE_C3F65F                    ;C3D451|225FF6C3|C3F65F;  
	pla                                  ;C3D455|68      |      ;  
	asl a                                ;C3D456|0A      |      ;  
	tax                                  ;C3D457|AA      |      ;  
	rep #$30                             ;C3D458|C230    |      ;  
...
CODE_C3D528:
	php                                  ;C3D528|08      |      ;  
	sep #$30                             ;C3D529|E230    |      ;  
	lda.b $00                            ;C3D52B|A500    |000000;  
	ldx.b w0001                            ;C3D52D|A601    |000001;  
	phx                                  ;C3D52F|DA      |      ;  
	stx.b $00                            ;C3D530|8600    |000000;  
	asl a                                ;C3D532|0A      |      ;  
	pha                                  ;C3D533|48      |      ;  
	jsl.l CODE_C210FF                    ;C3D534|22FF10C2|C210FF;  
...
DATA8_C3D555:
	...
	sta.b $00                            ;C3D58B|8500    |000000;  
	jsl.l CODE_C27EAC                    ;C3D58D|22AC7EC2|C27EAC;  
	...
	sta.b $00                            ;C3D5E0|8500    |000000;  
	jsl.l CODE_C23BA6                    ;C3D5E2|22A63BC2|C23BA6;  
	lda.b #$94                           ;C3D5E6|A994    |      ;  
	sta.b $00                            ;C3D5E8|8500    |000000;  
...
.lbl_C3D6D3
	...
	phx                                  ;C3D6E0|DA      |      ;  
	jsl.l CODE_C30710                    ;C3D6E1|221007C3|C30710;  
	plx                                  ;C3D6E5|FA      |      ;  
...
CODE_C3D772:
	stx.b $00                            ;C3D772|8600    |000000;  
	phx                                  ;C3D774|DA      |      ;  
	jsl.l CODE_C30710                    ;C3D775|221007C3|C30710;  
	plx                                  ;C3D779|FA      |      ;  
	ldy.b $00                            ;C3D77A|A400    |000000;  
	...
	jsl.l CODE_C24390                    ;C3D7B1|229043C2|C24390;  
	rts                                  ;C3D7B5|60      |      ;  
...
.lbl_C3D87B
	...
	jsl.l CODE_C24073                    ;C3D8A5|227340C2|C24073;  
...
.lbl_C3D8E3
	...
	phx                                  ;C3D8E7|DA      |      ;  
	phy                                  ;C3D8E8|5A      |      ;  
	jsl.l CODE_C3D3AB                    ;C3D8E9|22ABD3C3|C3D3AB;  
	ply                                  ;C3D8ED|7A      |      ;  
	plx                                  ;C3D8EE|FA      |      ;  
...
.lbl_C3D915
	...
	jsl.l CODE_C23BA6                    ;C3D948|22A63BC2|C23BA6;  
	lda.b #$05                           ;C3D94C|A905    |      ;  
	sta.b $00                            ;C3D94E|8500    |000000;  
	...
	jsl.l CODE_C228DF                    ;C3D962|22DF28C2|C228DF;  
	rts                                  ;C3D966|60      |      ;  
	...
	jsl.l CODE_C240D6                    ;C3D9E1|22D640C2|C240D6;  
	rts                                  ;C3D9E5|60      |      ;  
...
DATA8_C3DA1C:
	...
	.db $00,$00                           ;C3DA2C
	sep #$20                             ;C3DA2E|E220    |      ;  
	jsl.l CODE_C23B89                    ;C3DA30|22893BC2|C23B89;  
	lda.b $00                            ;C3DA34|A500    |000000;  
...
UNREACH_C3DA5B:
	...
	sta.b $00                            ;C3DC2F|8500    |000000;  
	bra CODE_C3DC39                      ;C3DC31|8006    |C3DC39;  
	sep #$20                             ;C3DC33|E220    |      ;  
	rep #$10                             ;C3DC35|C210    |      ;  
	lda.b $00                            ;C3DC37|A500    |000000;  
...
CODE_C3DC39:
	...
	jsl.l CODE_C210AC                    ;C3DC45|22AC10C2|C210AC;  
	ldy.b $00                            ;C3DC49|A400    |000000;  
	lda.b #$C5                           ;C3DC4B|A9C5    |      ;  
	sta.b $00                            ;C3DC4D|8500    |000000;  
	jsl.l CODE_C23BA6                    ;C3DC4F|22A63BC2|C23BA6;  
...
.lbl_C3DC59
	...
	sta.b $00                            ;C3DC61|8500    |000000;  
	sta.b $06                            ;C3DC63|8506    |000006;  
	phx                                  ;C3DC65|DA      |      ;  
	jsl.l CODE_C359AF                    ;C3DC66|22AF59C3|C359AF;  
	plx                                  ;C3DC6A|FA      |      ;  
	sep #$20                             ;C3DC6B|E220    |      ;  
...
.lbl_C3DC72
	...
	phx                                  ;C3DC7A|DA      |      ;  
	phy                                  ;C3DC7B|5A      |      ;  
	jsl.l CODE_C306F4                    ;C3DC7C|22F406C3|C306F4;  
	ply                                  ;C3DC80|7A      |      ;  
	plx                                  ;C3DC81|FA      |      ;  
	lda.b $06                            ;C3DC82|A506    |000006;  
...
.lbl_C3DCDA
	...
	phx                                  ;C3DCDE|DA      |      ;  
	jsl.l CODE_C282EB                    ;C3DCDF|22EB82C2|C282EB;  
	plx                                  ;C3DCE3|FA      |      ;  
	lda.b w0001,s                          ;C3DCE4|A301    |000001;  
	sta.b $00                            ;C3DCE6|8500    |000000;  
	phx                                  ;C3DCE8|DA      |      ;  
	jsl.l CODE_C20F35                    ;C3DCE9|22350FC2|C20F35;  
	plx                                  ;C3DCED|FA      |      ;  
...
.lbl_C3DD78
	...
	jsl.l CODE_C228DF                    ;C3DD80|22DF28C2|C228DF;  
	rts                                  ;C3DD84|60      |      ;  

CODE_C3DD85:
	jsl.l CODE_C2816C                    ;C3DD85|226C81C2|C2816C;  
	rts                                  ;C3DD89|60      |      ;  
	...
	jsl.l CODE_C20F35                    ;C3DDD9|22350FC2|C20F35;  
	rts                                  ;C3DDDD|60      |      ;  
	...
	jsl.l CODE_C27EB7                    ;C3DF4A|22B77EC2|C27EB7;  
	rts                                  ;C3DF4E|60      |      ;  
	...
	jsl.l CODE_C228DF                    ;C3DFF1|22DF28C2|C228DF;  
	rts                                  ;C3DFF5|60      |      ;  
	...
	sep #$20                             ;C3E032|E220    |      ;  
	lda.b $00                            ;C3E034|A500    |000000;  
	pha                                  ;C3E036|48      |      ;  
	lda.b #$0A                           ;C3E037|A90A    |      ;  
	sta.b w0001                            ;C3E039|8501    |000001;  
	jsl.l CODE_C24073                    ;C3E03B|227340C2|C24073;  
	...
	jsl.l CODE_C240D6                    ;C3E079|22D640C2|C240D6;  
	rts                                  ;C3E07D|60      |      ;  
...
.lbl_C3E0DC
	...
	jsl.l CODE_C4854E                    ;C3E0F0|224E85C4|C4854E;  
...
CODE_C3E104:
	...
	sta.b $00                            ;C3E106|8500    |000000;  
	jsl.l CODE_C60003                    ;C3E108|220300C6|C60003;  
	jsl.l CODE_C62D0F                    ;C3E10C|220F2DC6|C62D0F;  
	rep #$30                             ;C3E110|C230    |      ;  
	sep #$20                             ;C3E112|E220    |      ;  
	stz.b $00                            ;C3E114|6400    |000000;  
...
CODE_C3E131:
	php                                  ;C3E131|08      |      ;  
	sep #$30                             ;C3E132|E230    |      ;  
	lda.b $00                            ;C3E134|A500    |000000;  
	asl a                                ;C3E136|0A      |      ;  
	clc                                  ;C3E137|18      |      ;  
	adc.b $00                            ;C3E138|6500    |000000;  
	tax                                  ;C3E13A|AA      |      ;  
...
.lbl_C3E229
	...
	iny                                  ;C3E22F|C8      |      ;  
	bra CODE_C3E258                      ;C3E230|8026    |C3E258;  
...
CODE_C3E258:
	...
	jsl.l CODE_C28FF5                    ;C3E266|22F58FC2|C28FF5;  
	plp                                  ;C3E26A|28      |      ;  
	rtl                                  ;C3E26B|6B      |      ;  
...
CODE_C3E2F7:
	...
	sta.b $06                            ;C3E311|8506    |000006;  
	lda.b $00                            ;C3E313|A500    |000000;  
	asl a                                ;C3E315|0A      |      ;  
	clc                                  ;C3E316|18      |      ;  
	adc.b $00                            ;C3E317|6500    |000000;  
	tax                                  ;C3E319|AA      |      ;  
	lda.l DATA8_C3E14F,x                 ;C3E31A|BF4FE1C3|C3E14F;  
	sta.b $00                            ;C3E31E|8500    |000000;  
...
.lbl_C3E5AB
	...
	ply                                  ;C3E5B2|7A      |      ;  
	sty.b $00                            ;C3E5B3|8400    |000000;  
	jsl.l CODE_C3E131                    ;C3E5B5|2231E1C3|C3E131;  
...
CODE_C3E5F2:
	php                                  ;C3E5F2|08      |      ;  
	jsl.l CODE_C3E66B                    ;C3E5F3|226BE6C3|C3E66B;  
	sep #$20                             ;C3E5F7|E220    |      ;  
...
CODE_C3E66B:
	php                                  ;C3E66B|08      |      ;  
	sep #$30                             ;C3E66C|E230    |      ;  
	lda.b $00                            ;C3E66E|A500    |000000;  
	sta.b $B5                            ;C3E670|85B5    |0000B5;  
	jsl.l CODE_C3E131                    ;C3E672|2231E1C3|C3E131;  
...
CODE_C3E698:
	...
	sta.b $00                            ;C3E69B|8500    |000000;  
	plp                                  ;C3E69D|28      |      ;  
	rtl                                  ;C3E69E|6B      |      ;  

CODE_C3E69F:
	sep #$30                             ;C3E69F|E230    |      ;  
	lda.b $00                            ;C3E6A1|A500    |000000;  
	jsl.l CODE_C3E66B                    ;C3E6A3|226BE6C3|C3E66B;  
	jsl.l CODE_C3E0CD                    ;C3E6A7|22CDE0C3|C3E0CD;  

CODE_C3E6AB:
	sep #$30                             ;C3E6AB|E230    |      ;  
	lda.b $00                            ;C3E6AD|A500    |000000;  
	pha                                  ;C3E6AF|48      |      ;  
	jsl.l CODE_C3E66B                    ;C3E6B0|226BE6C3|C3E66B;  
	pla                                  ;C3E6B4|68      |      ;  
	sta.b $00                            ;C3E6B5|8500    |000000;  
	jsl.l CODE_C3E1C7                    ;C3E6B7|22C7E1C3|C3E1C7;  
	lda.b #$FF                           ;C3E6BB|A9FF    |      ;  
	sta.b $00                            ;C3E6BD|8500    |000000;  
	jsl.l CODE_C3E16A                    ;C3E6BF|226AE1C3|C3E16A;  
	jsl.l CODE_C3E6D3                    ;C3E6C3|22D3E6C3|C3E6D3;  
	jsl.l CODE_C3E5CD                    ;C3E6C7|22CDE5C3|C3E5CD;  
	jsl.l CODE_C3E658                    ;C3E6CB|2258E6C3|C3E658;  
	jsl.l CODE_C3E0CD                    ;C3E6CF|22CDE0C3|C3E0CD;  
...
CODE_C3E6D3:
	...
	sta.b $00                            ;C3E6FE|8500    |000000;  
	jsl.l CODE_C3E80B                    ;C3E700|220BE8C3|C3E80B;  
	plp                                  ;C3E704|28      |      ;  
	rtl                                  ;C3E705|6B      |      ;  

CODE_C3E706:
	php                                  ;C3E706|08      |      ;  
	jsl.l CODE_C3E66B                    ;C3E707|226BE6C3|C3E66B;  
	sep #$20                             ;C3E70B|E220    |      ;  
...
CODE_C3E72B:
	...
	rep #$20                             ;C3E72C|C220    |      ;  
	sep #$10                             ;C3E72E|E210    |      ;  
	lda.b $00                            ;C3E730|A500    |000000;  
	pha                                  ;C3E732|48      |      ;  
	jsl.l CODE_C3E2F7                    ;C3E733|22F7E2C3|C3E2F7;  
	pla                                  ;C3E737|68      |      ;  
	sta.b $00                            ;C3E738|8500    |000000;  
	ldx.b w0001                            ;C3E73A|A601    |000001;  
	ldy.b $00                            ;C3E73C|A400    |000000;  
	stx.b $00                            ;C3E73E|8600    |000000;  
	phy                                  ;C3E740|5A      |      ;  
	jsl.l CODE_C3E66B                    ;C3E741|226BE6C3|C3E66B;  
	ply                                  ;C3E745|7A      |      ;  
	lda.b $B2                            ;C3E746|A5B2    |0000B2;  
	ldx.b $B4                            ;C3E748|A6B4    |0000B4;  
	sty.b $00                            ;C3E74A|8400    |000000;  
	pha                                  ;C3E74C|48      |      ;  
	phx                                  ;C3E74D|DA      |      ;  
...
CODE_C3E7C8:
	...
	jmp.w CODE_C3E7AA                    ;C3E7CE|4CAAE7  |C3E7AA;  

CODE_C3E7D1:
	php                                  ;C3E7D1|08      |      ;  
	rep #$10                             ;C3E7D2|C210    |      ;  
	ldy.w #$000C                         ;C3E7D4|A00C00  |      ;  
	jmp.w CODE_C3E7B8                    ;C3E7D7|4CB8E7  |C3E7B8;  
...
CODE_C3E802:
	...
	jmp.w CODE_C3E7AA                    ;C3E808|4CAAE7  |C3E7AA;  

CODE_C3E80B:
	php                                  ;C3E80B|08      |      ;  
	rep #$10                             ;C3E80C|C210    |      ;  
	ldy.w #$000F                         ;C3E80E|A00F00  |      ;  
	jmp.w CODE_C3E7B8                    ;C3E811|4CB8E7  |C3E7B8;  

CODE_C3E814:
	php                                  ;C3E814|08      |      ;  
	rep #$10                             ;C3E815|C210    |      ;  
	ldy.w #$000E                         ;C3E817|A00E00  |      ;  
	jmp.w CODE_C3E7AA                    ;C3E81A|4CAAE7  |C3E7AA;  

CODE_C3E81D:
	php                                  ;C3E81D|08      |      ;  
	rep #$10                             ;C3E81E|C210    |      ;  
	ldy.w #$000E                         ;C3E820|A00E00  |      ;  
	jmp.w CODE_C3E7B8                    ;C3E823|4CB8E7  |C3E7B8;  
...
CODE_C3E85C:
	php                                  ;C3E85C|08      |      ;  
	sep #$20                             ;C3E85D|E220    |      ;  
	stz.b $07                            ;C3E85F|6407    |000007;  
	rep #$30                             ;C3E861|C230    |      ;  
	lda.b $06                            ;C3E863|A506    |000006;  
	asl a                                ;C3E865|0A      |      ;  
	clc                                  ;C3E866|18      |      ;  
	adc.b $06                            ;C3E867|6506    |000006;  
	asl a                                ;C3E869|0A      |      ;  
	clc                                  ;C3E86A|18      |      ;  
	adc.w #$0110                         ;C3E86B|691001  |      ;  
	tay                                  ;C3E86E|A8      |      ;  
	lda.b [$B2],y                        ;C3E86F|B7B2    |0000B2;  
	sta.b $00                            ;C3E871|8500    |000000;  
	iny                                  ;C3E873|C8      |      ;  
	iny                                  ;C3E874|C8      |      ;  
...
CODE_C3E881:
	php                                  ;C3E881|08      |      ;  
	sep #$20                             ;C3E882|E220    |      ;  
	stz.b $07                            ;C3E884|6407    |000007;  
	rep #$30                             ;C3E886|C230    |      ;  
	lda.b $06                            ;C3E888|A506    |000006;  
	asl a                                ;C3E88A|0A      |      ;  
	clc                                  ;C3E88B|18      |      ;  
	adc.b $06                            ;C3E88C|6506    |000006;  
	asl a                                ;C3E88E|0A      |      ;  
	clc                                  ;C3E88F|18      |      ;  
	adc.w #$0110                         ;C3E890|691001  |      ;  
	tay                                  ;C3E893|A8      |      ;  
	lda.b [$B2],y                        ;C3E894|B7B2    |0000B2;  
	eor.b $00                            ;C3E896|4500    |000000;  
	sta.b $06                            ;C3E898|8506    |000006;  
	lda.b $00                            ;C3E89A|A500    |000000;  
...
.lbl_C3E951
	...
	jsl.l CODE_C359AF                    ;C3E95A|22AF59C3|C359AF;  
...
CODE_C3E9BC:
	jsl.l CODE_C3F3E7                    ;C3E9BC|22E7F3C3|C3F3E7;  
	ldx.w #$0000                         ;C3E9C0|A20000  |      ;  
	stx.b $00                            ;C3E9C3|8600    |000000;  
	phx                                  ;C3E9C5|DA      |      ;  
	jsl.l func_80DC0C                    ;C3E9C6|220CDC80|80DC0C;  
	plx                                  ;C3E9CA|FA      |      ;  
	ldy.b $00                            ;C3E9CB|A400    |000000;  
	phy                                  ;C3E9CD|5A      |      ;  
...
CODE_C3E9DF:
	ply                                  ;C3E9DF|7A      |      ;  
	lda.b $00                            ;C3E9E0|A500    |000000;  
	pha                                  ;C3E9E2|48      |      ;  
	sty.b $00                            ;C3E9E3|8400    |000000;  
...
CODE_C3EB97:
	...
	bra CODE_C3EBAD                      ;C3EBA1|800A    |C3EBAD;  
...
.lbl_C3EBF9
	...
	sta.b $00                            ;C3EC11|8500    |000000;  
	bra CODE_C3EBE6                      ;C3EC13|80D1    |C3EBE6;  
...
CODE_C3ED51:
	php                                  ;C3ED51|08      |      ;  
	rep #$30                             ;C3ED52|C230    |      ;  
	jsl.l CODE_C07D19                    ;C3ED54|22197DC0|C07D19;  
	jsl.l CODE_C4854E                    ;C3ED58|224E85C4|C4854E;  
...
CODE_C3ED74:
	php                                  ;C3ED74|08      |      ;  
	rep #$30                             ;C3ED75|C230    |      ;  
	lda.b $00                            ;C3ED77|A500    |000000;  
	pha                                  ;C3ED79|48      |      ;  
	jsl.l CODE_C07D19                    ;C3ED7A|22197DC0|C07D19;  
	jsl.l CODE_C4854E                    ;C3ED7E|224E85C4|C4854E;  
	pla                                  ;C3ED82|68      |      ;  
...
DATA8_C3F142:
	...
	sta.b $00                            ;C3F162|8500    |000000;  
	bra CODE_C3F177                      ;C3F164|8011    |C3F177;  
	lda.w #$0040                         ;C3F166|A94000  |      ;  
	tsb.b $00                            ;C3F169|0400    |000000;  
...
CODE_C3F17D:
	php                                  ;C3F17D|08      |      ;  
	sep #$30                             ;C3F17E|E230    |      ;  
	ldx.b $00                            ;C3F180|A600    |000000;  
	phx                                  ;C3F182|DA      |      ;  
	cpx.b #$1F                           ;C3F183|E01F    |      ;  
	beq UNREACH_C3F18D                   ;C3F185|F006    |C3F18D;  
	jsl.l CODE_C23B7C                    ;C3F187|227C3BC2|C23B7C;  
	bra CODE_C3F19D                      ;C3F18B|8010    |C3F19D;  
...
.lbl_C3F1C7
	...
	bra CODE_C3F1F0                      ;C3F1CC|8022    |C3F1F0;  
...
.lbl_C3F1D1
	...
	bmi UNREACH_C3F1F3                   ;C3F1D9|3018    |C3F1F3;  
	lda.b w0001,s                          ;C3F1DB|A301    |000001;  
	sta.b $00                            ;C3F1DD|8500    |000000;  
	jsl.l CODE_C4A0B1                    ;C3F1DF|22B1A0C4|C4A0B1;  
	bcs UNREACH_C3F1F3                   ;C3F1E3|B00E    |C3F1F3;  
	lda.b $00                            ;C3F1E5|A500    |000000;  
	sta.b w0001                            ;C3F1E7|8501    |000001;  
	pla                                  ;C3F1E9|68      |      ;  
	ora.b #$A0                           ;C3F1EA|09A0    |      ;  
	sta.b $00                            ;C3F1EC|8500    |000000;  
	bra CODE_C3F177                      ;C3F1EE|8087    |C3F177;  
...
CODE_C3F1F7:
	php                                  ;C3F1F7|08      |      ;  
	sep #$30                             ;C3F1F8|E230    |      ;  
	lda.b $00                            ;C3F1FA|A500    |000000;  
	pha                                  ;C3F1FC|48      |      ;  
	cmp.b #$1F                           ;C3F1FD|C91F    |      ;  
	beq UNREACH_C3F209                   ;C3F1FF|F008    |C3F209;  
	sta.b $00                            ;C3F201|8500    |000000;  
	jsl.l CODE_C23B7C                    ;C3F203|227C3BC2|C23B7C;  
	bra CODE_C3F219                      ;C3F207|8010    |C3F219;  
...
CODE_C3F219:
	jsl.l CODE_C49A97                    ;C3F219|22979AC4|C49A97;  
	bcc UNREACH_C3F223                   ;C3F21D|9004    |C3F223;  
	pla                                  ;C3F21F|68      |      ;  
	plp                                  ;C3F220|28      |      ;  
	sec                                  ;C3F221|38      |      ;  
	rts                                  ;C3F222|60      |      ;  
...
CODE_C3F2FD:
	php                                  ;C3F2FD|08      |      ;  
	sep #$30                             ;C3F2FE|E230    |      ;  
	ldy.b $00                            ;C3F300|A400    |000000;  
	phy                                  ;C3F302|5A      |      ;  
	jsl.l CODE_C30710                    ;C3F303|221007C3|C30710;  
	ply                                  ;C3F307|7A      |      ;  
	lda.b w0001                            ;C3F308|A501    |000001;  
	cmp.b #$68                           ;C3F30A|C968    |      ;  
	beq UNREACH_C3F310                   ;C3F30C|F002    |C3F310;  
	plp                                  ;C3F30E|28      |      ;  
	rtl                                  ;C3F30F|6B      |      ;  
...
CODE_C3F336:
	php                                  ;C3F336|08      |      ;  
	sep #$30                             ;C3F337|E230    |      ;  
	ldy.b $00                            ;C3F339|A400    |000000;  
	phy                                  ;C3F33B|5A      |      ;  
	jsl.l CODE_C30710                    ;C3F33C|221007C3|C30710;  
	ply                                  ;C3F340|7A      |      ;  
...
.lbl_C3F3A0
	...
	jsl.l CODE_C3E80B                    ;C3F3A7|220BE8C3|C3E80B;  
	lda.w #$0004                         ;C3F3AB|A90400  |      ;  

CODE_C3F3AE:
	sta.b $00                            ;C3F3AE|8500    |000000;  
...
CODE_C3F69F:
	...
	sec                                  ;C3F6A4|38      |      ;  
	sbc.b $00                            ;C3F6A5|E500    |000000;  
	inc a                                ;C3F6A7|1A      |      ;  
	ldy.b $00                            ;C3F6A8|A400    |000000;  
	pha                                  ;C3F6AA|48      |      ;  
	jsl.l CODE_C3F65F                    ;C3F6AB|225FF6C3|C3F65F;  
	pla                                  ;C3F6AF|68      |      ;  
	sta.b w0001                            ;C3F6B0|8501    |000001;  
	jsl.l CODE_C3E3CB                    ;C3F6B2|22CBE3C3|C3E3CB;  
	tya                                  ;C3F6B6|98      |      ;  
	clc                                  ;C3F6B7|18      |      ;  
	adc.b w0001                            ;C3F6B8|6501    |000001;  
	sta.b $00                            ;C3F6BA|8500    |000000;  
	plp                                  ;C3F6BC|28      |      ;  
	rtl                                  ;C3F6BD|6B      |      ;  
