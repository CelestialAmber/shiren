...
.include "data/unknown_data_bank3_c341bb.asm"
...
DATA8_C3E5EC:
	.db $56,$41,$4C,$00,$44,$00 ;4th byte modified
...
func_C3E768:
	php
	rep #$30 ;AXY->16
	ldy.w #$0004 ;modified from 6 to 4
	lda.b [$B2],y
	sta.b wTemp00
	iny
	iny
