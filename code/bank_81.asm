...
.lbl_8184BD
	...
	beq .lbl_8184E1                      ;8184C0|F01F    |C184E1;  
	stz.w $0EAA                          ;8184C2|9CAA0E  |810EAA;  
	dec a                                ;8184C5|3A      |      ;  
	sta.w $0C52,x                        ;8184C6|9D520C  |810C52;  
	bne .lbl_8184E1                      ;8184C9|D016    |C184E1;  
...
.lbl_81850C
	...
	beq .lbl_8184E1                      ;81850E|F0D1    |C184E1;  
	tay                                  ;818510|A8      |      ;  
	and.b #$3F                           ;818511|293F    |      ;  
	cmp.b #$29                           ;818513|C929    |      ;  
	bcs .lbl_8184E4                      ;818515|B0CD    |C184E4;  
...
.lbl_8193A9
	...
	beq .lbl_8193DC                      ;8193AF|F02B    |C193DC;  
	lda.w $2856,y                        ;8193B1|B95628  |7E2856;  
	bmi .lbl_8193DC                      ;8193B4|3026    |C193DC;  
...
.lbl_8193DC
	dey                                  ;8193DC|88      |      ;  
	dey                                  ;8193DD|88      |      ;  
	bpl .lbl_8193A9                      ;8193DE|10C9    |C193A9;  
...
.lbl_819600
	...
	beq .lbl_81962F                      ;819606|F027    |C1962F;  
	lda.w $282E,y                        ;819608|B92E28  |7E282E;  
	bmi .lbl_81962F                      ;81960B|3022    |C1962F;  
...
.lbl_81962F
	dey                                  ;81962F|88      |      ;  
	dey                                  ;819630|88      |      ;  
	bpl .lbl_819600                      ;819631|10CD    |C19600;  
	rts                                  ;819633|60      |      ;  
...
func_819740:
	...
	beq .lbl_8197C0                      ;819762|F05C    |C197C0;  
...
func_8197A5:
	...
	dex                                  ;8197A9|CA      |      ;  
	dex                                  ;8197AA|CA      |      ;  
	beq .lbl_8197C0                      ;8197AB|F013    |C197C0;  
...
.lbl_81A79B
	...
	bpl .lbl_81A7D1                      ;81A79E|1031    |C1A7D1;  
...
.lbl_81A7D1
	dey                                  ;81A7D1|88      |      ;  
	dey                                  ;81A7D2|88      |      ;  
	bpl .lbl_81A79B                      ;81A7D3|10C6    |C1A79B;  
...
func_81AD36:
	...
	bcs .lbl_81AD71                      ;81AD44|B02B    |C1AD71;  
...
func_81B044:
	...
	bne .lbl_81B062                      ;81B04B|D015    |C1B062;  
	lda.w #$0045                         ;81B04D|A94500  |      ;  
	bra .lbl_81B062                      ;81B050|8010    |C1B062;  
	lda.w #$0043                         ;81B052|A94300  |      ;  
	cpy.w #$0026                         ;81B055|C02600  |      ;  
	bne .lbl_81B062                      ;81B058|D008    |C1B062;  
	lda.w #$0044                         ;81B05A|A94400  |      ;  
	bra .lbl_81B062                      ;81B05D|8003    |C1B062;  
...
.lbl_81C17E
	...
	jmp.w .lbl_81C21C                    ;81C181|4C1CC2  |C1C21C;  
.lbl_81C184
	rep #$20                             ;81C184|C220    |      ;  
...
func_81C18E:
	...
	beq .lbl_81C18B                      ;81C196|F0F3    |C1C18B;  
	lda.w $3431                          ;81C198|AD3134  |7E3431;  
	bmi .lbl_81C184                      ;81C19B|30E7    |C1C184;  
...
.lbl_81C1A8
	...
	bcs .lbl_81C184                      ;81C1AD|B0D5    |C1C184;  

func_81C1AF:
	tax                                  ;81C1AF|AA      |      ;  
	lda.l DATA8_C6CADC,x                 ;81C1B0|BFDCCAC6|C6CADC;  
	cmp.b #$FF                           ;81C1B4|C9FF    |      ;  
	beq .lbl_81C184                      ;81C1B6|F0CC    |C1C184;  
...
.lbl_81C20C
	...
	beq .lbl_81C21C                      ;81C217|F003    |C1C21C;  
...
.lbl_81C349
	...
	jmp.w .lbl_81C480                    ;81C359|4C80C4  |C1C480;  
.lbl_81C35C
	asl a                                ;81C35C|0A      |      ;  
...
.lbl_81C440
	...
	beq .lbl_81C480                      ;81C459|F025    |C1C480;  
...
func_81D27E:
	...
	bcs .lbl_81D2CF                      ;81D285|B048    |C1D2CF;  
...
.lbl_81D2C6
	...
	beq .lbl_81D2CF                      ;81D2CB|F002    |C1D2CF;  
...
func_81D8D5:
	...
	bne .lbl_81D8F2                      ;81D8D9|D017    |C1D8F2;  
...
func_81D8F3:
	...
	beq .lbl_81D8F2                      ;81D8F7|F0F9    |C1D8F2;  
	lda.w $1040                          ;81D8F9|AD4010  |001040;  
	beq .lbl_81D8F2                      ;81D8FC|F0F4    |C1D8F2;  
