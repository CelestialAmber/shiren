...
;dd74e1
incbin "1D74E1_02AC.brr"
	
;dd778d
	db $02,$03,$D0,$02,$81   ;DD778A|        |      ; 

;dd7792
incbin "1D7792_02FD.brr"
...
;dd844e
incbin "1D844E_03C3.brr"

;dd8811
	db $A4,$03,$84,$03,$4E
	
;dd8816
incbin "1D8816_039F.brr"
	
;dd8bb5	
db $72,$02,$1B,$00,$03,$21,$20,$00,$00,$00,$16,$00,$00,$00
	
;dd8bc3
incbin "1D8BC3_0264.brr"
...
;dd8e35
incbin "1D8E35_03F0.brr"
	
;dd9225
db $B6,$03,$57,$03,$B8

;dd922a
incbin "1D922A_03B1.brr"
	
;dd95db
db $3D,$04,$57,$03,$5A

;dd95e0	
incbin "1D95E0_0438.brr"

;dd9a18
db $CC,$02,$91,$02,$73
	
;dd9a1d
incbin "1D9A1D_02C7.brr"
...
;dd9cf2
incbin "1D9CF2_04B6.brr"
	
;dda1a8
db $30,$05,$D9,$02,$55

;dda1ad
incbin "1DA1AD_052B.brr"
	
;dda6d8
db $F5,$03,$21,$03,$FF
	
;dda6dd	
incbin "1DA6DD_03F0.brr"
...
;ddaadb
incbin "1DAADB_0B37.brr"

;ddb612 
db $63,$11,$FB,$10,$8F
	
;ddb617
incbin "1DB617_115E.brr"
	
;ddc775
db $55,$19,$11,$19,$81

;ddc77a
incbin "1DC77A_1950.brr"
...
;dde302  
incbin "1DE302_0465.brr"
	
;dde767	
	db $08,$06,$BB,$05,$4F
	
;dde76c
incbin "1DE76C_0603.brr"

;dded6f
db $EE,$07,$A1,$07,$FF

;dded74
incbin "1DED74_07E9.brr"
	
;ddf55d
	db $8B,$07,$C9,$06,$88   ;DDF55A|        |      ;

;ddf562
incbin "1DF562_0786.brr"
	
;ddfce8
db $81,$0E,$4C,$08,$D9
	
;ddfced
;bytes 0x000-313 of brr file (continued in next bank)
incbin "1DFCED_0E7C.brr"