...
func_81992B:
	sta.b $04                   ;81992B|8504    |000004;  
	pla                                  ;81992D|68      |      ;  
	sta.b $02                   ;81992E|8502    |000002;  
...
func_8199D3:
	...
	lda.b $02                   ;8199EB|A502    |000002;  
	pha                                  ;8199ED|48      |      ;  
	sec                                  ;8199EE|38      |      ;  
	sbc.w #$0008                         ;8199EF|E90800  |      ;  
	sta.b $02                   ;8199F2|8502    |000002;  
	jsl.l func_809617                    ;8199F4|22179680|809617;  
	lda.b $04                   ;8199F8|A504    |000004;  
	clc                                  ;8199FA|18      |      ;  
	adc.w #$0010                         ;8199FB|691000  |      ;  
	sta.b $04                   ;8199FE|8504    |000004;  
...
func_819A2E:
	...
	clc                                  ;819AA5|18      |      ;  
	adc.b $04                   ;819AA6|6504    |000004;  
	sta.b $04                   ;819AA8|8504    |000004;  
...
func_819ACD:
	...
	lda.b $02                   ;819B32|A502    |000002;  
	sec                                  ;819B34|38      |      ;  
	sbc.w #$0004                         ;819B35|E90400  |      ;  
	sta.b $02                   ;819B38|8502    |000002;  
	lda.b $04                   ;819B3A|A504    |000004;  
	sec                                  ;819B3C|38      |      ;  
	sbc.w #$0004                         ;819B3D|E90400  |      ;  
	sta.b $04                   ;819B40|8504    |000004;  
	jsl.l func_8095BE                    ;819B42|22BE9580|8095BE;  
	jmp.w func_8197A5                    ;819B46|4CA597  |C197A5;  
	lda.b $02                   ;819B49|A502    |000002;  
	sec                                  ;819B4B|38      |      ;  
	sbc.w #$0008                         ;819B4C|E90800  |      ;  
	sta.b $02                   ;819B4F|8502    |000002;  
	lda.b $04                   ;819B51|A504    |000004;  
	sec                                  ;819B53|38      |      ;  
	sbc.w #$0008                         ;819B54|E90800  |      ;  
	sta.b $04                   ;819B57|8504    |000004;  
...
func_819E14:
	...
	pha                                  ;819E16|48      |      ;  
	lda.b $04                   ;819E17|A504    |000004;  
	pha                                  ;819E19|48      |      ;  
	lda.b $02                   ;819E1A|A502    |000002;  
	pha                                  ;819E1C|48      |      ;  
...
func_81A141:
	...
	lda.b $02                   ;81A155|A502    |000002;  
	pha                                  ;81A157|48      |      ;  
	phx                                  ;81A158|DA      |      ;  
	jsl.l func_81A169                    ;81A159|2269A181|81A169;  
	plx                                  ;81A15D|FA      |      ;  
	pla                                  ;81A15E|68      |      ;  
	sta.b $02                   ;81A15F|8502    |000002;  
...
func_81A169:
	...
	sta.b $02                   ;81A190|8502    |000002;  
	lda.w #$00FB                         ;81A192|A9FB00  |      ;  
	sta.b $04                   ;81A195|8504    |000004;  
...
Jumptable_81A1D7:
	...
	lda.b $02                   ;81A1E3|A502    |000002;  
	sec                                  ;81A1E5|38      |      ;  
	sbc.w #$0080                         ;81A1E6|E98000  |      ;  
	sta.b $04                   ;81A1E9|8504    |000004;  
	clc                                  ;81A1EB|18      |      ;  
...
func_81A300:
	...
	lda.b $02                   ;81A332|A502    |000002;  
	sta.b $04                   ;81A334|8504    |000004;  
	lda.b $00                            ;81A336|A500    |000000;  
	inc a                                ;81A338|1A      |      ;  
	sta.b $02                   ;81A339|8502    |000002;  
...
func_81A6FA:
	...
	sta.b $02                   ;81A71C|8502    |000002;  
	lda.w #$00FB                         ;81A71E|A9FB00  |      ;  
	sta.b $04                   ;81A721|8504    |000004;  
...
func_81A84F:
	...
	sta.b $02                   ;81A85F|8502    |000002;  
	lda.l $7E346C,x                      ;81A861|BF6C347E|7E346C;  
	sta.b $04                   ;81A865|8504    |000004;  
	phb                                  ;81A867|8B      |      ;  
	phk                                  ;81A868|4B      |      ;  
	plb                                  ;81A869|AB      |      ;  
...
func_81A961:
	...
	sta.b $02                   ;81A972|8502    |000002;  
	tyx                                  ;81A974|BB      |      ;  
	lda.l DATA8_81BEAD,x                 ;81A975|BFADBE81|81BEAD;  
	sta.b $04                   ;81A979|8504    |000004;  
...
func_81B8C6:
	...
	sta.b $02                   ;81B8FB|8502    |000002;  
	lda.w #$38BC                         ;81B8FD|A9BC38  |      ;  
	sta.b $04                   ;81B900|8504    |000004;  
	phb                                  ;81B902|8B      |      ;  
	phy                                  ;81B903|5A      |      ;  
	...
	sta.b $02                   ;81B934|8502    |000002;  
	pla                                  ;81B936|68      |      ;  
	sta.b $04                   ;81B937|8504    |000004;  
...
func_81C08C:
	...
	sta.b $02                   ;81C0CD|8502    |000002;  
	ldx.b #$FB                           ;81C0CF|A2FB    |      ;  
	stx.b $04                   ;81C0D1|8604    |000004;  
...
func_81C115:
	...
	sta.b $02                   ;81C133|8502    |000002;  
	lda.w #$4080                         ;81C135|A98040  |      ;  
	sta.b $04                   ;81C138|8504    |000004;  
...
func_81C1AF:
	...
	sta.b $02                   ;81C1E4|8502    |000002;  
	lda.w #$4080                         ;81C1E6|A98040  |      ;  
	sta.b $04                   ;81C1E9|8504    |000004;  
...
func_81C29C:
	...
	sta.b $02                   ;81C2C2|8502    |000002;  
	ldx.w #$00FB                         ;81C2C4|A2FB00  |      ;  
	stx.b $04                   ;81C2C7|8604    |000004;  
...
func_81C545:
	...
	lda.b $02                   ;81C54A|A502    |000002;  
	pha                                  ;81C54C|48      |      ;  
	sep #$20                             ;81C54D|E220    |      ;  
	lda.b #$03                           ;81C54F|A903    |      ;  
	sta.b $02                   ;81C551|8502    |000002;  
	rep #$20                             ;81C553|C220    |      ;  
	phy                                  ;81C555|5A      |      ;  
	phb                                  ;81C556|8B      |      ;  
...
func_81C9F7:
	...
	lda.b $04                   ;81C9FE|A504    |000004;  
	clc                                  ;81CA00|18      |      ;  
	adc.w #$0020                         ;81CA01|692000  |      ;  
	sta.b $04                   ;81CA04|8504    |000004;  
...
func_81CB47:
	...
	pha                                  ;81CB5E|48      |      ;  
	pha                                  ;81CB5F|48      |      ;  
	lda.b $04                   ;81CB60|A504    |000004;  
	tax                                  ;81CB62|AA      |      ;  
	clc                                  ;81CB63|18      |      ;  
	adc.w #$0020                         ;81CB64|692000  |      ;  
	sta.b $04                   ;81CB67|8504    |000004;  
...
func_81CB80:
	...
	lda.b $04                   ;81CB88|A504    |000004;  
	tax                                  ;81CB8A|AA      |      ;  
	clc                                  ;81CB8B|18      |      ;  
	adc.w #$0020                         ;81CB8C|692000  |      ;  
	sta.b $04                   ;81CB8F|8504    |000004;  
...
func_81CC29:
	...
	lda.b $02                   ;81CC2E|A502    |000002;  
	asl a                                ;81CC30|0A      |      ;  
	asl a                                ;81CC31|0A      |      ;  
	asl a                                ;81CC32|0A      |      ;  
	asl a                                ;81CC33|0A      |      ;  
	sec                                  ;81CC34|38      |      ;  
	sbc.b $02                   ;81CC35|E502    |000002;  
	asl a                                ;81CC37|0A      |      ;  
	adc.w #$C66D                         ;81CC38|696DC6  |      ;  
	sta.b $02                   ;81CC3B|8502    |000002;  
	lda.w #$00FB                         ;81CC3D|A9FB00  |      ;  
	sta.b $04                   ;81CC40|8504    |000004;  
...
func_81D084:
	...
	sta.b $02                   ;81D0ED|8502    |000002;  
	jsl.l CODE_C4C422                    ;81D0EF|2222C4C4|C4C422;  
	sep #$10                             ;81D0F3|E210    |      ;  
	ldx.b $04                   ;81D0F5|A604    |000004;  
	phx                                  ;81D0F7|DA      |      ;  
