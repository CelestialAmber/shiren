...
func_818026:
	...
	bcc func_818026                      ;81802E|90F6    |C18026;  
	rep #$20                             ;818030|C220    |      ;  
...
func_818049:
	...
	beq func_818090                      ;818059|F035    |C18090;  
	bcs func_8180A7                      ;81805B|B04A    |C180A7;  
	lda.w $0C0E                          ;81805D|AD0E0C  |810C0E;  
	bne func_818067                      ;818060|D005    |C18067;  
	cpy.w $0EA8                          ;818062|CCA80E  |810EA8;  
	beq func_818090                      ;818065|F029    |C18090;  

func_818067:
	stz.w $0EA6                          ;818067|9CA60E  |810EA6;  
	sty.w $0EA7                          ;81806A|8CA70E  |810EA7;  
	cpy.w $1039                          ;81806D|CC3910  |811039;  
	beq func_818090                      ;818070|F01E    |C18090;  
	bcs func_81807E                      ;818072|B00A    |C1807E;  
	lda.w $103F                          ;818074|AD3F10  |81103F;  
	bne func_818092                      ;818077|D019    |C18092;  
	sty.w $0EA8                          ;818079|8CA80E  |810EA8;  
	bra func_818084                      ;81807C|8006    |C18084;  
...
func_818084:
	...
	bne func_81808D                      ;818089|D002    |C1808D;  
...
func_8180A7:
	rep #$10                             ;8180A7|C210    |      ;  
	ldy.b $00                            ;8180A9|A400    |000000;  
	cpy.w $103B                          ;8180AB|CC3B10  |81103B;  
	bcs func_8180BE                      ;8180AE|B00E    |C180BE;  
	ldx.w #$0001                         ;8180B0|A20100  |      ;  

func_8180B3:
	lda.w $0C0E,x                        ;8180B3|BD0E0C  |810C0E;  
	bne func_8180C0                      ;8180B6|D008    |C180C0;  
	inx                                  ;8180B8|E8      |      ;  
	cpx.w #$0005                         ;8180B9|E00500  |      ;  
	bcc func_8180B3                      ;8180BC|90F5    |C180B3;  
...
func_8180C8:
	...
	bpl func_8180C8                      ;8180CC|10FA    |C180C8;  
	plp                                  ;8180CE|28      |      ;  
	rtl                                  ;8180CF|6B      |      ;  
...
func_8180DD:
	php                                  ;8180DD|08      |      ;  
	sep #$20                             ;8180DE|E220    |      ;  
	lda.b $00                            ;8180E0|A500    |000000;  
	beq func_8180E6                      ;8180E2|F002    |C180E6;  
	lda.b #$01                           ;8180E4|A901    |      ;  

func_8180E6:
	cmp.l $000EA4                        ;8180E6|CFA40E00|000EA4;  
	beq func_81810F                      ;8180EA|F023    |C1810F;  
	ora.b #$80                           ;8180EC|0980    |      ;  
	sta.l $000EA4                        ;8180EE|8FA40E00|000EA4;  
	lsr a                                ;8180F2|4A      |      ;  
	bcc func_818103                      ;8180F3|900E    |C18103;  
...
func_818133:
	bra func_818133                      ;818133|80FE    |C18133;  
...
func_818135:
	...
	sta.b $51                            ;81813D|8551    |000051;  
	ldx.b #$DD                           ;81813F|A2DD    |      ;  
	stx.b $53                            ;818141|8653    |000053;  
	ldy.b #$02                           ;818143|A002    |      ;  
	lda.b [$51],y                        ;818145|B751    |000051;  
	clc                                  ;818147|18      |      ;  
	adc.b $51                            ;818148|6551    |000051;  
	sta.b $51                            ;81814A|8551    |000051;  

func_81814C:
	lda.w #$BBAA                         ;81814C|A9AABB  |      ;  
	cmp.w APUIO0                          ;81814F|CD4021  |812140;  
	bne func_81814C                      ;818152|D0F8    |C1814C;  
	ldx.b #$CC                           ;818154|A2CC    |      ;  
	ldy.b #$00                           ;818156|A000    |      ;  
	sep #$20                             ;818158|E220    |      ;  
	rep #$10                             ;81815A|C210    |      ;  
	sta.b $54                            ;81815C|8554    |000054;  

func_81815E:
	lda.b [$51],y                        ;81815E|B751    |000051;  
	iny                                  ;818160|C8      |      ;  
	sta.b $55                            ;818161|8555    |000055;  
	lda.b [$51],y                        ;818163|B751    |000051;  
	iny                                  ;818165|C8      |      ;  
	sta.b $56                            ;818166|8556    |000056;  
	lda.b $54                            ;818168|A554    |000054;  

func_81816A:
	cmp.w APUIO0                          ;81816A|CD4021  |812140;  
	bne func_81816A                      ;81816D|D0FB    |C1816A;  
	...
	lda.b $55                            ;81817B|A555    |000055;  
	ora.b $56                            ;81817D|0556    |000056;  
	beq func_8181AD                      ;81817F|F02C    |C181AD;  
	lda.b #$FF                           ;818181|A9FF    |      ;  
	sta.w APUIO1                          ;818183|8D4121  |812141;  
	txa                                  ;818186|8A      |      ;  
	sta.w APUIO0                          ;818187|8D4021  |812140;  
	sta.b $54                            ;81818A|8554    |000054;  
	ldx.w #$0000                         ;81818C|A20000  |      ;  
	lda.b $54                            ;81818F|A554    |000054;  

func_818191:
	cmp.w APUIO0                          ;818191|CD4021  |812140;  
	bne func_818191                      ;818194|D0FB    |C18191;  
	...
	inx                                  ;8181A0|E8      |      ;  
	cpx.b $55                            ;8181A1|E455    |000055;  
	bcc func_818191                      ;8181A3|90EC    |C18191;  
	sta.b $54                            ;8181A5|8554    |000054;  

func_8181A7:
	inx                                  ;8181A7|E8      |      ;  
	txa                                  ;8181A8|8A      |      ;  
	beq func_8181A7                      ;8181A9|F0FC    |C181A7;  
	bra func_81815E                      ;8181AB|80B1    |C1815E;  
...
func_8181B6:
	...
	bne func_8181B6                      ;8181B9|D0FB    |C181B6;  
	lda.b #$00                           ;8181BB|A900    |      ;  
	sta.w APUIO0                          ;8181BD|8D4021  |812140;  
	sta.b $54                            ;8181C0|8554    |000054;  

func_8181C2:
	lda.w APUIO1                          ;8181C2|AD4121  |812141;  
	bne func_8181C2                      ;8181C5|D0FB    |C181C2;  
	rep #$20                             ;8181C7|C220    |      ;  
...
func_8181D1:
	php                                  ;8181D1|08      |      ;  
	sep #$20                             ;8181D2|E220    |      ;  
	lda.b $54                            ;8181D4|A554    |000054;  

func_8181D6:
	cmp.w APUIO0                          ;8181D6|CD4021  |812140;  
	bne func_8181D6                      ;8181D9|D0FB    |C181D6;  
	lda.b $57                            ;8181DB|A557    |000057;  
	sta.w APUIO1                          ;8181DD|8D4121  |812141;  
	lda.b $58                            ;8181E0|A558    |000058;  
	sta.w APUIO2                          ;8181E2|8D4221  |812142;  
	lda.b $59                            ;8181E5|A559    |000059;  
	sta.w APUIO3                          ;8181E7|8D4321  |812143;  
	lda.b $54                            ;8181EA|A554    |000054;  
	eor.b #$01                           ;8181EC|4901    |      ;  
	sta.w APUIO0                          ;8181EE|8D4021  |812140;  
	sta.b $54                            ;8181F1|8554    |000054;  
	plp                                  ;8181F3|28      |      ;  
	rts                                  ;8181F4|60      |      ;
...
func_8181FF:
	...
	dex                                  ;81820C|CA      |      ;  
	bpl func_8181FF                      ;81820D|10F0    |C181FF;  
...
func_818222:
	...
	bne func_81824F                      ;81822A|D023    |C1824F;  
...
func_818234:
	...
	beq func_818248                      ;818237|F00F    |C18248;  
	tya                                  ;818239|98      |      ;  
	ora.b #$90                           ;81823A|0990    |      ;  
	sta.b $57                            ;81823C|8557    |000057;  
	lda.w $0C42,y                        ;81823E|B9420C  |810C42;  
	sta.b $58                            ;818241|8558    |000058;  
	stz.b $59                            ;818243|6459    |000059;  
...
func_818248:
	...
	bcc func_818234                      ;81824D|90E5    |C18234;  
...
func_818251:
	...
	ply                                  ;818280|7A      |      ;  
	sty.b $5F                            ;818281|845F    |00005F;  
	clc                                  ;818283|18      |      ;  
	adc.b $5F                            ;818284|655F    |00005F;  
	adc.b $5F                            ;818286|655F    |00005F;  
	adc.b $5F                            ;818288|655F    |00005F;  
	sta.b $5F                            ;81828A|855F    |00005F;  
	sep #$30                             ;81828C|E230    |      ;  
	...
	sta.b $5F                            ;81829C|855F    |00005F;  
	pla                                  ;81829E|68      |      ;  
	adc.b #$40                           ;81829F|6940    |      ;  
	sta.b $60                            ;8182A1|8560    |000060;  
	pla                                  ;8182A3|68      |      ;  
	adc.b #$DD                           ;8182A4|69DD    |      ;  
	sta.b $61                            ;8182A6|8561    |000061;  
...
func_8182B1:
	...
	inx                                  ;81830C|E8      |      ;  
	bra func_8182B1                      ;81830D|80A2    |C182B1;  
...
func_81831D:
	...
	beq func_81832D                      ;818327|F004    |C1832D;  
	lda.b #$64                           ;818329|A964    |      ;  
	bra func_818330                      ;81832B|8003    |C18330;  

func_81832D:
	lda.w $0C32,y                        ;81832D|B9320C  |810C32;  

func_818330:
	sta.b $57                            ;818330|8557    |000057;  
	lda.w $0C1D,x                        ;818332|BD1D0C  |810C1D;  
	tax                                  ;818335|AA      |      ;  
	lda.w DATA8_81871B,x                 ;818336|BD1B87  |81871B;  
	sta.b $5A                            ;818339|855A    |00005A;  
	lda.w $0C22,y                        ;81833B|B9220C  |810C22;  
	tax                                  ;81833E|AA      |      ;  
	lda.w DATA8_81871B,x                 ;81833F|BD1B87  |81871B;  
	sta.b $5B                            ;818342|855B    |00005B;  
	jsr.w func_818F89                    ;818344|20898F  |C18F89;  
	lda.b $5B                            ;818347|A55B    |00005B;  
	asl.b $5A                            ;818349|065A    |00005A;  
	rol a                                ;81834B|2A      |      ;  
	pha                                  ;81834C|48      |      ;  
	sta.b $5A                            ;81834D|855A    |00005A;  
	lda.b $57                            ;81834F|A557    |000057;  
	sta.b $5B                            ;818351|855B    |00005B;  
	jsr.w func_818F89                    ;818353|20898F  |C18F89;  
	lda.b $5B                            ;818356|A55B    |00005B;  
	asl.b $5A                            ;818358|065A    |00005A;  
	rol a                                ;81835A|2A      |      ;  
	sta.b $59                            ;81835B|8559    |000059;  
	pla                                  ;81835D|68      |      ;  
	sta.b $5A                            ;81835E|855A    |00005A;  
	lda.b #$C8                           ;818360|A9C8    |      ;  
	sec                                  ;818362|38      |      ;  
	sbc.b $57                            ;818363|E557    |000057;  
	sta.b $5B                            ;818365|855B    |00005B;  
	jsr.w func_818F89                    ;818367|20898F  |C18F89;  
	lda.b $5B                            ;81836A|A55B    |00005B;  
	asl.b $5A                            ;81836C|065A    |00005A;  
	rol a                                ;81836E|2A      |      ;  
	sta.b $58                            ;81836F|8558    |000058;  
	tya                                  ;818371|98      |      ;  
	ora.b #$40                           ;818372|0940    |      ;  
	sta.b $57                            ;818374|8557    |000057;  
...
func_8183C6:
	...
	bpl func_8183F3                      ;8183C9|1028    |C183F3;  
	and.b #$7F                           ;8183CB|297F    |      ;  
	sta.w $0EA4                          ;8183CD|8DA40E  |810EA4;  
	sta.b $59                            ;8183D0|8559    |000059;  
	stz.b $58                            ;8183D2|6458    |000058;  
	lda.b #$10                           ;8183D4|A910    |      ;  
	sta.b $57                            ;8183D6|8557    |000057;  
...
func_8183F3:
	...
	bpl func_81840A                      ;8183F6|1012    |C1840A;  
...
func_81840A:
	...
	beq func_818424                      ;81840D|F015    |C18424;  
	dec a                                ;81840F|3A      |      ;  
	sta.w $0C62,x                        ;818410|9D620C  |810C62;  
	bne func_818424                      ;818413|D00F    |C18424;  
	txa                                  ;818415|8A      |      ;  
	ora.b #$90                           ;818416|0990    |      ;  
	sta.b $57                            ;818418|8557    |000057;  
	lda.w $0C42,x                        ;81841A|BD420C  |810C42;  
	sta.b $58                            ;81841D|8558    |000058;  
	stz.b $59                            ;81841F|6459    |000059;  
	jsr.w func_8181D1                    ;818421|20D181  |C181D1;  

func_818424:
	lda.w $0DD2,x                        ;818424|BDD20D  |810DD2;  
	beq func_818480                      ;818427|F057    |C18480;  
	rep #$10                             ;818429|C210    |      ;  
	dec a                                ;81842B|3A      |      ;  
	...
	bcc func_818444                      ;81843E|9004    |C18444;  
...
func_818444:
	...
	beq func_81847E                      ;81844A|F032    |C1847E;  
	sty.b $58                            ;81844C|8458    |000058;  
	lda.w $0DC2,x                        ;81844E|BDC20D  |810DC2;  
	xba                                  ;818451|EB      |      ;  
	lda.w $0DE2,x                        ;818452|BDE20D  |810DE2;  
	bmi func_818463                      ;818455|300C    |C18463;  
	lda.w $0DB2,x                        ;818457|BDB20D  |810DB2;  
	rep #$20                             ;81845A|C220    |      ;  
	clc                                  ;81845C|18      |      ;  
	adc.b $58                            ;81845D|6558    |000058;  
	bra func_81846B                      ;81845F|800A    |C1846B;  
	db $E2,$20                           ;818461|        |      ;  
...
func_818463:
	...
	rep #$20                             ;818466|C220    |      ;  
	sec                                  ;818468|38      |      ;  
	sbc.b $58                            ;818469|E558    |000058;  

func_81846B:
	sta.b $58                            ;81846B|8558    |000058;  
	sep #$20                             ;81846D|E220    |      ;  
...
func_818480:
	...
	beq func_8184BD                      ;818483|F038    |C184BD;  
	dec a                                ;818485|3A      |      ;  
	...
	bcc func_81849A                      ;818494|9004    |C1849A;  
...
func_81849A:
	...
	beq func_8184BD                      ;81849F|F01C    |C184BD;  
	lda.w $0E52,x                        ;8184A1|BD520E  |810E52;  
	bmi func_8184AD                      ;8184A4|3007    |C184AD;  
	tya                                  ;8184A6|98      |      ;  
	clc                                  ;8184A7|18      |      ;  
	adc.w $0C22,x                        ;8184A8|7D220C  |810C22;  
	bra func_8184B5                      ;8184AB|8008    |C184B5;  

func_8184AD:
	lda.w $0C22,x                        ;8184AD|BD220C  |810C22;  
	sty.b $58                            ;8184B0|8458    |000058;  
	sec                                  ;8184B2|38      |      ;  
	sbc.b $58                            ;8184B3|E558    |000058;  
...
func_8184BD:
	...
	sta.b $51                            ;8184CE|8551    |000051;  
	lda.w $0CD2,x                        ;8184D0|BDD20C  |810CD2;  
	sta.b $52                            ;8184D3|8552    |000052;  
	lda.w $0CE2,x                        ;8184D5|BDE20C  |810CE2;  
	sta.b $53                            ;8184D8|8553    |000053;  
...
func_818500:
	...
	inc.b $51                            ;818502|E651    |000051;  
	bne func_81850C                      ;818504|D006    |C1850C;  
	inc.b $52                            ;818506|E652    |000052;  
	bne func_81850C                      ;818508|D002    |C1850C;  
...
func_81850C:
	...
	beq func_818530                      ;81851A|F014    |C18530;  
	phy                                  ;81851C|5A      |      ;  
	txa                                  ;81851D|8A      |      ;  
	sec                                  ;81851E|38      |      ;  
...
func_818530:
	...
	beq func_818543                      ;818533|F00E    |C18543;  
	phy                                  ;818535|5A      |      ;  
	txa                                  ;818536|8A      |      ;  
	sec                                  ;818537|38      |      ;  
...
func_818543:
	...
	beq func_81858C                      ;818546|F044    |C1858C;  
	bmi func_81855B                      ;818548|3011    |C1855B;  
	lda.b [$51]                          ;81854A|A751    |000051;  
	inc.b $51                            ;81854C|E651    |000051;  
	bne func_818556                      ;81854E|D006    |C18556;  
	inc.b $52                            ;818550|E652    |000052;  
	bne func_818556                      ;818552|D002    |C18556;  
	db $E6,$53                           ;818554|        |000053;  

func_818556:
	sta.w $0C72,x                        ;818556|9D720C  |810C72;  
	bra func_81858C                      ;818559|8031    |C1858C;  

func_81855B:
	cmp.b #$80                           ;81855B|C980    |      ;  
	bne func_8185AE                      ;81855D|D04F    |C185AE;  
	lda.b [$51]                          ;81855F|A751    |000051;  
	inc.b $51                            ;818561|E651    |000051;  
	bne func_81856B                      ;818563|D006    |C1856B;  
	inc.b $52                            ;818565|E652    |000052;  
	bne func_81856B                      ;818567|D002    |C1856B;  
	db $E6,$53                           ;818569|        |000053;  

func_81856B:
	cmp.b #$65                           ;81856B|C965    |      ;  
	bcs func_818574                      ;81856D|B005    |C18574;  
	sta.w $0C82,x                        ;81856F|9D820C  |810C82;  
	bra func_81858C                      ;818572|8018    |C1858C;  

func_818574:
	sbc.b #$65                           ;818574|E965    |      ;  
	cmp.b #$65                           ;818576|C965    |      ;  
	bcs func_81858E                      ;818578|B014    |C1858E;  
	sta.w $0C82,x                        ;81857A|9D820C  |810C82;  
	lda.b [$51]                          ;81857D|A751    |000051;  
	inc.b $51                            ;81857F|E651    |000051;  
	bne func_818589                      ;818581|D006    |C18589;  
...
func_81858C:
	bra func_81860A                      ;81858C|807C    |C1860A;  
...
func_81858E:
	...
	inc.b $51                            ;818596|E651    |000051;  
	bne func_8185A0                      ;818598|D006    |C185A0;  
	db $E6,$52,$D0,$02,$E6,$53           ;81859A|        |000052;  

func_8185A0:
	cmp.b #$65                           ;8185A0|C965    |      ;  
	bcc func_8185A9                      ;8185A2|9005    |C185A9;  
	sbc.b #$65                           ;8185A4|E965    |      ;  
	inc.w $0C82,x                        ;8185A6|FE820C  |810C82;  

func_8185A9:
	sta.w $0C92,x                        ;8185A9|9D920C  |810C92;  
	bra func_81860A                      ;8185AC|805C    |C1860A;  

func_8185AE:
	lda.b [$51]                          ;8185AE|A751    |000051;  
	inc.b $51                            ;8185B0|E651    |000051;  
	bne func_8185BA                      ;8185B2|D006    |C185BA;  
	inc.b $52                            ;8185B4|E652    |000052;  
	bne func_8185BA                      ;8185B6|D002    |C185BA;  
	db $E6,$53                           ;8185B8|        |000053;  

func_8185BA:
	cmp.b #$65                           ;8185BA|C965    |      ;  
	bcs func_8185C3                      ;8185BC|B005    |C185C3;  
	sta.w $0C92,x                        ;8185BE|9D920C  |810C92;  
	bra func_81860A                      ;8185C1|8047    |C1860A;  

func_8185C3:
	sbc.b #$65                           ;8185C3|E965    |      ;  
	cmp.b #$65                           ;8185C5|C965    |      ;  
	bcs func_8185DD                      ;8185C7|B014    |C185DD;  
	sta.w $0C92,x                        ;8185C9|9D920C  |810C92;  
	lda.b [$51]                          ;8185CC|A751    |000051;  
	inc.b $51                            ;8185CE|E651    |000051;  
	bne func_8185D8                      ;8185D0|D006    |C185D8;  
	inc.b $52                            ;8185D2|E652    |000052;  
	bne func_8185D8                      ;8185D4|D002    |C185D8;  
	db $E6,$53                           ;8185D6|        |000053;  

func_8185D8:
	sta.w $0C72,x                        ;8185D8|9D720C  |810C72;  
	bra func_81860A                      ;8185DB|802D    |C1860A;  
...
func_8185DD:
	...
	inc.b $51                            ;8185E5|E651    |000051;  
	bne func_8185EF                      ;8185E7|D006    |C185EF;  
	db $E6,$52,$D0,$02,$E6,$53           ;8185E9|        |000052;  

func_8185EF:
	cmp.b #$65                           ;8185EF|C965    |      ;  
	bcc func_8185F8                      ;8185F1|9005    |C185F8;  
...
func_8185F8:
	...
	inc.b $51                            ;8185FD|E651    |000051;  
	bne func_818607                      ;8185FF|D006    |C18607;  
	inc.b $52                            ;818601|E652    |000052;  
	bne func_818607                      ;818603|D002    |C18607;  
...
func_81860A:
	...
	sta.b $5A                            ;818618|855A    |00005A;  
	plx                                  ;81861A|FA      |      ;  
	lda.w $0C72,x                        ;81861B|BD720C  |810C72;  
	sta.b $5B                            ;81861E|855B    |00005B;  
	jsr.w func_818F89                    ;818620|20898F  |C18F89;  
	lda.b $5B                            ;818623|A55B    |00005B;  
	asl.b $5A                            ;818625|065A    |00005A;  
	rol a                                ;818627|2A      |      ;  
	asl.b $5A                            ;818628|065A    |00005A;  
	...
	beq func_81867B                      ;818637|F042    |C1867B;  
	phx                                  ;818639|DA      |      ;  
	pha                                  ;81863A|48      |      ;  
...
UNREACH_818780:
	...
	inc.b $51                            ;818871|E651    |000051;  
	bne func_81887B                      ;818873|D006    |C1887B;  
	inc.b $52                            ;818875|E652    |000052;  
	bne func_81887B                      ;818877|D002    |C1887B;  
...
func_81887B:
	...
	inc.b $51                            ;818884|E651    |000051;  
	bne func_81888E                      ;818886|D006    |C1888E;  
	inc.b $52                            ;818888|E652    |000052;  
	bne func_81888E                      ;81888A|D002    |C1888E;  
	db $E6,$53                           ;81888C|        |000053;  

func_81888E:
	sta.b $58                            ;81888E|8558    |000058;  
	txa                                  ;818890|8A      |      ;  
	ora.b #$C0                           ;818891|09C0    |      ;  
	sta.b $57                            ;818893|8557    |000057;  
	jsr.w func_8181D1                    ;818895|20D181  |C181D1;  
	rts                                  ;818898|60      |      ;  
	db $60                               ;818899|        |      ;  
	lda.b [$51]                          ;81889A|A751    |000051;  
	inc.b $51                            ;81889C|E651    |000051;  
	bne func_8188A6                      ;81889E|D006    |C188A6;  
	db $E6,$52,$D0,$02,$E6,$53           ;8188A0|        |000052;  

func_8188A6:
	sta.b $59                            ;8188A6|8559    |000059;  
	lda.b #$02                           ;8188A8|A902    |      ;  
	sta.b $58                            ;8188AA|8558    |000058;  
	txa                                  ;8188AC|8A      |      ;  
	ora.b #$10                           ;8188AD|0910    |      ;  
	sta.b $57                            ;8188AF|8557    |000057;  
	jsr.w func_8181D1                    ;8188B1|20D181  |C181D1;  
	rts                                  ;8188B4|60      |      ;  
	lda.b [$51]                          ;8188B5|A751    |000051;  
	inc.b $51                            ;8188B7|E651    |000051;  
	bne func_8188C1                      ;8188B9|D006    |C188C1;  
	inc.b $52                            ;8188BB|E652    |000052;  
	bne func_8188C1                      ;8188BD|D002    |C188C1;  
	db $E6,$53                           ;8188BF|        |000053;  

func_8188C1:
	ldx.w $0EA3                          ;8188C1|AEA30E  |810EA3;  
	bne func_8188CA                      ;8188C4|D004    |C188CA;  
...
func_81890B:
	...
	inc.b $51                            ;81890E|E651    |000051;  
	bne func_818918                      ;818910|D006    |C18918;  
...
func_818918:
	...
	inc.b $51                            ;818921|E651    |000051;  
	bne func_81892B                      ;818923|D006    |C1892B;  
...
func_818938:
	...
	inc.b $51                            ;818947|E651    |000051;  
	bne func_818951                      ;818949|D006    |C18951;  
...
func_818951:
	...
	bra func_81896A                      ;81895A|800E    |C1896A;  
	lda.b #$04                           ;81895C|A904    |      ;  
	bra func_81896A                      ;81895E|800A    |C1896A;  
	lda.b #$05                           ;818960|A905    |      ;  
	bra func_81896A                      ;818962|8006    |C1896A;  
	lda.b #$06                           ;818964|A906    |      ;  
	bra func_81896A                      ;818966|8002    |C1896A;  
	lda.b #$07                           ;818968|A907    |      ;  

func_81896A:
	sta.b $58                            ;81896A|8558    |000058;  
	lda.b [$51]                          ;81896C|A751    |000051;  
	inc.b $51                            ;81896E|E651    |000051;  
	bne func_818978                      ;818970|D006    |C18978;  
	inc.b $52                            ;818972|E652    |000052;  
	bne func_818978                      ;818974|D002    |C18978;  
	db $E6,$53                           ;818976|        |000053;  

func_818978:
	sta.b $59                            ;818978|8559    |000059;  
	txa                                  ;81897A|8A      |      ;  
	ora.b #$10                           ;81897B|0910    |      ;  
	sta.b $57                            ;81897D|8557    |000057;  
	jsr.w func_8181D1                    ;81897F|20D181  |C181D1;  
	rts                                  ;818982|60      |      ;  
	lda.b #$0A                           ;818983|A90A    |      ;  
	bra func_81896A                      ;818985|80E3    |C1896A;  
	lda.b #$0B                           ;818987|A90B    |      ;  
	bra func_81896A                      ;818989|80DF    |C1896A;  
	lda.b #$0C                           ;81898B|A90C    |      ;  
	bra func_81896A                      ;81898D|80DB    |C1896A;  
	lda.b #$10                           ;81898F|A910    |      ;  
	bra func_81896A                      ;818991|80D7    |C1896A;  
	lda.b [$51]                          ;818993|A751    |000051;  
	inc.b $51                            ;818995|E651    |000051;  
	bne func_81899F                      ;818997|D006    |C1899F;  
	inc.b $52                            ;818999|E652    |000052;  
	bne func_81899F                      ;81899B|D002    |C1899F;  
	db $E6,$53                           ;81899D|        |000053;  

func_81899F:
	sta.w $0DB2,x                        ;81899F|9DB20D  |810DB2;  
	sta.b $58                            ;8189A2|8558    |000058;  
	lda.b [$51]                          ;8189A4|A751    |000051;  
	inc.b $51                            ;8189A6|E651    |000051;  
	bne func_8189B0                      ;8189A8|D006    |C189B0;  
	inc.b $52                            ;8189AA|E652    |000052;  
	bne func_8189B0                      ;8189AC|D002    |C189B0;  
	db $E6,$53                           ;8189AE|        |000053;  

func_8189B0:
	sta.w $0DC2,x                        ;8189B0|9DC20D  |810DC2;  
	sta.b $59                            ;8189B3|8559    |000059;  
	txa                                  ;8189B5|8A      |      ;  
	ora.b #$30                           ;8189B6|0930    |      ;  
	sta.b $57                            ;8189B8|8557    |000057;  
	jsr.w func_8181D1                    ;8189BA|20D181  |C181D1;  
	rts                                  ;8189BD|60      |      ;  
	rep #$20                             ;8189BE|C220    |      ;  
	ldy.b #$00                           ;8189C0|A000    |      ;  
	lda.b [$51]                          ;8189C2|A751    |000051;  
	bpl func_8189CB                      ;8189C4|1005    |C189CB;  
...
func_8189CB:
	pha                                  ;8189CB|48      |      ;  
	sep #$20                             ;8189CC|E220    |      ;  
	inc.b $51                            ;8189CE|E651    |000051;  
	bne func_8189D8                      ;8189D0|D006    |C189D8;  
	inc.b $52                            ;8189D2|E652    |000052;  
	bne func_8189D8                      ;8189D4|D002    |C189D8;  
	db $E6,$53                           ;8189D6|        |000053;  

func_8189D8:
	inc.b $51                            ;8189D8|E651    |000051;  
	bne func_8189E2                      ;8189DA|D006    |C189E2;  
	inc.b $52                            ;8189DC|E652    |000052;  
	bne func_8189E2                      ;8189DE|D002    |C189E2;  
...
func_8189E2:
	...
	inc.b $51                            ;8189E8|E651    |000051;  
	bne func_8189F2                      ;8189EA|D006    |C189F2;  
	inc.b $52                            ;8189EC|E652    |000052;  
	bne func_8189F2                      ;8189EE|D002    |C189F2;  
...
func_818A00:
	...
	bpl func_818A32                      ;818A2C|1004    |C18A32;  
...
func_818A32:
	pha                                  ;818A32|48      |      ;  
	inc.b $51                            ;818A33|E651    |000051;  
	bne func_818A3D                      ;818A35|D006    |C18A3D;  
...
func_818A3D:
	...
	inc.b $51                            ;818A43|E651    |000051;  
	bne func_818A4D                      ;818A45|D006    |C18A4D;  
...
func_818A75:
	sta.b $59                            ;818A75|8559    |000059;  
	lda.b #$08                           ;818A77|A908    |      ;  

func_818A79:
	sta.b $58                            ;818A79|8558    |000058;  
	txa                                  ;818A7B|8A      |      ;  
	ora.b #$10                           ;818A7C|0910    |      ;  
	sta.b $57                            ;818A7E|8557    |000057;  
	jsr.w func_8181D1                    ;818A80|20D181  |C181D1;  
	rts                                  ;818A83|60      |      ;  
	lda.b #$01                           ;818A84|A901    |      ;  
	bra func_818A75                      ;818A86|80ED    |C18A75;  
	lda.b #$00                           ;818A88|A900    |      ;  

func_818A8A:
	sta.b $59                            ;818A8A|8559    |000059;  
	lda.b #$09                           ;818A8C|A909    |      ;  
	bra func_818A79                      ;818A8E|80E9    |C18A79;  
	lda.b #$01                           ;818A90|A901    |      ;  
	bra func_818A8A                      ;818A92|80F6    |C18A8A;  
	lda.b #$00                           ;818A94|A900    |      ;  

func_818A96:
	sta.b $59                            ;818A96|8559    |000059;  
	lda.b #$0E                           ;818A98|A90E    |      ;  
	bra func_818A79                      ;818A9A|80DD    |C18A79;  
	lda.b #$01                           ;818A9C|A901    |      ;  
	bra func_818A96                      ;818A9E|80F6    |C18A96;  
	lda.b [$51]                          ;818AA0|A751    |000051;  
	inc.b $51                            ;818AA2|E651    |000051;  
	bne func_818AAC                      ;818AA4|D006    |C18AAC;  
...
func_818AAC:
	...
	inc.b $51                            ;818AB8|E651    |000051;  
	bne func_818AC2                      ;818ABA|D006    |C18AC2;  
...
func_818AC2:
	...
	beq func_818B1C                      ;818AEB|F02F    |C18B1C;  
	sec                                  ;818AED|38      |      ;  
	...
	sta.b $51                            ;818AFC|8551    |000051;  
	lda.w $0D22,y                        ;818AFE|B9220D  |810D22;  
	sta.b $52                            ;818B01|8552    |000052;  
	lda.w $0D52,y                        ;818B03|B9520D  |810D52;  
	sta.b $53                            ;818B06|8553    |000053;  
	inc.b $51                            ;818B08|E651    |000051;  
	bne func_818B12                      ;818B0A|D006    |C18B12;  
	inc.b $52                            ;818B0C|E652    |000052;  
	bne func_818B12                      ;818B0E|D002    |C18B12;  
	db $E6,$53                           ;818B10|        |000053;  

func_818B12:
	inc.b $51                            ;818B12|E651    |000051;  
	bne func_818B1C                      ;818B14|D006    |C18B1C;  
	inc.b $52                            ;818B16|E652    |000052;  
	bne func_818B1C                      ;818B18|D002    |C18B1C;  
	db $E6,$53                           ;818B1A|        |000053;  

func_818B1C:
	rts                                  ;818B1C|60      |      ;  
	ldy.b #$02                           ;818B1D|A002    |      ;  
	bra func_818B2E                      ;818B1F|800D    |C18B2E;  
	lda.b [$51]                          ;818B21|A751    |000051;  
	inc.b $51                            ;818B23|E651    |000051;  
	bne func_818B2D                      ;818B25|D006    |C18B2D;  
...
func_818B2E:
	...
	bne func_818B34                      ;818B31|D001    |C18B34;  
	tya                                  ;818B33|98      |      ;  

func_818B34:
	dec a                                ;818B34|3A      |      ;  
	sta.w $0D92,x                        ;818B35|9D920D  |810D92;  
	bne func_818B89                      ;818B38|D04F    |C18B89;  
	inc.b $51                            ;818B3A|E651    |000051;  
	bne func_818B44                      ;818B3C|D006    |C18B44;  
	db $E6,$52,$D0,$02,$E6,$53           ;818B3E|        |000052;  

func_818B44:
	inc.b $51                            ;818B44|E651    |000051;  
	bne func_818B4E                      ;818B46|D006    |C18B4E;  
...
func_818B4E:
	...
	bcc func_818B6B                      ;818B54|9015    |C18B6B;  
...
func_818B6B:
	...
	tay                                  ;818B70|A8      |      ;  
	lda.b $51                            ;818B71|A551    |000051;  
	sta.w $0CF2,y                        ;818B73|99F20C  |810CF2;  
	lda.b $52                            ;818B76|A552    |000052;  
	sta.w $0D22,y                        ;818B78|99220D  |810D22;  
	lda.b $53                            ;818B7B|A553    |000053;  
...
func_818B89:
	...
	inc.b $51                            ;818B8B|E651    |000051;  
	bne func_818B95                      ;818B8D|D006    |C18B95;  
	inc.b $52                            ;818B8F|E652    |000052;  
	bne func_818B95                      ;818B91|D002    |C18B95;  
	db $E6,$53                           ;818B93|        |000053;  

func_818B95:
	pha                                  ;818B95|48      |      ;  
	lda.b [$51]                          ;818B96|A751    |000051;  
	inc.b $51                            ;818B98|E651    |000051;  
	bne func_818BA2                      ;818B9A|D006    |C18BA2;  
	inc.b $52                            ;818B9C|E652    |000052;  
	bne func_818BA2                      ;818B9E|D002    |C18BA2;  
...
func_818BA2:
	...
	bpl func_818BAB                      ;818BA7|1002    |C18BAB;  
	ldy.b #$FF                           ;818BA9|A0FF    |      ;  

func_818BAB:
	phy                                  ;818BAB|5A      |      ;  
	lda.b $51                            ;818BAC|A551    |000051;  
	clc                                  ;818BAE|18      |      ;  
	adc.b $03,s                          ;818BAF|6303    |000003;  
	sta.b $51                            ;818BB1|8551    |000051;  
	lda.b $52                            ;818BB3|A552    |000052;  
...
func_818C12:
	...
	beq func_818C2E                      ;818C15|F017    |C18C2E;  
	dec.w $0EAB                          ;818C17|CEAB0E  |810EAB;  
	bne func_818C2E                      ;818C1A|D012    |C18C2E;  
	jsr.w func_818E8F                    ;818C1C|208F8E  |C18E8F;  
	lda.b #$18                           ;818C1F|A918    |      ;  
	sta.b $57                            ;818C21|8557    |000057;  
	lda.b #$0F                           ;818C23|A90F    |      ;  
	sta.b $58                            ;818C25|8558    |000058;  
	lda.b #$10                           ;818C27|A910    |      ;  
	sta.b $59                            ;818C29|8559    |000059;  
...
func_818C4E:
	...
	bcs func_818C6B                      ;818C55|B014    |C18C6B;  
...
func_818C57:
	...
	lsr a                                ;818C63|4A      |      ;  
	pla                                  ;818C64|68      |      ;  
	bcs func_818C6E                      ;818C65|B007    |C18C6E;  
	adc.b #$4B                           ;818C67|694B    |      ;  
	bcc func_818C57                      ;818C69|90EC    |C18C57;  
...
func_818C6E:
	...
	bne func_818C30                      ;818C71|D0BD    |C18C30;  
	plp                                  ;818C73|28      |      ;  
	rts                                  ;818C74|60      |      ;  
...
func_818C75:
	php                                  ;818C75|08      |      ;  
	sep #$30                             ;818C76|E230    |      ;  
	lda.b $58                            ;818C78|A558    |000058;  
	eor.b #$FF                           ;818C7A|49FF    |      ;  
	inc a                                ;818C7C|1A      |      ;  
	sta.b $58                            ;818C7D|8558    |000058;  
	lda.b $54                            ;818C7F|A554    |000054;  

func_818C81:
	cmp.w APUIO0                          ;818C81|CD4021  |812140;  
	bne func_818C81                      ;818C84|D0FB    |C18C81;  
	lda.b #$20                           ;818C86|A920    |      ;  
	sta.w APUIO1                          ;818C88|8D4121  |812141;  
	lda.b $58                            ;818C8B|A558    |000058;  
	sta.w APUIO2                          ;818C8D|8D4221  |812142;  
	lda.b $59                            ;818C90|A559    |000059;  
...
func_818C9A:
	...
	beq func_818C9A                      ;818C9D|F0FB    |C18C9A;  
	lda.b #$00                           ;818C9F|A900    |      ;  
	sta.w APUIO0                          ;818CA1|8D4021  |812140;  
	sta.b $54                            ;818CA4|8554    |000054;  
	lda.b $5C                            ;818CA6|A55C    |00005C;  
	sec                                  ;818CA8|38      |      ;  
	sbc.b $58                            ;818CA9|E558    |000058;  
	sta.b $5C                            ;818CAB|855C    |00005C;  
	lda.b $5D                            ;818CAD|A55D    |00005D;  
	sbc.b #$00                           ;818CAF|E900    |      ;  
	sta.b $5D                            ;818CB1|855D    |00005D;  
	lda.b $5E                            ;818CB3|A55E    |00005E;  
	sbc.b #$00                           ;818CB5|E900    |      ;  
	sta.b $5E                            ;818CB7|855E    |00005E;  
	ldy.b $58                            ;818CB9|A458    |000058;  
	rep #$20                             ;818CBB|C220    |      ;  
...
func_818CC1:
	...
	bne func_818CC1                      ;818CC4|D0FB    |C18CC1;  
...
func_818CD9:
	...
	beq func_818CD9                      ;818CDC|F0FB    |C18CD9;  
	...
	bcs func_818CBD                      ;818CEF|B0CC    |C18CBD;  
	sep #$20                             ;818CF1|E220    |      ;  
	inc.b $5D                            ;818CF3|E65D    |00005D;  
	bne func_818CF9                      ;818CF5|D002    |C18CF9;  
	inc.b $5E                            ;818CF7|E65E    |00005E;  
...
func_818D86:
	...
	sta.b $5E                            ;818D8A|855E    |00005E;  
	rep #$30                             ;818D8C|C230    |      ;  
	lda.w #$4000                         ;818D8E|A90040  |      ;  
	sta.b $5C                            ;818D91|855C    |00005C;  
	lda.w #$0004                         ;818D93|A90400  |      ;  
	clc                                  ;818D96|18      |      ;  
	adc.b $5C                            ;818D97|655C    |00005C;  
	sty.b $5C                            ;818D99|845C    |00005C;  
	clc                                  ;818D9B|18      |      ;  
	adc.b $5C                            ;818D9C|655C    |00005C;  
	adc.b $5C                            ;818D9E|655C    |00005C;  
	adc.b $5C                            ;818DA0|655C    |00005C;  
	sta.b $5C                            ;818DA2|855C    |00005C;  
	sep #$30                             ;818DA4|E230    |      ;  
	...
	sta.b $5C                            ;818DB4|855C    |00005C;  
	pla                                  ;818DB6|68      |      ;  
	adc.b #$40                           ;818DB7|6940    |      ;  
	sta.b $5D                            ;818DB9|855D    |00005D;  
	pla                                  ;818DBB|68      |      ;  
	adc.b #$DD                           ;818DBC|69DD    |      ;  
	sta.b $5E                            ;818DBE|855E    |00005E;  
	txa                                  ;818DC0|8A      |      ;  
	asl a                                ;818DC1|0A      |      ;  
	tax                                  ;818DC2|AA      |      ;  
	rep #$20                             ;818DC3|C220    |      ;  
	...
	sta.b $55                            ;818DD2|8555    |000055;  
	ldy.w $1038                          ;818DD4|AC3810  |811038;  
	bne func_818DE6                      ;818DD7|D00D    |C18DE6;  
	lda.w $0EF4,x                        ;818DD9|BDF40E  |810EF4;  
	sta.b $58                            ;818DDC|8558    |000058;  
	clc                                  ;818DDE|18      |      ;  
	adc.b $55                            ;818DDF|6555    |000055;  
	sta.w $0EF6,x                        ;818DE1|9DF60E  |810EF6;  
	bra func_818DF1                      ;818DE4|800B    |C18DF1;  

func_818DE6:
	lda.w $0FB6,x                        ;818DE6|BDB60F  |810FB6;  
	sec                                  ;818DE9|38      |      ;  
	sbc.b $55                            ;818DEA|E555    |000055;  
	sta.b $58                            ;818DEC|8558    |000058;  
	sta.w $0FB8,x                        ;818DEE|9DB80F  |810FB8;  

func_818DF1:
	sep #$20                             ;818DF1|E220    |      ;  
	inc.b $5C                            ;818DF3|E65C    |00005C;  
	bne func_818DFD                      ;818DF5|D006    |C18DFD;  
	db $E6,$5D,$D0,$02,$E6,$5E           ;818DF7|        |00005D;  

func_818DFD:
	inc.b $5C                            ;818DFD|E65C    |00005C;  
	bne func_818E07                      ;818DFF|D006    |C18E07;  
	db $E6,$5D,$D0,$02,$E6,$5E           ;818E01|        |00005D;  

func_818E07:
	stz.b $57                            ;818E07|6457    |000057;  
	jsr.w func_8181D1                    ;818E09|20D181  |C181D1;  
	pla                                  ;818E0C|68      |      ;  
	sta.b $59                            ;818E0D|8559    |000059;  
	lda.b #$1E                           ;818E0F|A91E    |      ;  
	sta.b $58                            ;818E11|8558    |000058;  
...
func_818E18:
	...
	bcc func_818E37                      ;818E1E|9017    |C18E37;  
	ldx.w $1036                          ;818E20|AE3610  |811036;  
	bra func_818E2B                      ;818E23|8006    |C18E2B;  

func_818E25:
	cmp.w $0EB2,x                        ;818E25|DDB20E  |810EB2;  
	beq func_818E37                      ;818E28|F00D    |C18E37;  
	inx                                  ;818E2A|E8      |      ;  

func_818E2B:
	cpx.w $0EF2                          ;818E2B|ECF20E  |810EF2;  
	bcc func_818E25                      ;818E2E|90F5    |C18E25;  
...
func_818E39:
	...
	bcc func_818E57                      ;818E3F|9016    |C18E57;  
	ldx.b #$00                           ;818E41|A200    |      ;  
	bra func_818E4B                      ;818E43|8006    |C18E4B;  

func_818E45:
	cmp.w $0F74,x                        ;818E45|DD740F  |810F74;  
	beq func_818E57                      ;818E48|F00D    |C18E57;  
	inx                                  ;818E4A|E8      |      ;  

func_818E4B:
	cpx.w $0FB4                          ;818E4B|ECB40F  |810FB4;  
	bcc func_818E45                      ;818E4E|90F5    |C18E45;  
...
func_818E6E:
	...
	bcc func_818E8D                      ;818E7D|900E    |C18E8D;  
	sty.w $0EF3                          ;818E7F|8CF30E  |810EF3;  
	lda.w $1038                          ;818E82|AD3810  |811038;  
	bne func_818E8D                      ;818E85|D006    |C18E8D;  
...
func_818E8F:
	...
	beq func_818EA3                      ;818E9B|F006    |C18EA3;  
...
func_818EA5:
	...
	bne func_818EB7                      ;818EAA|D00B    |C18EB7;  
	lda.w $0EF2                          ;818EAC|ADF20E  |810EF2;  
	cmp.w $0EF3                          ;818EAF|CDF30E  |810EF3;  
	beq func_818EBF                      ;818EB2|F00B    |C18EBF;  
...
func_818EB7:
	...
	bne func_818EB4                      ;818EBD|D0F5    |C18EB4;  
...
func_818EC2:
	...
	sta.b $5C                            ;818EC7|855C    |00005C;  
	lda.b #$40                           ;818EC9|A940    |      ;  
	sta.b $5D                            ;818ECB|855D    |00005D;  
	lda.b #$DD                           ;818ECD|A9DD    |      ;  
	sta.b $5E                            ;818ECF|855E    |00005E;  
	lda.b #$00                           ;818ED1|A900    |      ;  
	sta.w $1037                          ;818ED3|8D3710  |811037;  
	bra func_818EEB                      ;818ED6|8013    |C18EEB;  

func_818ED8:
	inc.b $5C                            ;818ED8|E65C    |00005C;  
	bne func_818EE2                      ;818EDA|D006    |C18EE2;  
...
func_818EEB:
	...
	inc.b $5C                            ;818EED|E65C    |00005C;  
	bne func_818EF7                      ;818EEF|D006    |C18EF7;  
	db $E6,$5D,$D0,$02,$E6,$5E           ;818EF1|        |00005D;  

func_818EF7:
	ora.b [$5C]                          ;818EF7|075C    |00005C;  
	inc.b $5C                            ;818EF9|E65C    |00005C;  
	bne func_818F03                      ;818EFB|D006    |C18F03;  
	db $E6,$5D,$D0,$02,$E6,$5E           ;818EFD|        |00005D;  

func_818F03:
	ora.b [$5C]                          ;818F03|075C    |00005C;  
	bne func_818ED8                      ;818F05|D0D1    |C18ED8;  
...
func_818F1F:
	...
	bcs func_818F1F                      ;818F23|B0FA    |C18F1F;  
	sty.w $103B                          ;818F25|8C3B10  |81103B;  
	sep #$10                             ;818F28|E210    |      ;  
	lda.w #$4000                         ;818F2A|A90040  |      ;  
	sta.b $51                            ;818F2D|8551    |000051;  
	ldy.b #$DD                           ;818F2F|A0DD    |      ;  
	sty.b $53                            ;818F31|8453    |000053;  
	lda.b [$51]                          ;818F33|A751    |000051;  
	clc                                  ;818F35|18      |      ;  
	adc.b $51                            ;818F36|6551    |000051;  
	sta.b $51                            ;818F38|8551    |000051;  
...
func_818F54:
	...
	bne func_818F54                      ;818F5E|D0F4    |C18F54;  
	txa                                  ;818F60|8A      |      ;  
...
func_818F66:
	...
	stz.b $00                            ;818F6F|6400    |000000;  
	lda.l $B36000                        ;818F71|AF0060B3|B36000;  
	cmp.b #$4D                           ;818F75|C94D    |      ;  
	bne func_818F83                      ;818F77|D00A    |C18F83;  
...
func_818F89:
	php                                  ;818F89|08      |      ;  
	sep #$20                             ;818F8A|E220    |      ;  
	lda.b $5B                            ;818F8C|A55B    |00005B;  
	eor.b #$FF                           ;818F8E|49FF    |      ;  
	xba                                  ;818F90|EB      |      ;  
	lda.b #$00                           ;818F91|A900    |      ;  
	sta.b $5B                            ;818F93|855B    |00005B;  
	rep #$20                             ;818F95|C220    |      ;  
	asl a                                ;818F97|0A      |      ;  
	bcs func_818F9C                      ;818F98|B002    |C18F9C;  
	adc.b $5A                            ;818F9A|655A    |00005A;  

func_818F9C:
	asl a                                ;818F9C|0A      |      ;  
	bcs func_818FA1                      ;818F9D|B002    |C18FA1;  
	adc.b $5A                            ;818F9F|655A    |00005A;  

func_818FA1:
	asl a                                ;818FA1|0A      |      ;  
	bcs func_818FA6                      ;818FA2|B002    |C18FA6;  
	adc.b $5A                            ;818FA4|655A    |00005A;  

func_818FA6:
	asl a                                ;818FA6|0A      |      ;  
	bcs func_818FAB                      ;818FA7|B002    |C18FAB;  
	adc.b $5A                            ;818FA9|655A    |00005A;  

func_818FAB:
	asl a                                ;818FAB|0A      |      ;  
	bcs func_818FB0                      ;818FAC|B002    |C18FB0;  
	adc.b $5A                            ;818FAE|655A    |00005A;  

func_818FB0:
	asl a                                ;818FB0|0A      |      ;  
	bcs func_818FB5                      ;818FB1|B002    |C18FB5;  
	adc.b $5A                            ;818FB3|655A    |00005A;  

func_818FB5:
	asl a                                ;818FB5|0A      |      ;  
	bcs func_818FBA                      ;818FB6|B002    |C18FBA;  
	adc.b $5A                            ;818FB8|655A    |00005A;  

func_818FBA:
	asl a                                ;818FBA|0A      |      ;  
	bcs func_818FBF                      ;818FBB|B002    |C18FBF;  
	adc.b $5A                            ;818FBD|655A    |00005A;  

func_818FBF:
	sta.b $5A                            ;818FBF|855A    |00005A;  
	plp                                  ;818FC1|28      |      ;  
	rts                                  ;818FC2|60      |      ;  
...
func_818FD6:
	...
	bcc func_818FD6                      ;818FEB|90E9    |C18FD6;  
...
func_818FF3:
	...
	bcc func_818FF3                      ;819008|90E9    |C18FF3;  
...
func_819010:
	...
	bcc func_819010                      ;819025|90E9    |C19010;  
...
func_819038:
	...
	clc                                  ;81903D|18      |      ;  
	adc.b $00                            ;81903E|6500    |000000;  
	sta.b $00                            ;819040|8500    |000000;  
	ldy.b #$01                           ;819042|A001    |      ;  
	bra func_81904F                      ;819044|8009    |C1904F;  

func_819046:
	jsl.l CODE_C627DB                    ;819046|22DB27C6|C627DB;  
	php                                  ;81904A|08      |      ;  
	sep #$30                             ;81904B|E230    |      ;  
...
func_8190A4:
	...
	dex                                  ;8190B3|CA      |      ;  
	dex                                  ;8190B4|CA      |      ;  
	bpl func_8190A4                      ;8190B5|10ED    |C190A4;  
	lda.w #$0907                         ;8190B7|A90709  |      ;  
	sta.b $00                            ;8190BA|8500    |000000;  
	lda.w #$C5B9                         ;8190BC|A9B9C5  |      ;load palette data table address?
	sta.b rUnkPtrLo_02                   ;8190BF|8502    |000002;  
	lda.w #$00FB                         ;8190C1|A9FB00  |      ;  
	sta.b rUnkPtrHi_02                   ;8190C4|8504    |000004;  
	jsl.l func_80886F                    ;8190C6|226F8880|80886F;  
	jsl.l func_8085B1                    ;8190CA|22B18580|8085B1;  
	stz.b $00                            ;8190CE|6400    |000000;  
	stz.b rUnkPtrLo_02                   ;8190D0|6402    |000002;  
...
func_8190EC:
	php                                  ;8190EC|08      |      ;  
	sep #$20                             ;8190ED|E220    |      ;  
	jsl.l CODE_C3E178                    ;8190EF|2278E1C3|C3E178;  
	lda.b $00                            ;8190F3|A500    |000000;  
	cmp.b #$01                           ;8190F5|C901    |      ;  
	bne func_81916B                      ;8190F7|D072    |C1916B;  
	jsl.l CODE_C3E3BC                    ;8190F9|22BCE3C3|C3E3BC;  
	lda.b #$7E                           ;8190FD|A97E    |      ;  
	pha                                  ;8190FF|48      |      ;  
	plb                                  ;819100|AB      |      ;  
	rep #$30                             ;819101|C230    |      ;  
	lda.b $00                            ;819103|A500    |000000;  
	beq func_81916B                      ;819105|F064    |C1916B;  
...
func_819136:
	...
	dex                                  ;81914B|CA      |      ;  
	dex                                  ;81914C|CA      |      ;  
	bmi func_819159                      ;81914D|300A    |C19159;  
	dec.b $62                            ;81914F|C662    |000062;  
	bpl func_819136                      ;819151|10E3    |C19136;  
	jsl.l func_80854A                    ;819153|224A8580|80854A;  
	bra func_819131                      ;819157|80D8    |C19131;  

func_819159:
	jsl.l func_80854A                    ;819159|224A8580|80854A;  
	lda.w #$91ED                         ;81915D|A9ED91  |      ;  
	sta.b $00                            ;819160|8500    |000000;  
	lda.w #$0081                         ;819162|A98100  |      ;  
	sta.b rUnkPtrLo_02                   ;819165|8502    |000002;  
...
func_81916D:
	phx                                  ;81916D|DA      |      ;  
	clc                                  ;81916E|18      |      ;  
	adc.l DATA8_C0018E                   ;81916F|6F8E01C0|C0018E;  
	tax                                  ;819173|AA      |      ;  
	lda.l DATA8_C00000,x                 ;819174|BF0000C0|C00000;  
	sta.b $00                            ;819178|8500    |000000;  
	lda.l DATA8_C00002,x                 ;81917A|BF0200C0|C00002;  
	sta.b rUnkPtrLo_02                   ;81917E|8502    |000002;  
	...
	sta.b rUnkPtrHi_02                   ;819192|8504    |000004;  
	phx                                  ;819194|DA      |      ;  
	phb                                  ;819195|8B      |      ;  
	jsl.l func_81C913                    ;819196|2213C981|81C913;  
	plb                                  ;81919A|AB      |      ;  
	plx                                  ;81919B|FA      |      ;  
	lda.b $00                            ;81919C|A500    |000000;  
	sta.w $2254,x                        ;81919E|9D5422  |7E2254;  
	lda.b rUnkPtrLo_02                   ;8191A1|A502    |000002;  
...
func_8191BB:
	...
	beq func_8191DD                      ;8191C7|F014    |C191DD;  
...
func_8191DD:
	...
	sta.b $00                            ;8191E0|8500    |000000;  
	lda.w #$0081                         ;8191E2|A98100  |      ;  
	sta.b rUnkPtrLo_02                   ;8191E5|8502    |000002;  
	...
	bne UNREACH_C19225                   ;8191F9|D02A    |C19225;  
	dec.w $3436                          ;8191FB|CE3634  |7E3436;  
	bpl func_819223                      ;8191FE|1023    |C19223;  
	lda.w #$0168                         ;819200|A96801  |      ;  
	ldx.b $00                            ;819203|A600    |000000;  
	ldy.w $3440                          ;819205|AC4034  |7E3440;  
	beq func_81921E                      ;819208|F014    |C1921E;  
	jsl.l CODE_C3E3BC                    ;81920A|22BCE3C3|C3E3BC;  
	lda.w #$0168                         ;81920E|A96801  |      ;  
	cmp.b $00                            ;819211|C500    |000000;  
	bcs func_81921E                      ;819213|B009    |C1921E;  
	db $A9,$01,$00,$8D,$34,$34,$A9,$EC   ;819215|        |      ;  
	db $FF                               ;81921D|        |34368D;  

func_81921E:
	sta.w $3436                          ;81921E|8D3634  |7E3436;  
	stx.b $00                            ;819221|8600    |000000;  
...
func_81933D:
	...
	bcs func_819350                      ;81934A|B004    |C19350;  
...
func_819356:
	...
	beq func_8193A6                      ;81935F|F045    |C193A6;  
...
func_8193DC:
	...
	beq func_819415                      ;8193E3|F030    |C19415;  
	...
	bne func_819412                      ;81940D|D003    |C19412;  
...
func_8194A0:
	lda.b $6A                            ;8194A0|A56A    |00006A;  
	sta.w $2282                          ;8194A2|8D8222  |7E2282;  
	cmp.w #$0004                         ;8194A5|C90400  |      ;  
	bcc func_8194BF                      ;8194A8|9015    |C194BF;  
	dec a                                ;8194AA|3A      |      ;  
	dec a                                ;8194AB|3A      |      ;  
	sta.b $6A                            ;8194AC|856A    |00006A;  
	ldx.w #$0000                         ;8194AE|A20000  |      ;  

func_8194B1:
	lda.w $30CC,x                        ;8194B1|BDCC30  |7E30CC;  
	cmp.w $30CA,x                        ;8194B4|DDCA30  |7E30CA;  
	bmi func_8194CE                      ;8194B7|3015    |C194CE;  
	inx                                  ;8194B9|E8      |      ;  
	inx                                  ;8194BA|E8      |      ;  
	cpx.b $6A                            ;8194BB|E46A    |00006A;  
	bne func_8194B1                      ;8194BD|D0F2    |C194B1;  
...
func_8194E5:
	inx                                  ;8194E5|E8      |      ;  
	inx                                  ;8194E6|E8      |      ;  
	cpx.b $6A                            ;8194E7|E46A    |00006A;  
	bne func_8194C6                      ;8194E9|D0DB    |C194C6;  
	lda.b $6A                            ;8194EB|A56A    |00006A;  
	dec a                                ;8194ED|3A      |      ;  
	dec a                                ;8194EE|3A      |      ;  
	bne func_8194C1                      ;8194EF|D0D0    |C194C1;  
	plp                                  ;8194F1|28      |      ;  
	rtl                                  ;8194F2|6B      |      ;  
...
func_81951D:
	...
	bmi func_819538                      ;81952E|3008    |C19538;  
...
func_819538:
	...
	bpl func_819589                      ;81953B|104C    |C19589;  
	lda.w $220C                          ;81953D|AD0C22  |00220C;  
	beq func_819589                      ;819540|F047    |C19589;  
	...
	bpl func_819566                      ;819553|1011    |C19566;  
	inc a                                ;819555|1A      |      ;  
	inc a                                ;819556|1A      |      ;  
	cmp.w #$000C                         ;819557|C90C00  |      ;  
	bcc func_81955D                      ;81955A|9001    |C1955D;  
	tdc                                  ;81955C|7B      |      ;  
...
func_819589:
	...
	bne func_8195FB                      ;81958F|D06A    |C195FB;  
	lda.w $23B4                          ;819591|ADB423  |7E23B4;  
	beq func_8195C6                      ;819594|F030    |C195C6;  
	lda.w $2DAC                          ;819596|ADAC2D  |7E2DAC;  
	bne func_81959E                      ;819599|D003    |C1959E;  
...
func_8195C6:
	...
	beq func_8195FB                      ;8195C9|F030    |C195FB;  
	lda.w $2DAA                          ;8195CB|ADAA2D  |7E2DAA;  
	bne func_8195D3                      ;8195CE|D003    |C195D3;  
...
func_8196DC:
	...
	plb                                  ;8196E2|AB      |      ;  
	rep #$30                             ;8196E3|C230    |      ;  
	lda.b rUnkPtrLo_02                   ;8196E5|A502    |000002;  
	sta.w $228A                          ;8196E7|8D8A22  |7E228A;  
	sec                                  ;8196EA|38      |      ;  
	sbc.w #$0080                         ;8196EB|E98000  |      ;  
	sta.b rUnkPtrHi_02                   ;8196EE|8504    |000004;  
	clc                                  ;8196F0|18      |      ;  
	adc.w #$0101                         ;8196F1|690101  |      ;  
	sta.b $06                            ;8196F4|8506    |000006;  
	lda.b $00                            ;8196F6|A500    |000000;  
	sta.w $2288                          ;8196F8|8D8822  |7E2288;  
	sec                                  ;8196FB|38      |      ;  
	sbc.w #$00A0                         ;8196FC|E9A000  |      ;  
	sta.b $00                            ;8196FF|8500    |000000;  
	clc                                  ;819701|18      |      ;  
	adc.w #$0141                         ;819702|694101  |      ;  
	sta.b rUnkPtrLo_02                   ;819705|8502    |000002;  
	ldx.w #$0026                         ;819707|A22600  |      ;  

func_81970A:
	stz.w $235E,x                        ;81970A|9E5E23  |7E235E;  
	lda.w $22AE,x                        ;81970D|BDAE22  |7E22AE;  
	beq func_81972E                      ;819710|F01C    |C1972E;  
	lda.w $2936,x                        ;819712|BD3629  |7E2936;  
	cmp.b $00                            ;819715|C500    |000000;  
	bmi func_81972E                      ;819717|3015    |C1972E;  
	cmp.b rUnkPtrLo_02                   ;819719|C502    |000002;  
	bpl func_81972E                      ;81971B|1011    |C1972E;  
	lda.w $298E,x                        ;81971D|BD8E29  |7E298E;  
	cmp.b rUnkPtrHi_02                   ;819720|C504    |000004;  
	bmi func_81972E                      ;819722|300A    |C1972E;  
	cmp.b $06                            ;819724|C506    |000006;  
	bpl func_81972E                      ;819726|1006    |C1972E;  
...
func_81972E:
	dex                                  ;81972E|CA      |      ;  
	dex                                  ;81972F|CA      |      ;  
	bpl func_81970A                      ;819730|10D8    |C1970A;  
...
func_819781:
	sec                                  ;819781|38      |      ;  
	sbc.b $6A                            ;819782|E56A    |00006A;  
	sta.b rUnkPtrLo_02                   ;819784|8502    |000002;  
	lda.w $2CFE,y                        ;819786|B9FE2C  |7E2CFE;  
	sec                                  ;819789|38      |      ;  
	sbc.b $6C                            ;81978A|E56C    |00006C;  
	sta.b rUnkPtrHi_02                   ;81978C|8504    |000004;  
	phb                                  ;81978E|8B      |      ;  
	phx                                  ;81978F|DA      |      ;  
	ldx.w $2E5E,y                        ;819790|BE5E2E  |7E2E5E;  
	cpx.w #$0033                         ;819793|E03300  |      ;  
	bcs func_81979B                      ;819796|B003    |C1979B;  
...
func_8197A5:
	inc.b $6E                            ;8197A5|E66E    |00006E;  
	plx                                  ;8197A7|FA      |      ;  
	plb                                  ;8197A8|AB      |      ;  
	dex                                  ;8197A9|CA      |      ;  
	dex                                  ;8197AA|CA      |      ;  
	beq func_8197C0                      ;8197AB|F013    |C197C0;  
	lda.b $6E                            ;8197AD|A56E    |00006E;  
...
func_8197C0:
	...
	sta.b $6C                            ;8197C5|856C    |00006C;  
	lda.b $6E                            ;8197C7|A56E    |00006E;  
	sta.w $2284                          ;8197C9|8D8422  |7E2284;  
	cmp.b $6C                            ;8197CC|C56C    |00006C;  
	bcs func_8197DD                      ;8197CE|B00D    |C197DD;  

func_8197D0:
	sta.b $00                            ;8197D0|8500    |000000;  
	jsl.l func_809180                    ;8197D2|22809180|809180;  
	lda.b $00                            ;8197D6|A500    |000000;  
	inc a                                ;8197D8|1A      |      ;  
	cmp.b $6C                            ;8197D9|C56C    |00006C;  
	bcc func_8197D0                      ;8197DB|90F3    |C197D0;  
...
func_81982D:
	...
	beq func_819840                      ;819830|F00E    |C19840;  
...
func_819840:
	...
	db $97                               ;8198C1|        |0000A5;  
	lda.b $06                            ;8198C2|A506    |000006;  
	bmi func_8198D2                      ;8198C4|300C    |C198D2;  
	jsl.l func_809617                    ;8198C6|22179680|809617;  
	lda.b rUnkPtrHi_02                   ;8198CA|A504    |000004;  
	clc                                  ;8198CC|18      |      ;  
	adc.w #$0010                         ;8198CD|691000  |      ;  
	bra func_8198E0                      ;8198D0|800E    |C198E0;  

func_8198D2:
	lda.b rUnkPtrHi_02                   ;8198D2|A504    |000004;  
	pha                                  ;8198D4|48      |      ;  
	clc                                  ;8198D5|18      |      ;  
	adc.w #$0010                         ;8198D6|691000  |      ;  
	sta.b rUnkPtrHi_02                   ;8198D9|8504    |000004;  
	jsl.l func_809617                    ;8198DB|22179680|809617;  
	pla                                  ;8198DF|68      |      ;  

func_8198E0:
	sta.b rUnkPtrHi_02                   ;8198E0|8504    |000004;  
	lda.b $00                            ;8198E2|A500    |000000;  
	asl a                                ;8198E4|0A      |      ;  
	asl a                                ;8198E5|0A      |      ;  
	inc a                                ;8198E6|1A      |      ;  
	sta.b $00                            ;8198E7|8500    |000000;  
	lda.b $06                            ;8198E9|A506    |000006;  
	inc a                                ;8198EB|1A      |      ;  
	inc a                                ;8198EC|1A      |      ;  
	sta.b $06                            ;8198ED|8506    |000006;  
	jsl.l func_80914D                    ;8198EF|224D9180|80914D;  
	jmp.w func_8197A5                    ;8198F3|4CA597  |C197A5;  
	lda.b $06                            ;8198F6|A506    |000006;  
	asl a                                ;8198F8|0A      |      ;  
	bmi UNREACH_C19904                   ;8198F9|3009    |C19904;  
	lda.b rUnkPtrLo_02                   ;8198FB|A502    |000002;  
	clc                                  ;8198FD|18      |      ;  
	adc.w #$0008                         ;8198FE|690800  |      ;  
	pha                                  ;819901|48      |      ;  
	bra func_81990D                      ;819902|8009    |C1990D;  
...
func_81990D:
	lda.b $06                            ;81990D|A506    |000006;  
	bmi UNREACH_C1991D                   ;81990F|300C    |C1991D;  
	jsl.l func_809617                    ;819911|22179680|809617;  
	lda.b rUnkPtrHi_02                   ;819915|A504    |000004;  
	clc                                  ;819917|18      |      ;  
	adc.w #$0010                         ;819918|691000  |      ;  
	bra func_81992B                      ;81991B|800E    |C1992B;  
...
func_81992B:
	sta.b rUnkPtrHi_02                   ;81992B|8504    |000004;  
	pla                                  ;81992D|68      |      ;  
	sta.b rUnkPtrLo_02                   ;81992E|8502    |000002;  
	lda.b $00                            ;819930|A500    |000000;  
	asl a                                ;819932|0A      |      ;  
	asl a                                ;819933|0A      |      ;  
	inc a                                ;819934|1A      |      ;  
	sta.b $00                            ;819935|8500    |000000;  
	lda.b $06                            ;819937|A506    |000006;  
	inc a                                ;819939|1A      |      ;  
	inc a                                ;81993A|1A      |      ;  
	sta.b $06                            ;81993B|8506    |000006;  
	jsl.l func_80914D                    ;81993D|224D9180|80914D;  
	jmp.w func_8197A5                    ;819941|4CA597  |C197A5;  
	lda.b $06                            ;819944|A506    |000006;  
	asl a                                ;819946|0A      |      ;  
	bmi UNREACH_C19952                   ;819947|3009    |C19952;  
	lda.b rUnkPtrLo_02                   ;819949|A502    |000002;  
	clc                                  ;81994B|18      |      ;  
	adc.w #$0008                         ;81994C|690800  |      ;  
	pha                                  ;81994F|48      |      ;  
	bra func_81995B                      ;819950|8009    |C1995B;  
...
func_81995B:
	lda.b $06                            ;81995B|A506    |000006;  
	bmi func_81996B                      ;81995D|300C    |C1996B;  
	jsl.l func_809617                    ;81995F|22179680|809617;  
	lda.b rUnkPtrHi_02                   ;819963|A504    |000004;  
	clc                                  ;819965|18      |      ;  
	adc.w #$0008                         ;819966|690800  |      ;  
	bra func_81992B                      ;819969|80C0    |C1992B;  

func_81996B:
	lda.b rUnkPtrHi_02                   ;81996B|A504    |000004;  
	pha                                  ;81996D|48      |      ;  
	clc                                  ;81996E|18      |      ;  
	adc.w #$0008                         ;81996F|690800  |      ;  
	sta.b rUnkPtrHi_02                   ;819972|8504    |000004;  
	jsl.l func_809617                    ;819974|22179680|809617;  
	pla                                  ;819978|68      |      ;  
	bra func_81992B                      ;819979|80B0    |C1992B;  
	...
	db $99                               ;8199B3|        |0006A5;  
	lda.b $06                            ;8199B4|A506    |000006;  
	asl a                                ;8199B6|0A      |      ;  
	bmi func_8199C5                      ;8199B7|300C    |C199C5;  
	jsl.l func_809617                    ;8199B9|22179680|809617;  
	lda.b rUnkPtrLo_02                   ;8199BD|A502    |000002;  
	clc                                  ;8199BF|18      |      ;  
	adc.w #$0010                         ;8199C0|691000  |      ;  
	bra func_8199D3                      ;8199C3|800E    |C199D3;  

func_8199C5:
	lda.b rUnkPtrLo_02                   ;8199C5|A502    |000002;  
	pha                                  ;8199C7|48      |      ;  
	clc                                  ;8199C8|18      |      ;  
	adc.w #$0010                         ;8199C9|691000  |      ;  
	sta.b rUnkPtrLo_02                   ;8199CC|8502    |000002;  
	jsl.l func_809617                    ;8199CE|22179680|809617;  
	pla                                  ;8199D2|68      |      ;  

func_8199D3:
	sta.b rUnkPtrLo_02                   ;8199D3|8502    |000002;  
	lda.b $00                            ;8199D5|A500    |000000;  
	asl a                                ;8199D7|0A      |      ;  
	asl a                                ;8199D8|0A      |      ;  
	inc a                                ;8199D9|1A      |      ;  
	sta.b $00                            ;8199DA|8500    |000000;  
	sta.b $00                            ;8199DC|8500    |000000;  
	lda.b $06                            ;8199DE|A506    |000006;  
	inc a                                ;8199E0|1A      |      ;  
	inc a                                ;8199E1|1A      |      ;  
	sta.b $06                            ;8199E2|8506    |000006;  
	jsl.l func_80914D                    ;8199E4|224D9180|80914D;  
	jmp.w func_8197A5                    ;8199E8|4CA597  |C197A5;  
	lda.b rUnkPtrLo_02                   ;8199EB|A502    |000002;  
	pha                                  ;8199ED|48      |      ;  
	sec                                  ;8199EE|38      |      ;  
	sbc.w #$0008                         ;8199EF|E90800  |      ;  
	sta.b rUnkPtrLo_02                   ;8199F2|8502    |000002;  
	jsl.l func_809617                    ;8199F4|22179680|809617;  
	lda.b rUnkPtrHi_02                   ;8199F8|A504    |000004;  
	clc                                  ;8199FA|18      |      ;  
	adc.w #$0010                         ;8199FB|691000  |      ;  
	sta.b rUnkPtrHi_02                   ;8199FE|8504    |000004;  
	lda.b $00                            ;819A00|A500    |000000;  
	asl a                                ;819A02|0A      |      ;  
	asl a                                ;819A03|0A      |      ;  
	inc a                                ;819A04|1A      |      ;  
	sta.b $00                            ;819A05|8500    |000000;  
	lda.b $06                            ;819A07|A506    |000006;  
	bit.w #$4000                         ;819A09|890040  |      ;  
	bne func_819A1E                      ;819A0C|D010    |C19A1E;  
	inc a                                ;819A0E|1A      |      ;  
	inc a                                ;819A0F|1A      |      ;  
	sta.b $06                            ;819A10|8506    |000006;  
	jsl.l func_80911A                    ;819A12|221A9180|80911A;  
	lda.b $06                            ;819A16|A506    |000006;  
	clc                                  ;819A18|18      |      ;  
	adc.w #$0010                         ;819A19|691000  |      ;  
	bra func_819A2E                      ;819A1C|8010    |C19A2E;  

func_819A1E:
	clc                                  ;819A1E|18      |      ;  
	adc.w #$0012                         ;819A1F|691200  |      ;  
	sta.b $06                            ;819A22|8506    |000006;  
	jsl.l func_80911A                    ;819A24|221A9180|80911A;  
	lda.b $06                            ;819A28|A506    |000006;  
	sec                                  ;819A2A|38      |      ;  
	sbc.w #$0010                         ;819A2B|E91000  |      ;  

func_819A2E:
	sta.b $06                            ;819A2E|8506    |000006;  
	inc.b $00                            ;819A30|E600    |000000;  
	pla                                  ;819A32|68      |      ;  
	sta.b rUnkPtrLo_02                   ;819A33|8502    |000002;  
	...
	lda.b rUnkPtrLo_02                   ;819A97|A502    |000002;  
	clc                                  ;819A99|18      |      ;  
	...
	clc                                  ;819AA5|18      |      ;  
	adc.b rUnkPtrHi_02                   ;819AA6|6504    |000004;  
	sta.b rUnkPtrHi_02                   ;819AA8|8504    |000004;  
	lda.b $00                            ;819AAA|A500    |000000;  
	asl a                                ;819AAC|0A      |      ;  
	asl a                                ;819AAD|0A      |      ;  
	inc a                                ;819AAE|1A      |      ;  
	sta.b $00                            ;819AAF|8500    |000000;  
	lda.b $06                            ;819AB1|A506    |000006;  
	inc a                                ;819AB3|1A      |      ;  
	inc a                                ;819AB4|1A      |      ;  
	bit.w #$4000                         ;819AB5|890040  |      ;  
	bne func_819AC4                      ;819AB8|D00A    |C19AC4;  
	sta.b $06                            ;819ABA|8506    |000006;  
	jsl.l func_80911A                    ;819ABC|221A9180|80911A;  
	inc.b $06                            ;819AC0|E606    |000006;  
	bra func_819ACD                      ;819AC2|8009    |C19ACD;  

func_819AC4:
	inc a                                ;819AC4|1A      |      ;  
	sta.b $06                            ;819AC5|8506    |000006;  
	jsl.l func_80911A                    ;819AC7|221A9180|80911A;  
	dec.b $06                            ;819ACB|C606    |000006;  

func_819ACD:
	inc.b $00                            ;819ACD|E600    |000000;  
	pla                                  ;819ACF|68      |      ;  
	sta.b rUnkPtrLo_02                   ;819AD0|8502    |000002;  
	...
	lda.b rUnkPtrLo_02                   ;819B32|A502    |000002;  
	sec                                  ;819B34|38      |      ;  
	sbc.w #$0004                         ;819B35|E90400  |      ;  
	sta.b rUnkPtrLo_02                   ;819B38|8502    |000002;  
	lda.b rUnkPtrHi_02                   ;819B3A|A504    |000004;  
	sec                                  ;819B3C|38      |      ;  
	sbc.w #$0004                         ;819B3D|E90400  |      ;  
	sta.b rUnkPtrHi_02                   ;819B40|8504    |000004;  
	jsl.l func_8095BE                    ;819B42|22BE9580|8095BE;  
	jmp.w func_8197A5                    ;819B46|4CA597  |C197A5;  
	lda.b rUnkPtrLo_02                   ;819B49|A502    |000002;  
	sec                                  ;819B4B|38      |      ;  
	sbc.w #$0008                         ;819B4C|E90800  |      ;  
	sta.b rUnkPtrLo_02                   ;819B4F|8502    |000002;  
	lda.b rUnkPtrHi_02                   ;819B51|A504    |000004;  
	sec                                  ;819B53|38      |      ;  
	sbc.w #$0008                         ;819B54|E90800  |      ;  
	sta.b rUnkPtrHi_02                   ;819B57|8504    |000004;  
	...
	lda.b rUnkPtrHi_02                   ;819BD1|A504    |000004;  
	pha                                  ;819BD3|48      |      ;  
	sec                                  ;819BD4|38      |      ;  
	sbc.w #$0008                         ;819BD5|E90800  |      ;  
	sta.b rUnkPtrHi_02                   ;819BD8|8504    |000004;  
	lda.b $06                            ;819BDA|A506    |000006;  
	asl a                                ;819BDC|0A      |      ;  
	bmi func_819BF3                      ;819BDD|3014    |C19BF3;  
	lda.b rUnkPtrLo_02                   ;819BDF|A502    |000002;  
	sec                                  ;819BE1|38      |      ;  
	sbc.w #$000C                         ;819BE2|E90C00  |      ;  
	sta.b rUnkPtrLo_02                   ;819BE5|8502    |000002;  
	jsl.l func_809617                    ;819BE7|22179680|809617;  
	lda.b rUnkPtrLo_02                   ;819BEB|A502    |000002;  
	clc                                  ;819BED|18      |      ;  
	adc.w #$0010                         ;819BEE|691000  |      ;  
	bra func_819C05                      ;819BF1|8012    |C19C05;  

func_819BF3:
	lda.b rUnkPtrLo_02                   ;819BF3|A502    |000002;  
	sec                                  ;819BF5|38      |      ;  
	sbc.w #$0004                         ;819BF6|E90400  |      ;  
	sta.b rUnkPtrLo_02                   ;819BF9|8502    |000002;  
	jsl.l func_809617                    ;819BFB|22179680|809617;  
	lda.b rUnkPtrLo_02                   ;819BFF|A502    |000002;  
	sec                                  ;819C01|38      |      ;  
	sbc.w #$0008                         ;819C02|E90800  |      ;  

func_819C05:
	sta.b rUnkPtrLo_02                   ;819C05|8502    |000002;  
	lda.b $00                            ;819C07|A500    |000000;  
	asl a                                ;819C09|0A      |      ;  
	asl a                                ;819C0A|0A      |      ;  
	inc a                                ;819C0B|1A      |      ;  
	sta.b $00                            ;819C0C|8500    |000000;  
	lda.b $06                            ;819C0E|A506    |000006;  
	inc a                                ;819C10|1A      |      ;  
	inc a                                ;819C11|1A      |      ;  
	bmi UNREACH_C19C21                   ;819C12|300D    |C19C21;  
	sta.b $06                            ;819C14|8506    |000006;  
	clc                                  ;819C16|18      |      ;  
	adc.w #$0010                         ;819C17|691000  |      ;  
	pha                                  ;819C1A|48      |      ;  
	jsl.l func_80911A                    ;819C1B|221A9180|80911A;  
	bra func_819C2C                      ;819C1F|800B    |C19C2C;  
...
func_819C2C:
	pla                                  ;819C2C|68      |      ;  
	sta.b $06                            ;819C2D|8506    |000006;  
	inc.b $00                            ;819C2F|E600    |000000;  
	pla                                  ;819C31|68      |      ;  
	sta.b rUnkPtrHi_02                   ;819C32|8504    |000004;  
	jsl.l func_80911A                    ;819C34|221A9180|80911A;  
	jmp.w func_8197A5                    ;819C38|4CA597  |C197A5;  
	lda.b $06                            ;819C3B|A506    |000006;  
	bmi func_819C71                      ;819C3D|3032    |C19C71;  
	jsl.l func_8095BE                    ;819C3F|22BE9580|8095BE;  
	lda.b $00                            ;819C43|A500    |000000;  
	asl a                                ;819C45|0A      |      ;  
	asl a                                ;819C46|0A      |      ;  
	inc a                                ;819C47|1A      |      ;  
	sta.b $00                            ;819C48|8500    |000000;  
	inc.b $06                            ;819C4A|E606    |000006;  
	lda.b rUnkPtrHi_02                   ;819C4C|A504    |000004;  
	clc                                  ;819C4E|18      |      ;  
	adc.w #$0008                         ;819C4F|690800  |      ;  
	sta.b rUnkPtrHi_02                   ;819C52|8504    |000004;  
	jsl.l func_80911A                    ;819C54|221A9180|80911A;  
	inc.b $00                            ;819C58|E600    |000000;  
	lda.b rUnkPtrHi_02                   ;819C5A|A504    |000004;  
	clc                                  ;819C5C|18      |      ;  
	adc.w #$0008                         ;819C5D|690800  |      ;  
	sta.b rUnkPtrHi_02                   ;819C60|8504    |000004;  
	lda.b $06                            ;819C62|A506    |000006;  
	clc                                  ;819C64|18      |      ;  
	adc.w #$000F                         ;819C65|690F00  |      ;  
	sta.b $06                            ;819C68|8506    |000006;  
...
func_819C71:
	...
	sta.b $06                            ;819C76|8506    |000006;  
	jsl.l func_8095BE                    ;819C78|22BE9580|8095BE;  
	lda.b $00                            ;819C7C|A500    |000000;  
	asl a                                ;819C7E|0A      |      ;  
	asl a                                ;819C7F|0A      |      ;  
	inc a                                ;819C80|1A      |      ;  
	sta.b $00                            ;819C81|8500    |000000;  
	pla                                  ;819C83|68      |      ;  
	sta.b $06                            ;819C84|8506    |000006;  
	lda.b rUnkPtrHi_02                   ;819C86|A504    |000004;  
	clc                                  ;819C88|18      |      ;  
	adc.w #$0010                         ;819C89|691000  |      ;  
	sta.b rUnkPtrHi_02                   ;819C8C|8504    |000004;  
	jsl.l func_80911A                    ;819C8E|221A9180|80911A;  
	inc.b $00                            ;819C92|E600    |000000;  
	lda.b rUnkPtrHi_02                   ;819C94|A504    |000004;  
	sec                                  ;819C96|38      |      ;  
	sbc.w #$0008                         ;819C97|E90800  |      ;  
	sta.b rUnkPtrHi_02                   ;819C9A|8504    |000004;  
	inc.b $06                            ;819C9C|E606    |000006;  
	jsl.l func_80911A                    ;819C9E|221A9180|80911A;  
	jmp.w func_8197A5                    ;819CA2|4CA597  |C197A5;  
	lda.b $06                            ;819CA5|A506    |000006;  
	bit.w #$4000                         ;819CA7|890040  |      ;  
	bne func_819CDE                      ;819CAA|D032    |C19CDE;  
	jsl.l func_8095BE                    ;819CAC|22BE9580|8095BE;  
	lda.b $00                            ;819CB0|A500    |000000;  
	asl a                                ;819CB2|0A      |      ;  
	asl a                                ;819CB3|0A      |      ;  
	inc a                                ;819CB4|1A      |      ;  
	sta.b $00                            ;819CB5|8500    |000000;  
	inc.b $06                            ;819CB7|E606    |000006;  
	lda.b rUnkPtrLo_02                   ;819CB9|A502    |000002;  
	clc                                  ;819CBB|18      |      ;  
	adc.w #$0008                         ;819CBC|690800  |      ;  
	sta.b rUnkPtrLo_02                   ;819CBF|8502    |000002;  
	jsl.l func_80911A                    ;819CC1|221A9180|80911A;  
	inc.b $00                            ;819CC5|E600    |000000;  
	lda.b rUnkPtrLo_02                   ;819CC7|A502    |000002;  
	clc                                  ;819CC9|18      |      ;  
	adc.w #$0008                         ;819CCA|690800  |      ;  
	sta.b rUnkPtrLo_02                   ;819CCD|8502    |000002;  
	lda.b $06                            ;819CCF|A506    |000006;  
	clc                                  ;819CD1|18      |      ;  
	adc.w #$000F                         ;819CD2|690F00  |      ;  
	sta.b $06                            ;819CD5|8506    |000006;  
...
func_819CDE:
	...
	sta.b $06                            ;819CE3|8506    |000006;  
	jsl.l func_8095BE                    ;819CE5|22BE9580|8095BE;  
	lda.b $00                            ;819CE9|A500    |000000;  
	asl a                                ;819CEB|0A      |      ;  
	asl a                                ;819CEC|0A      |      ;  
	inc a                                ;819CED|1A      |      ;  
	sta.b $00                            ;819CEE|8500    |000000;  
	pla                                  ;819CF0|68      |      ;  
	sta.b $06                            ;819CF1|8506    |000006;  
	lda.b rUnkPtrLo_02                   ;819CF3|A502    |000002;  
	clc                                  ;819CF5|18      |      ;  
	adc.w #$0010                         ;819CF6|691000  |      ;  
	sta.b rUnkPtrLo_02                   ;819CF9|8502    |000002;  
	jsl.l func_80911A                    ;819CFB|221A9180|80911A;  
	inc.b $00                            ;819CFF|E600    |000000;  
	lda.b rUnkPtrLo_02                   ;819D01|A502    |000002;  
	sec                                  ;819D03|38      |      ;  
	sbc.w #$0008                         ;819D04|E90800  |      ;  
	sta.b rUnkPtrLo_02                   ;819D07|8502    |000002;  
	inc.b $06                            ;819D09|E606    |000006;  
...
func_819E14:
	lda.b $06                            ;819E14|A506    |000006;  
	pha                                  ;819E16|48      |      ;  
	lda.b rUnkPtrHi_02                   ;819E17|A504    |000004;  
	pha                                  ;819E19|48      |      ;  
	lda.b rUnkPtrLo_02                   ;819E1A|A502    |000002;  
	pha                                  ;819E1C|48      |      ;  
	ldy.w #$0005                         ;819E1D|A00500  |      ;  
	lda.b $00                            ;819E20|A500    |000000;  
	asl a                                ;819E22|0A      |      ;  
	asl a                                ;819E23|0A      |      ;  
	sta.b $00                            ;819E24|8500    |000000;  
	cpx.w #$0033                         ;819E26|E03300  |      ;  
	beq UNREACH_C19E2E                   ;819E29|F003    |C19E2E;  
...
func_819EA6:
	...
	tax                                  ;819EAD|AA      |      ;  
	bra func_819EB2                      ;819EAE|8002    |C19EB2;  

func_819EB0:
	inc.b $00                            ;819EB0|E600    |000000;  

func_819EB2:
	lda.l DATA8_C69378,x                 ;819EB2|BF7893C6|C69378;  
	cmp.w #$FFFF                         ;819EB6|C9FFFF  |      ;  
	beq func_819F19                      ;819EB9|F05E    |C19F19;  
	phy                                  ;819EBB|5A      |      ;  
	tay                                  ;819EBC|A8      |      ;  
	and.w #$01FF                         ;819EBD|29FF01  |      ;  
	clc                                  ;819EC0|18      |      ;  
	adc.b $07,s                          ;819EC1|6307    |000007;  
	sta.b $06                            ;819EC3|8506    |000006;  
	tya                                  ;819EC5|98      |      ;  
	and.w #$C000                         ;819EC6|2900C0  |      ;  
	eor.b $06                            ;819EC9|4506    |000006;  
	sta.b $06                            ;819ECB|8506    |000006;  
	tya                                  ;819ECD|98      |      ;  
	and.w #$3000                         ;819ECE|290030  |      ;  
	beq func_819EDE                      ;819ED1|F00B    |C19EDE;  
	bit.w #$2000                         ;819ED3|890020  |      ;  
	bne func_819EDC                      ;819ED6|D004    |C19EDC;  
	lda.l $7E2206                        ;819ED8|AF06227E|7E2206;  

func_819EDC:
	tsb.b $06                            ;819EDC|0406    |000006;  

func_819EDE:
	lda.l DATA8_C6937A,x                 ;819EDE|BF7A93C6|C6937A;  
	clc                                  ;819EE2|18      |      ;  
	adc.b $03,s                          ;819EE3|6303    |000003;  
	sta.b rUnkPtrLo_02                   ;819EE5|8502    |000002;  
	lda.l DATA8_C6937C,x                 ;819EE7|BF7C93C6|C6937C;  
	clc                                  ;819EEB|18      |      ;  
	adc.b $05,s                          ;819EEC|6305    |000005;  
	sta.b rUnkPtrHi_02                   ;819EEE|8504    |000004;  
	phx                                  ;819EF0|DA      |      ;  
	tya                                  ;819EF1|98      |      ;  
	bit.w #$0800                         ;819EF2|890008  |      ;  
	bne func_819EFD                      ;819EF5|D006    |C19EFD;  
	jsl.l func_80911A                    ;819EF7|221A9180|80911A;  
	bra func_819F01                      ;819EFB|8004    |C19F01;  
...
func_819F01:
	...
	ply                                  ;819F07|7A      |      ;  
	dey                                  ;819F08|88      |      ;  
	bne func_819EB0                      ;819F09|D0A5    |C19EB0;  
	ldy.w #$0004                         ;819F0B|A00400  |      ;  
	inc.b $6E                            ;819F0E|E66E    |00006E;  
	lda.b $6E                            ;819F10|A56E    |00006E;  
	cmp.w #$0020                         ;819F12|C92000  |      ;  
	bcc func_819EB0                      ;819F15|9099    |C19EB0;  
...
func_819F19:
	...
	pla                                  ;819F1A|68      |      ;  
	pla                                  ;819F1B|68      |      ;  
	lda.b $00                            ;819F1C|A500    |000000;  
	and.w #$0003                         ;819F1E|290300  |      ;  
	beq func_819F31                      ;819F21|F00E    |C19F31;  

func_819F23:
	jsl.l func_8090ED                    ;819F23|22ED9080|8090ED;  
	lda.b $00                            ;819F27|A500    |000000;  
	inc a                                ;819F29|1A      |      ;  
	sta.b $00                            ;819F2A|8500    |000000;  
	and.w #$0003                         ;819F2C|290300  |      ;  
	bne func_819F23                      ;819F2F|D0F2    |C19F23;  
...
func_819F6B:
	...
	beq func_819F92                      ;819F6E|F022    |C19F92;  
...
func_819F92:
	dex                                  ;819F92|CA      |      ;  
	dex                                  ;819F93|CA      |      ;  
	bpl func_819F6B                      ;819F94|10D5    |C19F6B;  
	plp                                  ;819F96|28      |      ;  
	rtl                                  ;819F97|6B      |      ;  
...
func_819FAA:
	...
	bra func_81A008                      ;819FCB|803B    |C1A008;  

func_819FCD:
	lda.w $256E,x                        ;819FCD|BD6E25  |7E256E;  
	bne UNREACH_C1A00E                   ;819FD0|D03C    |C1A00E;  
	lda.w $2936,x                        ;819FD2|BD3629  |7E2936;  
	cmp.w $29E6,x                        ;819FD5|DDE629  |7E29E6;  
	bne func_819FDF                      ;819FD8|D005    |C19FDF;  
	stz.w $2A96,x                        ;819FDA|9E962A  |7E2A96;  
	bra func_819FE6                      ;819FDD|8007    |C19FE6;  
...
func_819FE6:
	...
	bne func_819FFA                      ;819FF3|D005    |C19FFA;  
	stz.w $2AEE,x                        ;819FF5|9EEE2A  |7E2AEE;  
	bra func_81A001                      ;819FF8|8007    |C1A001;  
...
func_81A008:
	dex                                  ;81A008|CA      |      ;  
	dex                                  ;81A009|CA      |      ;  
	bpl func_819FAA                      ;81A00A|109E    |C19FAA;  
	plp                                  ;81A00C|28      |      ;  
	rtl                                  ;81A00D|6B      |      ;  
...
func_81A080:
	...
	beq func_81A0A5                      ;81A083|F020    |C1A0A5;  
...
func_81A0A5:
	dex                                  ;81A0A5|CA      |      ;  
	dex                                  ;81A0A6|CA      |      ;  
	bpl func_81A080                      ;81A0A7|10D7    |C1A080;  
	plp                                  ;81A0A9|28      |      ;  
	rtl                                  ;81A0AA|6B      |      ;  
...
func_81A0AB:
	...
	beq func_81A0C6                      ;81A0B2|F012    |C1A0C6;  
	cmp.w #$0008                         ;81A0B4|C90800  |      ;  
	bcs func_81A0C1                      ;81A0B7|B008    |C1A0C1;  
...
func_81A0C8:
	...
	beq func_81A0E3                      ;81A0CF|F012    |C1A0E3;  
	cmp.w #$0008                         ;81A0D1|C90800  |      ;  
	bcs func_81A0DE                      ;81A0D4|B008    |C1A0DE;  
...
func_81A141:
	...
	ldx.b $00                            ;81A14E|A600    |000000;  
	lda.w #$0001                         ;81A150|A90100  |      ;  
	sta.b $00                            ;81A153|8500    |000000;  
	lda.b rUnkPtrLo_02                   ;81A155|A502    |000002;  
	pha                                  ;81A157|48      |      ;  
	phx                                  ;81A158|DA      |      ;  
	jsl.l func_81A169                    ;81A159|2269A181|81A169;  
	plx                                  ;81A15D|FA      |      ;  
	pla                                  ;81A15E|68      |      ;  
	sta.b rUnkPtrLo_02                   ;81A15F|8502    |000002;  
	stx.b $00                            ;81A161|8600    |000000;  
...
func_81A169:
	php                                  ;81A169|08      |      ;  
	rep #$20                             ;81A16A|C220    |      ;  
	lda.b $00                            ;81A16C|A500    |000000;  
	beq func_81A1A1                      ;81A16E|F031    |C1A1A1;  
	lda.l $7E220A                        ;81A170|AF0A227E|7E220A;  
	bne func_81A19F                      ;81A174|D029    |C1A19F;  
	tdc                                  ;81A176|7B      |      ;  
	...
	sta.b $00                            ;81A18B|8500    |000000;  
	lda.w #$C703                         ;81A18D|A903C7  |      ;  
	sta.b rUnkPtrLo_02                   ;81A190|8502    |000002;  
	lda.w #$00FB                         ;81A192|A9FB00  |      ;  
	sta.b rUnkPtrHi_02                   ;81A195|8504    |000004;  
...
func_81A1B3:
	...
	lda.b $00                            ;81A1C2|A500    |000000;  
	sta.w $2288                          ;81A1C4|8D8822  |7E2288;  
	lda.b rUnkPtrLo_02                   ;81A1C7|A502    |000002;  
...
Jumptable_81A1D7:
	...
	lda.b rUnkPtrLo_02                   ;81A1E3|A502    |000002;  
	sec                                  ;81A1E5|38      |      ;  
	sbc.w #$0080                         ;81A1E6|E98000  |      ;  
	sta.b rUnkPtrHi_02                   ;81A1E9|8504    |000004;  
	clc                                  ;81A1EB|18      |      ;  
	adc.w #$0101                         ;81A1EC|690101  |      ;  
	sta.b $06                            ;81A1EF|8506    |000006;  
	lda.b $00                            ;81A1F1|A500    |000000;  
	sec                                  ;81A1F3|38      |      ;  
	sbc.w #$00A0                         ;81A1F4|E9A000  |      ;  
	sta.b $00                            ;81A1F7|8500    |000000;  
	clc                                  ;81A1F9|18      |      ;  
	adc.w #$0141                         ;81A1FA|694101  |      ;  
	sta.b rUnkPtrLo_02                   ;81A1FD|8502    |000002;  
...
func_81A205:
	...
	bne func_81A214                      ;81A20B|D007    |C1A214;  
	dex                                  ;81A20D|CA      |      ;  
	dex                                  ;81A20E|CA      |      ;  
	bpl func_81A205                      ;81A20F|10F4    |C1A205;  
	jmp.w func_81A2B1                    ;81A211|4CB1A2  |C1A2B1;  

func_81A214:
	cmp.w $2306,x                        ;81A214|DD0623  |7E2306;  
	bne func_81A262                      ;81A217|D049    |C1A262;  
	lda.w $2936,x                        ;81A219|BD3629  |7E2936;  
	cmp.b $00                            ;81A21C|C500    |000000;  
	bmi func_81A22F                      ;81A21E|300F    |C1A22F;  
	cmp.b rUnkPtrLo_02                   ;81A220|C502    |000002;  
	bpl func_81A22F                      ;81A222|100B    |C1A22F;  
	lda.w $298E,x                        ;81A224|BD8E29  |7E298E;  
	cmp.b rUnkPtrHi_02                   ;81A227|C504    |000004;  
	bmi func_81A22F                      ;81A229|3004    |C1A22F;  
	cmp.b $06                            ;81A22B|C506    |000006;  
	bmi func_81A236                      ;81A22D|3007    |C1A236;  

func_81A22F:
	dex                                  ;81A22F|CA      |      ;  
	dex                                  ;81A230|CA      |      ;  
	bpl func_81A205                      ;81A231|10D2    |C1A205;  
	jmp.w func_81A2B1                    ;81A233|4CB1A2  |C1A2B1;  

func_81A236:
	lda.w $2A96,x                        ;81A236|BD962A  |7E2A96;  
	ora.w $2AEE,x                        ;81A239|1DEE2A  |7E2AEE;  
	beq func_81A241                      ;81A23C|F003    |C1A241;  
...
func_81A241:
	...
	bne func_81A2AA                      ;81A24A|D05E    |C1A2AA;  
	lda.w $2466,x                        ;81A24C|BD6624  |7E2466;  
	bne func_81A26B                      ;81A24F|D01A    |C1A26B;  
	cpx.w #$0026                         ;81A251|E02600  |      ;  
	beq func_81A25B                      ;81A254|F005    |C1A25B;  
	lda.w $2208                          ;81A256|AD0822  |7E2208;  
	beq func_81A2AA                      ;81A259|F04F    |C1A2AA;  

func_81A25B:
	dec.w $25C6,x                        ;81A25B|DEC625  |7E25C6;  
	bmi func_81A274                      ;81A25E|3014    |C1A274;  
	bra func_81A2AA                      ;81A260|8048    |C1A2AA;  
...
func_81A2AA:
	dex                                  ;81A2AA|CA      |      ;  
	dex                                  ;81A2AB|CA      |      ;  
	bmi func_81A2B1                      ;81A2AC|3003    |C1A2B1;  
	jmp.w func_81A205                    ;81A2AE|4C05A2  |C1A205;  
...
func_81A2B1:
	...
	beq func_81A300                      ;81A2BA|F044    |C1A300;  
	lda.w $220C                          ;81A2BC|AD0C22  |00220C;  
	cmp.w #$0003                         ;81A2BF|C90300  |      ;  
	beq func_81A300                      ;81A2C2|F03C    |C1A300;  
	phb                                  ;81A2C4|8B      |      ;  
	asl a                                ;81A2C5|0A      |      ;  
	tax                                  ;81A2C6|AA      |      ;  
...
func_81A300:
	...
	sta.b $77                            ;81A303|8577    |000077;  
	lda.w $2E2C                          ;81A305|AD2C2E  |7E2E2C;  
	bpl func_81A36D                      ;81A308|1063    |C1A36D;  
...
func_81A378:
	...
	bcc func_81A378                      ;81A385|90F1    |C1A378;  

func_81A387:
	jmp.w func_81A3CA                    ;81A387|4CCAA3  |C1A3CA;  
	phb                                  ;81A38A|8B      |      ;  
	jsl.l func_819F98                    ;81A38B|22989F81|819F98;  
	plb                                  ;81A38F|AB      |      ;  
	jsr.w func_81A3D1                    ;81A390|20D1A3  |C1A3D1;  
	bcc func_81A3CA                      ;81A393|9035    |C1A3CA;  
	bra func_81A3C3                      ;81A395|802C    |C1A3C3;  

func_81A397:
	lda.w $2208                          ;81A397|AD0822  |7E2208;  
	bne func_81A3B1                      ;81A39A|D015    |C1A3B1;  
...
func_81A3DA:
	...
	sta.b $68                            ;81A3DD|8568    |000068;  
	lda.w $2E06,y                        ;81A3DF|B9062E  |7E2E06;  
	bpl func_81A403                      ;81A3E2|101F    |C1A403;  
	...
	beq func_81A3F9                      ;81A3F4|F003    |C1A3F9;  
	db $4C,$20,$A5                       ;81A3F6|        |C1A520;  

func_81A3F9:
	jsr.w func_81A4A3                    ;81A3F9|20A3A4  |C1A4A3;  
	bcc func_81A403                      ;81A3FC|9005    |C1A403;  
	jsr.w func_81A505                    ;81A3FE|2005A5  |C1A505;  
	stz.b $68                            ;81A401|6468    |000068;  

func_81A403:
	cpy.w #$0024                         ;81A403|C02400  |      ;  
	bcs func_81A432                      ;81A406|B02A    |C1A432;  
	lda.w $2E08,y                        ;81A408|B9082E  |7E2E08;  
	bpl func_81A432                      ;81A40B|1025    |C1A432;  
	...
	bcc func_81A431                      ;81A41A|9015    |C1A431;  
	jsr.w func_81A505                    ;81A41C|2005A5  |C1A505;  
	ply                                  ;81A41F|7A      |      ;  
	lda.b $68                            ;81A420|A568    |000068;  
	beq func_81A43B                      ;81A422|F017    |C1A43B;  
	ldx.w #$CC83                         ;81A424|A283CC  |      ;  
	lda.w $3446,y                        ;81A427|B94634  |7E3446;  
	sta.b rUnkPtrLo_02                   ;81A42A|8502    |000002;  
	lda.w $346E,y                        ;81A42C|B96E34  |7E346E;  
	bra func_81A446                      ;81A42F|8015    |C1A446;  

func_81A431:
	ply                                  ;81A431|7A      |      ;  

func_81A432:
	lda.b $68                            ;81A432|A568    |000068;  
	bne func_81A461                      ;81A434|D02B    |C1A461;  
	ldx.w #$CC83                         ;81A436|A283CC  |      ;  
	bra func_81A43E                      ;81A439|8003    |C1A43E;  
...
func_81A43E:
	...
	sta.b rUnkPtrLo_02                   ;81A441|8502    |000002;  
	lda.w $346C,y                        ;81A443|B96C34  |7E346C;  

func_81A446:
	cpy.w $2212                          ;81A446|CC1222  |7E2212;  
	bcc func_81A45D                      ;81A449|9012    |C1A45D;  
	sta.b rUnkPtrHi_02                   ;81A44B|8504    |000004;  
	phb                                  ;81A44D|8B      |      ;  
	phk                                  ;81A44E|4B      |      ;  
	plb                                  ;81A44F|AB      |      ;  
	stx.b $00                            ;81A450|8600    |000000;  
	phy                                  ;81A452|5A      |      ;  
...
func_81A45D:
	dec.b $77                            ;81A45D|C677    |000077;  
	bmi func_81A472                      ;81A45F|3011    |C1A472;  

func_81A461:
	cpy.w #$0022                         ;81A461|C02200  |      ;  
	bcs func_81A480                      ;81A464|B01A    |C1A480;  
	iny                                  ;81A466|C8      |      ;  
	iny                                  ;81A467|C8      |      ;  
	iny                                  ;81A468|C8      |      ;  
	iny                                  ;81A469|C8      |      ;  
	cpy.w $227A                          ;81A46A|CC7A22  |7E227A;  
	beq func_81A49B                      ;81A46D|F02C    |C1A49B;  
	jmp.w func_81A3DA                    ;81A46F|4CDAA3  |C1A3DA;  

func_81A472:
	cpy.w #$0022                         ;81A472|C02200  |      ;  
	bcs func_81A480                      ;81A475|B009    |C1A480;  
	iny                                  ;81A477|C8      |      ;  
	iny                                  ;81A478|C8      |      ;  
	iny                                  ;81A479|C8      |      ;  
	iny                                  ;81A47A|C8      |      ;  
...
func_81A480:
	...
	beq func_81A48B                      ;81A483|F006    |C1A48B;  
...
func_81A4A3:
	sta.b rUnkPtrLo_02                   ;81A4A3|8502    |000002;  
	lda.w $2E06,y                        ;81A4A5|B9062E  |7E2E06;  
	and.w #$2000                         ;81A4A8|290020  |      ;  
	beq func_81A4AE                      ;81A4AB|F001    |C1A4AE;  
	asl a                                ;81A4AD|0A      |      ;  

func_81A4AE:
	eor.b rUnkPtrLo_02                   ;81A4AE|4502    |000002;  
	...
	stz.b $03                            ;81A4C1|6403    |000003;  
	lda.l DATA8_C00000,x                 ;81A4C3|BF0000C0|C00000;  
	sta.b $00                            ;81A4C7|8500    |000000;  
	cmp.w $2FBE,y                        ;81A4C9|D9BE2F  |7E2FBE;  
	sta.w $2FBE,y                        ;81A4CC|99BE2F  |7E2FBE;  
	bne func_81A4D8                      ;81A4CF|D007    |C1A4D8;  
	lda.b rUnkPtrLo_02                   ;81A4D1|A502    |000002;  
	cmp.w $2F66,y                        ;81A4D3|D9662F  |7E2F66;  
	beq func_81A4EE                      ;81A4D6|F016    |C1A4EE;  

func_81A4D8:
	lda.b rUnkPtrLo_02                   ;81A4D8|A502    |000002;  
	sta.w $2F66,y                        ;81A4DA|99662F  |7E2F66;  
	lda.w $23B6,y                        ;81A4DD|B9B623  |7E23B6;  
	bne func_81A4E5                      ;81A4E0|D003    |C1A4E5;  
	pla                                  ;81A4E2|68      |      ;  
	sec                                  ;81A4E3|38      |      ;  
	rts                                  ;81A4E4|60      |      ;  
...
func_81A4EE:
	...
	bne func_81A4F9                      ;81A4F1|D006    |C1A4F9;  
	pla                                  ;81A4F3|68      |      ;  
...
func_81A505:
	...
	sta.b rUnkPtrHi_02                   ;81A50B|8504    |000004;  
	phy                                  ;81A50D|5A      |      ;  
	phb                                  ;81A50E|8B      |      ;  
	jsl.l func_81C913                    ;81A50F|2213C981|81C913;  
	plb                                  ;81A513|AB      |      ;  
	ply                                  ;81A514|7A      |      ;  
	lda.b $00                            ;81A515|A500    |000000;  
	sta.w $2E5E,y                        ;81A517|995E2E  |7E2E5E;  
	lda.b rUnkPtrLo_02                   ;81A51A|A502    |000002;  
...
func_81A63B:
	...
	dex                                  ;81A64E|CA      |      ;  
	dex                                  ;81A64F|CA      |      ;  
	bpl func_81A63B                      ;81A650|10E9    |C1A63B;  
...
func_81A655:
	...
	dex                                  ;81A658|CA      |      ;  
	dex                                  ;81A659|CA      |      ;  
	bpl func_81A655                      ;81A65A|10F9    |C1A655;  
	plp                                  ;81A65C|28      |      ;  
	rtl                                  ;81A65D|6B      |      ;  
...
func_81A67F:
	...
	dex                                  ;81A682|CA      |      ;  
	dex                                  ;81A683|CA      |      ;  
	bpl func_81A67F                      ;81A684|10F9    |C1A67F;  
...
func_81A689:
	...
	dex                                  ;81A68C|CA      |      ;  
	dex                                  ;81A68D|CA      |      ;  
	bpl func_81A689                      ;81A68E|10F9    |C1A689;  
	lda.b rUnkPtrLo_02                   ;81A690|A502    |000002;  
	sta.w $228A                          ;81A692|8D8A22  |7E228A;  
	sec                                  ;81A695|38      |      ;  
	sbc.w #$0080                         ;81A696|E98000  |      ;  
	sta.b $66                            ;81A699|8566    |000066;  
	clc                                  ;81A69B|18      |      ;  
	adc.w #$0101                         ;81A69C|690101  |      ;  
	sta.b $68                            ;81A69F|8568    |000068;  
	lda.b $00                            ;81A6A1|A500    |000000;  
	sta.w $2288                          ;81A6A3|8D8822  |7E2288;  
	sec                                  ;81A6A6|38      |      ;  
	sbc.w #$00A0                         ;81A6A7|E9A000  |      ;  
	sta.b $62                            ;81A6AA|8562    |000062;  
	clc                                  ;81A6AC|18      |      ;  
	adc.w #$0141                         ;81A6AD|694101  |      ;  
	sta.b $64                            ;81A6B0|8564    |000064;  
	ldx.w #$0050                         ;81A6B2|A25000  |      ;  

func_81A6B5:
	stz.w $235E,x                        ;81A6B5|9E5E23  |7E235E;  
	lda.w $22AE,x                        ;81A6B8|BDAE22  |7E22AE;  
	beq func_81A6FA                      ;81A6BB|F03D    |C1A6FA;  
	lda.w $2466,x                        ;81A6BD|BD6624  |7E2466;  
	bmi func_81A6E7                      ;81A6C0|3025    |C1A6E7;  
	cpx.w #$0028                         ;81A6C2|E02800  |      ;  
	bcs func_81A6FA                      ;81A6C5|B033    |C1A6FA;  
	lda.w $2936,x                        ;81A6C7|BD3629  |7E2936;  
	clc                                  ;81A6CA|18      |      ;  
	adc.w $2B46,x                        ;81A6CB|7D462B  |7E2B46;  
	cmp.b $62                            ;81A6CE|C562    |000062;  
	bmi func_81A6FA                      ;81A6D0|3028    |C1A6FA;  
	cmp.b $64                            ;81A6D2|C564    |000064;  
	bpl func_81A6FA                      ;81A6D4|1024    |C1A6FA;  
	lda.w $298E,x                        ;81A6D6|BD8E29  |7E298E;  
	clc                                  ;81A6D9|18      |      ;  
	adc.w $2B9E,x                        ;81A6DA|7D9E2B  |7E2B9E;  
	cmp.b $66                            ;81A6DD|C566    |000066;  
	bmi func_81A6FA                      ;81A6DF|3019    |C1A6FA;  
	cmp.b $68                            ;81A6E1|C568    |000068;  
	bpl func_81A6FA                      ;81A6E3|1015    |C1A6FA;  
	bra func_81A6F4                      ;81A6E5|800D    |C1A6F4;  

func_81A6E7:
	inc.w $2278                          ;81A6E7|EE7822  |7E2278;  
	dec.w $25C6,x                        ;81A6EA|DEC625  |7E25C6;  
	bpl func_81A6F4                      ;81A6ED|1005    |C1A6F4;  
	txy                                  ;81A6EF|9B      |      ;  
...
func_81A6FA:
	dex                                  ;81A6FA|CA      |      ;  
	dex                                  ;81A6FB|CA      |      ;  
	bpl func_81A6B5                      ;81A6FC|10B7    |C1A6B5;  
	phb                                  ;81A6FE|8B      |      ;  
	jsl.l func_819F5F                    ;81A6FF|225F9F81|819F5F;  
	plb                                  ;81A703|AB      |      ;  
	lda.w $2274                          ;81A704|AD7422  |7E2274;  
	bpl func_81A74A                      ;81A707|1041    |C1A74A;  
	asl a                                ;81A709|0A      |      ;  
	bmi UNREACH_C1A730                   ;81A70A|3024    |C1A730;  
	sta.b $00                            ;81A70C|8500    |000000;  
	...
	asl a                                ;81A714|0A      |      ;  
	sec                                  ;81A715|38      |      ;  
	sbc.b $00                            ;81A716|E500    |000000;  
	clc                                  ;81A718|18      |      ;  
	adc.w #$C66D                         ;81A719|696DC6  |      ;  
	sta.b rUnkPtrLo_02                   ;81A71C|8502    |000002;  
	lda.w #$00FB                         ;81A71E|A9FB00  |      ;  
	sta.b rUnkPtrHi_02                   ;81A721|8504    |000004;  
	lda.w #$0801                         ;81A723|A90108  |      ;  
	sta.b $00                            ;81A726|8500    |000000;  
	phb                                  ;81A728|8B      |      ;  
	jsl.l func_80886F                    ;81A729|226F8880|80886F;  
	plb                                  ;81A72D|AB      |      ;  
	bra func_81A746                      ;81A72E|8016    |C1A746;  
...
func_81A74A:
	...
	sta.b $77                            ;81A74D|8577    |000077;  
	lda.w $2E2C                          ;81A74F|AD2C2E  |7E2E2C;  
	bpl func_81A787                      ;81A752|1033    |C1A787;  
	asl a                                ;81A754|0A      |      ;  
	bpl func_81A75C                      ;81A755|1005    |C1A75C;  
...
func_81A75C:
	...
	bcc func_81A781                      ;81A76F|9010    |C1A781;  
	jsr.w func_81A505                    ;81A771|2005A5  |C1A505;  
	dec.b $77                            ;81A774|C677    |000077;  
	lda.w #$CC91                         ;81A776|A991CC  |      ;  
	sta.b $00                            ;81A779|8500    |000000;  
	phb                                  ;81A77B|8B      |      ;  
...
func_81A787:
	phb                                  ;81A787|8B      |      ;  
	jsl.l CODE_C5D0BB                    ;81A788|22BBD0C5|C5D0BB;  
	plb                                  ;81A78C|AB      |      ;  
	bcc func_81A792                      ;81A78D|9003    |C1A792;  
	inc.w $2278                          ;81A78F|EE7822  |7E2278;  

func_81A792:
	lda.b $00                            ;81A792|A500    |000000;  
	beq func_81A798                      ;81A794|F002    |C1A798;  
...
func_81A82F:
	...
	bcc func_81A849                      ;81A83B|900C    |C1A849;  
	ldx.b $68                            ;81A83D|A668    |000068;  
	beq func_81A844                      ;81A83F|F003    |C1A844;  
	jsr.w func_81A93C                    ;81A841|203CA9  |C1A93C;  

func_81A844:
	jsr.w func_81A505                    ;81A844|2005A5  |C1A505;  
	bra func_81A84F                      ;81A847|8006    |C1A84F;  

func_81A849:
	ply                                  ;81A849|7A      |      ;  

func_81A84A:
	lda.b $68                            ;81A84A|A568    |000068;  
	bne func_81A874                      ;81A84C|D026    |C1A874;  
...
func_81A84F:
	...
	sta.b $00                            ;81A852|8500    |000000;  
	plx                                  ;81A854|FA      |      ;  
	phx                                  ;81A855|DA      |      ;  
	cpx.w $2212                          ;81A856|EC1222  |7E2212;  
	bcc func_81A873                      ;81A859|9018    |C1A873;  
	lda.l $7E3444,x                      ;81A85B|BF44347E|7E3444;  
	sta.b rUnkPtrLo_02                   ;81A85F|8502    |000002;  
	lda.l $7E346C,x                      ;81A861|BF6C347E|7E346C;  
	sta.b rUnkPtrHi_02                   ;81A865|8504    |000004;  
	phb                                  ;81A867|8B      |      ;  
	phk                                  ;81A868|4B      |      ;  
	plb                                  ;81A869|AB      |      ;  
...
func_81A874:
	...
	bcs func_81A880                      ;81A877|B007    |C1A880;  
	iny                                  ;81A879|C8      |      ;  
	iny                                  ;81A87A|C8      |      ;  
	iny                                  ;81A87B|C8      |      ;  
	iny                                  ;81A87C|C8      |      ;  
...
func_81A8BD:
	...
	sta.b $64                            ;81A8C3|8564    |000064;  
	lda.w #$6DBC                         ;81A8C5|A9BC6D  |      ;  
	sta.b $62                            ;81A8C8|8562    |000062;  
	jsr.w func_81A9B8                    ;81A8CA|20B8A9  |C1A9B8;  
	lda.b $68                            ;81A8CD|A568    |000068;  
	bne func_81A8DC                      ;81A8CF|D00B    |C1A8DC;  
...
func_81A8DC:
	...
	sta.b $64                            ;81A8E2|8564    |000064;  
	lda.w #$70BC                         ;81A8E4|A9BC70  |      ;  
	sta.b $62                            ;81A8E7|8562    |000062;  
	jsr.w func_81A9B8                    ;81A8E9|20B8A9  |C1A9B8;  
	lda.b $68                            ;81A8EC|A568    |000068;  
	bne func_81A8FB                      ;81A8EE|D00B    |C1A8FB;  
	lda.w #$CCB1                         ;81A8F0|A9B1CC  |      ;  
	sta.b $00                            ;81A8F3|8500    |000000;  
	phb                                  ;81A8F5|8B      |      ;  
...
func_81A8FB:
	...
	bcc func_81A911                      ;81A907|9008    |C1A911;  
	db $22,$4A,$85,$80,$22,$23,$BE,$80   ;81A909|        |80854A;  

func_81A911:
	lda.l $7E227C                        ;81A911|AF7C227E|7E227C;  
	cmp.w #$8000                         ;81A915|C90080  |      ;  
	beq func_81A920                      ;81A918|F006    |C1A920;  
	sta.b $00                            ;81A91A|8500    |000000;  
	jsl.l func_818049                    ;81A91C|22498081|818049;  

func_81A920:
	lda.l $7E227E                        ;81A920|AF7E227E|7E227E;  
	bmi func_81A934                      ;81A924|300E    |C1A934;  
	bne func_81A92E                      ;81A926|D006    |C1A92E;  
	db $22,$5D,$D0,$C5,$80,$06           ;81A928|        |C5D05D;  

func_81A92E:
	sta.b $00                            ;81A92E|8500    |000000;  
	jsl.l CODE_C5D082                    ;81A930|2282D0C5|C5D082;  

func_81A934:
	lda.l $7E2278                        ;81A934|AF78227E|7E2278;  
	sta.b $00                            ;81A938|8500    |000000;  
	plp                                  ;81A93A|28      |      ;  
	rtl                                  ;81A93B|6B      |      ;  

func_81A93C:
	dec.b $77                            ;81A93C|C677    |000077;  
	bpl func_81A961                      ;81A93E|1021    |C1A961;  
	pha                                  ;81A940|48      |      ;  
	lda.b $00                            ;81A941|A500    |000000;  
	pha                                  ;81A943|48      |      ;  
	lda.b rUnkPtrLo_02                   ;81A944|A502    |000002;  
	pha                                  ;81A946|48      |      ;  
	phx                                  ;81A947|DA      |      ;  
	phy                                  ;81A948|5A      |      ;  
	phb                                  ;81A949|8B      |      ;  
	...
	plx                                  ;81A950|FA      |      ;  
	pla                                  ;81A951|68      |      ;  
	sta.b rUnkPtrLo_02                   ;81A952|8502    |000002;  
	pla                                  ;81A954|68      |      ;  
	sta.b $00                            ;81A955|8500    |000000;  
	jsl.l func_80854A                    ;81A957|224A8580|80854A;  
	lda.w #$0002                         ;81A95B|A90200  |      ;  
	sta.b $77                            ;81A95E|8577    |000077;  
	pla                                  ;81A960|68      |      ;  

func_81A961:
	rts                                  ;81A961|60      |      ;  
	sta.b $00                            ;81A962|8500    |000000;  
	asl a                                ;81A964|0A      |      ;  
	adc.b $00                            ;81A965|6500    |000000;  
	tax                                  ;81A967|AA      |      ;  
	lda.l DATA8_FBC257,x                 ;81A968|BF57C2FB|FBC257;  
	sta.b $00                            ;81A96C|8500    |000000;  
	lda.l DATA8_FBC259,x                 ;81A96E|BF59C2FB|FBC259;  
	sta.b rUnkPtrLo_02                   ;81A972|8502    |000002;  
	tyx                                  ;81A974|BB      |      ;  
	lda.l DATA8_81BEAD,x                 ;81A975|BFADBE81|81BEAD;  
	sta.b rUnkPtrHi_02                   ;81A979|8504    |000004;  
...
func_81A9BD:
	...
	sta.b rUnkPtrLo_02                   ;81A9D3|8502    |000002;  
	lda.l DATA8_FBC11E,x                 ;81A9D5|BF1EC1FB|FBC11E;  
	cmp.w $2FBE,y                        ;81A9D9|D9BE2F  |7E2FBE;  
	beq func_81AA04                      ;81A9DC|F026    |C1AA04;  
	sta.w $2FBE,y                        ;81A9DE|99BE2F  |7E2FBE;  
	lda.b $68                            ;81A9E1|A568    |000068;  
	beq func_81A9EA                      ;81A9E3|F005    |C1A9EA;  
	jsr.w func_81A93C                    ;81A9E5|203CA9  |C1A93C;  
	stz.b $68                            ;81A9E8|6468    |000068;  

func_81A9EA:
	phy                                  ;81A9EA|5A      |      ;  
	ldx.w $2FBE,y                        ;81A9EB|BEBE2F  |7E2FBE;  
	lda.b $62                            ;81A9EE|A562    |000062;  
	tay                                  ;81A9F0|A8      |      ;  
	clc                                  ;81A9F1|18      |      ;  
	adc.w #$0200                         ;81A9F2|690002  |      ;  
	pha                                  ;81A9F5|48      |      ;  
	lda.w #$003F                         ;81A9F6|A93F00  |      ;  
	mvn $7E,$FB                          ;81A9F9|547EFB  |      ;  
	ply                                  ;81A9FC|7A      |      ;  
	lda.w #$003F                         ;81A9FD|A93F00  |      ;  
	mvn $7E,$FB                          ;81AA00|547EFB  |      ;  
	ply                                  ;81AA03|7A      |      ;  

func_81AA04:
	lda.w $22AE,y                        ;81AA04|B9AE22  |7E22AE;  
	sta.w $2306,y                        ;81AA07|990623  |7E2306;  
	lda.b rUnkPtrLo_02                   ;81AA0A|A502    |000002;  
	and.w #$FE00                         ;81AA0C|2900FE  |      ;  
	ora.b $64                            ;81AA0F|0564    |000064;  
	sta.w $2EB6,y                        ;81AA11|99B62E  |7E2EB6;  
	stz.b $03                            ;81AA14|6403    |000003;  
	ldx.b rUnkPtrLo_02                   ;81AA16|A602    |000002;  
	lda.l DATA8_81AA3B,x                 ;81AA18|BF3BAA81|81AA3B;  
	sta.w $2E5E,y                        ;81AA1C|995E2E  |7E2E5E;  

func_81AA1F:
	lda.b $62                            ;81AA1F|A562    |000062;  
	clc                                  ;81AA21|18      |      ;  
	adc.w #$0040                         ;81AA22|694000  |      ;  
	sta.b $62                            ;81AA25|8562    |000062;  
	inc.b $64                            ;81AA27|E664    |000064;  
	inc.b $64                            ;81AA29|E664    |000064;  
	iny                                  ;81AA2B|C8      |      ;  
	iny                                  ;81AA2C|C8      |      ;  
	cpy.w #$0040                         ;81AA2D|C04000  |      ;  
	beq func_81AA3A                      ;81AA30|F008    |C1AA3A;  
	cpy.w #$0030                         ;81AA32|C03000  |      ;  
	beq func_81AA3A                      ;81AA35|F003    |C1AA3A;  
...
func_81AAA0:
	...
	sta.b $00                            ;81AAAF|8500    |000000;  
	lda.w $277E,y                        ;81AAB1|B97E27  |7E277E;  
	sta.b $06                            ;81AAB4|8506    |000006;  
	inc a                                ;81AAB6|1A      |      ;  
...
Data_81AABD:
	...
	lda.b $06                            ;81AAC5|A506    |000006;  
	and.w #$0007                         ;81AAC7|290700  |      ;  
	tax                                  ;81AACA|AA      |      ;  
	lda.l DATA8_81AB18,x                 ;81AACB|BF18AB81|81AB18;  
	sta.b rUnkPtrLo_02                   ;81AACF|8502    |000002;  
	sta.b $03                            ;81AAD1|8503    |000003;  
	lda.l DATA8_81AB10,x                 ;81AAD3|BF10AB81|81AB10;  
	and.w #$00FF                         ;81AAD7|29FF00  |      ;  
	sta.b rUnkPtrHi_02                   ;81AADA|8504    |000004;  
	ldx.b $00                            ;81AADC|A600    |000000;  
	jsr.w func_81ACF2                    ;81AADE|20F2AC  |C1ACF2;  
	ldx.b $00                            ;81AAE1|A600    |000000;  
	ldy.w #$0000                         ;81AAE3|A00000  |      ;  
	lda.w #$0008                         ;81AAE6|A90800  |      ;  
	sta.b $66                            ;81AAE9|8566    |000066;  
	lda.b $06                            ;81AAEB|A506    |000006;  
	cmp.w #$0008                         ;81AAED|C90800  |      ;  
	bcs func_81AAFB                      ;81AAF0|B009    |C1AAFB;  

func_81AAF2:
	jsr.w func_81AB20                    ;81AAF2|2020AB  |C1AB20;  
	dec.b $66                            ;81AAF5|C666    |000066;  
	bne func_81AAF2                      ;81AAF7|D0F9    |C1AAF2;  
	ply                                  ;81AAF9|7A      |      ;  
	rts                                  ;81AAFA|60      |      ;  

func_81AAFB:
	jsr.w func_81ABB3                    ;81AAFB|20B3AB  |C1ABB3;  
	dec.b $66                            ;81AAFE|C666    |000066;  
	bne func_81AAFB                      ;81AB00|D0F9    |C1AAFB;  
	ply                                  ;81AB02|7A      |      ;  
	lda.w $277E,y                        ;81AB03|B97E27  |7E277E;  
	cmp.w #$0010                         ;81AB06|C91000  |      ;  
	bcc func_81AB0F                      ;81AB09|9004    |C1AB0F;  
	tyx                                  ;81AB0B|BB      |      ;  
...
func_81AB25:
	...
	and.b rUnkPtrLo_02                   ;81AB2B|2502    |000002;  
	...
	lda.b $00                            ;81AB3B|A500    |000000;  
	and.w $0001,x                        ;81AB3D|3D0100  |7E0001;  
	sta.w $0001,x                        ;81AB40|9D0100  |7E0001;  
	rep #$20                             ;81AB43|C220    |      ;  
	lda.b $00                            ;81AB45|A500    |000000;  
	and.w $0010,x                        ;81AB47|3D1000  |7E0010;  
	sta.w $0010,x                        ;81AB4A|9D1000  |7E0010;  
	sep #$20                             ;81AB4D|E220    |      ;  
	lda.w $35CC,y                        ;81AB4F|B9CC35  |7E35CC;  
	and.b rUnkPtrLo_02                   ;81AB52|2502    |000002;  
	...
	pla                                  ;81AB78|68      |      ;  
	dec a                                ;81AB79|3A      |      ;  
	bne func_81AB25                      ;81AB7A|D0A9    |C1AB25;  
	lda.b $03,s                          ;81AB7C|A303    |000003;  
	clc                                  ;81AB7E|18      |      ;  
	adc.b rUnkPtrHi_02                   ;81AB7F|6504    |000004;  
	tax                                  ;81AB81|AA      |      ;  
	tdc                                  ;81AB82|7B      |      ;  
	lda.b $01,s                          ;81AB83|A301    |000001;  
	clc                                  ;81AB85|18      |      ;  
	adc.b rUnkPtrHi_02                   ;81AB86|6504    |000004;  
	tay                                  ;81AB88|A8      |      ;  
	tdc                                  ;81AB89|7B      |      ;  
	sep #$20                             ;81AB8A|E220    |      ;  
	lda.w $35BC,y                        ;81AB8C|B9BC35  |7E35BC;  
	sta.w $0000,x                        ;81AB8F|9D0000  |7E0000;  
	lda.w $35CC,y                        ;81AB92|B9CC35  |7E35CC;  
	sta.w $0200,x                        ;81AB95|9D0002  |7E0200;  
	stz.w $0001,x                        ;81AB98|9E0100  |7E0001;  
	stz.w $0201,x                        ;81AB9B|9E0102  |7E0201;  
	rep #$20                             ;81AB9E|C220    |      ;  
	stz.w $0010,x                        ;81ABA0|9E1000  |7E0010;  
...
func_81ABB3:
	...
	sta.b $00                            ;81ABB7|8500    |000000;  
	lda.b rUnkPtrLo_02                   ;81ABB9|A502    |000002;  
	eor.w #$FFFF                         ;81ABBB|49FFFF  |      ;  
	tay                                  ;81ABBE|A8      |      ;  

func_81ABBF:
	tya                                  ;81ABBF|98      |      ;  
	and.w $0000,x                        ;81ABC0|3D0000  |7E0000;  
	sta.w $0000,x                        ;81ABC3|9D0000  |7E0000;  
	tya                                  ;81ABC6|98      |      ;  
	and.w $0010,x                        ;81ABC7|3D1000  |7E0010;  
	sta.w $0010,x                        ;81ABCA|9D1000  |7E0010;  
	tya                                  ;81ABCD|98      |      ;  
	...
	clc                                  ;81ABE3|18      |      ;  
	adc.b rUnkPtrHi_02                   ;81ABE4|6504    |000004;  
	tax                                  ;81ABE6|AA      |      ;  
	stz.w $0000,x                        ;81ABE7|9E0000  |7E0000;  
	stz.w $0010,x                        ;81ABEA|9E1000  |7E0010;  
...
func_81ACF9:
	xba                                  ;81ACF9|EB      |      ;  
	lda.w $0000,x                        ;81ACFA|BD0000  |7E0000;  
	ora.w $0001,x                        ;81ACFD|1D0100  |7E0001;  
	ora.w $0010,x                        ;81AD00|1D1000  |7E0010;  
	ora.w $0011,x                        ;81AD03|1D1100  |7E0011;  
	...
	xba                                  ;81AD1C|EB      |      ;  
	dec a                                ;81AD1D|3A      |      ;  
	bne func_81ACF9                      ;81AD1E|D0D9    |C1ACF9;  
	rep #$20                             ;81AD20|C220    |      ;  
	txa                                  ;81AD22|8A      |      ;  
	clc                                  ;81AD23|18      |      ;  
	...
	bne func_81ACF5                      ;81AD31|D0C2    |C1ACF5;  
	rts                                  ;81AD33|60      |      ;  
	db $C2,$30                           ;81AD34|        |      ;  

func_81AD36:
	lda.w $2516,y                        ;81AD36|B91625  |7E2516;  
	sta.b $74                            ;81AD39|8574    |000074;  
	...
	sta.b $00                            ;81AD46|8500    |000000;  
	lsr a                                ;81AD48|4A      |      ;  
	lsr a                                ;81AD49|4A      |      ;  
	lsr a                                ;81AD4A|4A      |      ;  
	and.w #$001E                         ;81AD4B|291E00  |      ;  
	tax                                  ;81AD4E|AA      |      ;  
	lda.b $00                            ;81AD4F|A500    |000000;  
...
func_81AE65:
	...
	dex                                  ;81AE68|CA      |      ;  
	dex                                  ;81AE69|CA      |      ;  
	bpl func_81AE65                      ;81AE6A|10F9    |C1AE65;  
	rts                                  ;81AE6C|60      |      ;  
	...
	bne func_81AEBB                      ;81AEB6|D003    |C1AEBB;  
...
func_81AEBB:
	...
	bne func_81AF9F                      ;81AF9A|D003    |C1AF9F;  
...
Data_81AFFB:
	...
	bne func_81B011                      ;81B00A|D005    |C1B011;  
...
func_81B02C:
	...
	bcc func_81B044                      ;81B032|9010    |C1B044;  
...
func_81B087:
	...
	bra func_81B096                      ;81B08A|800A    |C1B096;  
...
func_81B0A9:
	...
	bra func_81B0B8                      ;81B0AC|800A    |C1B0B8;  
...
func_81B0B8:
	...
	sta.b $00                            ;81B0C1|8500    |000000;  
	lda.w $2A96,y                        ;81B0C3|B9962A  |7E2A96;  
	dex                                  ;81B0C6|CA      |      ;  
	bmi func_81B0CF                      ;81B0C7|3006    |C1B0CF;  

func_81B0C9:
	asl a                                ;81B0C9|0A      |      ;  
	asl.b $00                            ;81B0CA|0600    |000000;  
	dex                                  ;81B0CC|CA      |      ;  
	bpl func_81B0C9                      ;81B0CD|10FA    |C1B0C9;  

func_81B0CF:
	clc                                  ;81B0CF|18      |      ;  
	adc.w $2936,y                        ;81B0D0|793629  |7E2936;  
	ldx.w $2A96,y                        ;81B0D3|BE962A  |7E2A96;  
	bmi func_81B0E2                      ;81B0D6|300A    |C1B0E2;  
	cmp.w $29E6,y                        ;81B0D8|D9E629  |7E29E6;  
	bcc func_81B0EA                      ;81B0DB|900D    |C1B0EA;  

func_81B0DD:
	lda.w $29E6,y                        ;81B0DD|B9E629  |7E29E6;  
	bra func_81B0EA                      ;81B0E0|8008    |C1B0EA;  

func_81B0E2:
	tax                                  ;81B0E2|AA      |      ;  
	bmi func_81B0DD                      ;81B0E3|30F8    |C1B0DD;  
	cmp.w $29E6,y                        ;81B0E5|D9E629  |0029E6;  
	bcc func_81B0DD                      ;81B0E8|90F3    |C1B0DD;  

func_81B0EA:
	sta.w $2936,y                        ;81B0EA|993629  |7E2936;  
	lda.b $00                            ;81B0ED|A500    |000000;  
	clc                                  ;81B0EF|18      |      ;  
	adc.w $298E,y                        ;81B0F0|798E29  |7E298E;  
	ldx.w $2AEE,y                        ;81B0F3|BEEE2A  |7E2AEE;  
	bmi func_81B102                      ;81B0F6|300A    |C1B102;  
	cmp.w $2A3E,y                        ;81B0F8|D93E2A  |7E2A3E;  
	bcc func_81B10A                      ;81B0FB|900D    |C1B10A;  

func_81B0FD:
	lda.w $2A3E,y                        ;81B0FD|B93E2A  |7E2A3E;  
	bra func_81B10A                      ;81B100|8008    |C1B10A;  

func_81B102:
	tax                                  ;81B102|AA      |      ;  
	bmi func_81B0FD                      ;81B103|30F8    |C1B0FD;  
	cmp.w $2A3E,y                        ;81B105|D93E2A  |7E2A3E;  
	bcc func_81B0FD                      ;81B108|90F3    |C1B0FD;  
...
UNREACH_81B1AB:
	...
	asl a                                ;81B1DA|0A      |      ;  
	bne func_81B1E4                      ;81B1DB|D007    |C1B1E4;  
...
func_81B1E4:
	...
	bcs func_81B1F9                      ;81B1EF|B008    |C1B1F9;  
...
UNREACH_81B21B:
	...
	lsr a                                ;81B276|4A      |      ;  
	pha                                  ;81B277|48      |      ;  
	bcc func_81B282                      ;81B278|9008    |C1B282;  
	jsr.w func_81BE41                    ;81B27A|2041BE  |C1BE41;  
	ora.w #$FF00                         ;81B27D|0900FF  |      ;  
	bra func_81B285                      ;81B280|8003    |C1B285;  
...
func_81B285:
	...
	pla                                  ;81B288|68      |      ;  
	lsr a                                ;81B289|4A      |      ;  
	bcc func_81B294                      ;81B28A|9008    |C1B294;  
	jsr.w func_81BE41                    ;81B28C|2041BE  |C1BE41;  
	ora.w #$FF00                         ;81B28F|0900FF  |      ;  
	bra func_81B297                      ;81B292|8003    |C1B297;  
...
func_81B297:
	...
	bra func_81B2AB                      ;81B2A6|8003    |C1B2AB;  
...
func_81B2AB:
	...
	asl a                                ;81B2C8|0A      |      ;  
	adc.b $74                            ;81B2C9|6574    |000074;  
	sta.b $74                            ;81B2CB|8574    |000074;  
	...
	bmi func_81B369                      ;81B362|3005    |C1B369;  
	lda.w $2676,y                        ;81B364|B97626  |7E2676;  
	sta.b $74                            ;81B367|8574    |000074;  
...
func_81B369:
	...
	jsl.l CODE_C0680C                    ;81B463|220C68C0|C0680C;  
	inc.w $2278                          ;81B467|EE7822  |7E2278;  
	rts                                  ;81B46A|60      |      ;  
	jsl.l CODE_C067FE                    ;81B46B|22FE67C0|C067FE;  
	rts                                  ;81B46F|60      |      ;  
	phy                                  ;81B470|5A      |      ;  
	phb                                  ;81B471|8B      |      ;  
	jsl.l CODE_C0681A                    ;81B472|221A68C0|C0681A;  
	plb                                  ;81B476|AB      |      ;  
	ply                                  ;81B477|7A      |      ;  
...
func_81B4AA:
	...
	lsr a                                ;81B4B0|4A      |      ;  
	lsr a                                ;81B4B1|4A      |      ;  
	sta.b rUnkPtrHi_02                   ;81B4B2|8504    |000004;  
	...
	lsr a                                ;81B4BA|4A      |      ;  
	lsr a                                ;81B4BB|4A      |      ;  
	sta.b $05                            ;81B4BC|8505    |000005;  
	lda.b rUnkPtrHi_02                   ;81B4BE|A504    |000004;  
	sta.b $06                            ;81B4C0|8506    |000006;  
	rts                                  ;81B4C2|60      |      ;  
...
func_81B568:
	...
	bne func_81B57F                      ;81B573|D00A    |C1B57F;  
	lda.w $298E,y                        ;81B575|B98E29  |7E298E;  
	cmp.w $2A3E,y                        ;81B578|D93E2A  |7E2A3E;  
	bne func_81B57F                      ;81B57B|D002    |C1B57F;  
	stx.b $74                            ;81B57D|8674    |000074;  
...
func_81B57F:
	...
	sta.b $00                            ;81B587|8500    |000000;  
	clc                                  ;81B589|18      |      ;  
	adc.w #$0101                         ;81B58A|690101  |      ;  
	sta.b rUnkPtrLo_02                   ;81B58D|8502    |000002;  
	lda.w $228A                          ;81B58F|AD8A22  |7E228A;  
	sec                                  ;81B592|38      |      ;  
	sbc.w #$0060                         ;81B593|E96000  |      ;  
	sta.b rUnkPtrHi_02                   ;81B596|8504    |000004;  
	clc                                  ;81B598|18      |      ;  
	adc.w #$00C1                         ;81B599|69C100  |      ;  
	sta.b $06                            ;81B59C|8506    |000006;  
...
func_81B59E:
	...
	cmp.b $00                            ;81B5A9|C500    |000000;  
	bmi func_81B5C0                      ;81B5AB|3013    |C1B5C0;  
	cmp.b rUnkPtrLo_02                   ;81B5AD|C502    |000002;  
	bpl func_81B5C0                      ;81B5AF|100F    |C1B5C0;  
	lda.w $298E,y                        ;81B5B1|B98E29  |7E298E;  
	clc                                  ;81B5B4|18      |      ;  
	adc.w $2B9E,y                        ;81B5B5|799E2B  |7E2B9E;  
	cmp.b rUnkPtrHi_02                   ;81B5B8|C504    |000004;  
	bmi func_81B5C0                      ;81B5BA|3004    |C1B5C0;  
	cmp.b $06                            ;81B5BC|C506    |000006;  
	bmi func_81B5C4                      ;81B5BE|3004    |C1B5C4;  

func_81B5C0:
	stx.b $74                            ;81B5C0|8674    |000074;  
	sec                                  ;81B5C2|38      |      ;  
	rts                                  ;81B5C3|60      |      ;  
...
func_81B5C4:
	...
	sta.b $00                            ;81B5CD|8500    |000000;  
	clc                                  ;81B5CF|18      |      ;  
	adc.w #$0181                         ;81B5D0|698101  |      ;  
	sta.b rUnkPtrLo_02                   ;81B5D3|8502    |000002;  
	lda.w $228A                          ;81B5D5|AD8A22  |7E228A;  
	sec                                  ;81B5D8|38      |      ;  
	sbc.w #$00A0                         ;81B5D9|E9A000  |      ;  
	sta.b rUnkPtrHi_02                   ;81B5DC|8504    |000004;  
	clc                                  ;81B5DE|18      |      ;  
	adc.w #$0141                         ;81B5DF|694101  |      ;  
	sta.b $06                            ;81B5E2|8506    |000006;  
	bra func_81B59E                      ;81B5E4|80B8    |C1B59E;  
	...
	bne func_81B646                      ;81B642|D002    |C1B646;  
	sta.b $74                            ;81B644|8574    |000074;  
...
func_81B646:
	...
	beq func_81B65A                      ;81B656|F002    |C1B65A;  
...
func_81B65A:
	...
	bne func_81B66D                      ;81B667|D004    |C1B66D;  

func_81B669:
	pla                                  ;81B669|68      |      ;  
	sta.b $74                            ;81B66A|8574    |000074;  
	rts                                  ;81B66C|60      |      ;  
...
func_81B66D:
	...
	bne func_81B669                      ;81B67B|D0EC    |C1B669;  
	pla                                  ;81B67D|68      |      ;  
	rts                                  ;81B67E|60      |      ;  
...
func_81B686:
	...
	dex                                  ;81B689|CA      |      ;  
	bpl func_81B686                      ;81B68A|10FA    |C1B686;  
	sta.b $74                            ;81B68C|8574    |000074;  
	rts                                  ;81B68E|60      |      ;  
	jsr.w func_81BE41                    ;81B68F|2041BE  |C1BE41;  
	bit.w #$0080                         ;81B692|898000  |      ;  
	beq UNREACH_C1B6C4                   ;81B695|F02D    |C1B6C4;  
	bit.w #$0040                         ;81B697|894000  |      ;  
	beq func_81B6AF                      ;81B69A|F013    |C1B6AF;  
...
func_81B6AF:
	...
	bra func_81B6ED                      ;81B6C2|8029    |C1B6ED;  
...
func_81B6ED:
	sta.b $74                            ;81B6ED|8574    |000074;  
	rts                                  ;81B6EF|60      |      ;  
	jsr.w func_81BE49                    ;81B6F0|2049BE  |C1BE49;  
	sta.b $74                            ;81B6F3|8574    |000074;  
	rts                                  ;81B6F5|60      |      ;  
	jsr.w func_81BE49                    ;81B6F6|2049BE  |C1BE49;  
	ldx.b $74                            ;81B6F9|A674    |000074;  
	sta.b $74                            ;81B6FB|8574    |000074;  
	txa                                  ;81B6FD|8A      |      ;  
...
func_81B729:
	...
	sta.b rUnkPtrLo_02                   ;81B730|8502    |000002;  
	lda.w $2200                          ;81B732|AD0022  |7E2200;  
	bne func_81B73D                      ;81B735|D006    |C1B73D;  
	phy                                  ;81B737|5A      |      ;  
...
func_81B73D:
	...
	sta.b rUnkPtrLo_02                   ;81B758|8502    |000002;  
	lda.w $2200                          ;81B75A|AD0022  |7E2200;  
	bne func_81B767                      ;81B75D|D008    |C1B767;  
	phy                                  ;81B75F|5A      |      ;  
	phb                                  ;81B760|8B      |      ;  
...
func_81B767:
	...
	beq func_81B819                      ;81B811|F006    |C1B819;  
...
func_81B819:
	...
	sta.b $00                            ;81B834|8500    |000000;  
	phy                                  ;81B836|5A      |      ;  
	phb                                  ;81B837|8B      |      ;  
	jsl.l CODE_C06876                    ;81B838|227668C0|C06876;  
	plb                                  ;81B83C|AB      |      ;  
	ply                                  ;81B83D|7A      |      ;  
	rts                                  ;81B83E|60      |      ;  
...
Data_81B851:
	...
	beq func_81B86B                      ;81B863|F006    |C1B86B;  
...
func_81B86B:
	...
	sta.b $00                            ;81B87F|8500    |000000;  
	jsr.w func_81BE41                    ;81B881|2041BE  |C1BE41;  
	asl a                                ;81B884|0A      |      ;  
	asl a                                ;81B885|0A      |      ;  
	adc.b $00                            ;81B886|6500    |000000;  
	bra func_81B893                      ;81B888|8009    |C1B893;  
	pha                                  ;81B88A|48      |      ;  
...
func_81B8C6:
	...
	sta.b $00                            ;81B8EB|8500    |000000;  
	asl a                                ;81B8ED|0A      |      ;  
	adc.b $00                            ;81B8EE|6500    |000000;  
	tax                                  ;81B8F0|AA      |      ;  
	lda.l DATA8_FBC257,x                 ;81B8F1|BF57C2FB|FBC257;  
	sta.b $00                            ;81B8F5|8500    |000000;  
	lda.l DATA8_FBC259,x                 ;81B8F7|BF59C2FB|FBC259;  
	sta.b rUnkPtrLo_02                   ;81B8FB|8502    |000002;  
	lda.w #$38BC                         ;81B8FD|A9BC38  |      ;  
	sta.b rUnkPtrHi_02                   ;81B900|8504    |000004;  
	phb                                  ;81B902|8B      |      ;  
	phy                                  ;81B903|5A      |      ;  
	jsr.w func_81BE49                    ;81B904|2049BE  |C1BE49;  
	pha                                  ;81B907|48      |      ;  
	lda.b $6A                            ;81B908|A56A    |00006A;  
	pha                                  ;81B90A|48      |      ;  
	lda.b $6C                            ;81B90B|A56C    |00006C;  
	pha                                  ;81B90D|48      |      ;  
	lda.b $6E                            ;81B90E|A56E    |00006E;  
	pha                                  ;81B910|48      |      ;  
	lda.b $70                            ;81B911|A570    |000070;  
	pha                                  ;81B913|48      |      ;  
	lda.b $72                            ;81B914|A572    |000072;  
	pha                                  ;81B916|48      |      ;  
	jsl.l func_81CB47                    ;81B917|2247CB81|81CB47;  
	pla                                  ;81B91B|68      |      ;  
	sta.b $72                            ;81B91C|8572    |000072;  
	pla                                  ;81B91E|68      |      ;  
	sta.b $70                            ;81B91F|8570    |000070;  
	pla                                  ;81B921|68      |      ;  
	sta.b $6E                            ;81B922|856E    |00006E;  
	pla                                  ;81B924|68      |      ;  
	sta.b $6C                            ;81B925|856C    |00006C;  
	pla                                  ;81B927|68      |      ;  
	sta.b $6A                            ;81B928|856A    |00006A;  
	phk                                  ;81B92A|4B      |      ;  
	plb                                  ;81B92B|AB      |      ;  
	lda.w #$CD02                         ;81B92C|A902CD  |      ;  
	sta.b $00                            ;81B92F|8500    |000000;  
	lda.w #$38BC                         ;81B931|A9BC38  |      ;  
	sta.b rUnkPtrLo_02                   ;81B934|8502    |000002;  
	pla                                  ;81B936|68      |      ;  
	sta.b rUnkPtrHi_02                   ;81B937|8504    |000004;  
...
func_81B992:
	...
	sta.b $00                            ;81B9AB|8500    |000000;  
	lda.w $277E,y                        ;81B9AD|B97E27  |7E277E;  
	cmp.b $00                            ;81B9B0|C500    |000000;  
	inc a                                ;81B9B2|1A      |      ;  
	bcc func_81B9B6                      ;81B9B3|9001    |C1B9B6;  
	db $7B                               ;81B9B5|        |      ;  
...
func_81B9B6:
	...
	sta.b $00                            ;81B9E0|8500    |000000;  
	lda.w $298E,y                        ;81B9E2|B98E29  |7E298E;  
	clc                                  ;81B9E5|18      |      ;  
	adc.w $2B9E,y                        ;81B9E6|799E2B  |7E2B9E;  
	sta.w $228A                          ;81B9E9|8D8A22  |7E228A;  
	sta.b rUnkPtrLo_02                   ;81B9EC|8502    |000002;  
	jsl.l CODE_C06A93                    ;81B9EE|22936AC0|C06A93;  
	rts                                  ;81B9F2|60      |      ;  
	...
	sta.b $00                            ;81BA20|8500    |000000;  
	lda.w $298E,y                        ;81BA22|B98E29  |7E298E;  
	clc                                  ;81BA25|18      |      ;  
	adc.w $2B9E,y                        ;81BA26|799E2B  |7E2B9E;  
	sta.w $228A                          ;81BA29|8D8A22  |7E228A;  
	sta.b rUnkPtrLo_02                   ;81BA2C|8502    |000002;  
	phy                                  ;81BA2E|5A      |      ;  
	phb                                  ;81BA2F|8B      |      ;  
	jsl.l CODE_C06AC9                    ;81BA30|22C96AC0|C06AC9;  
	plb                                  ;81BA34|AB      |      ;  
	ply                                  ;81BA35|7A      |      ;  
	rts                                  ;81BA36|60      |      ;  
	...
	db $60                               ;81BBA0|        |      ;  
	jsl.l CODE_C06EC9                    ;81BBA1|22C96EC0|C06EC9;  
	rts                                  ;81BBA5|60      |      ;  
	...
	jsl.l CODE_C07D52                    ;81BBC7|22527DC0|C07D52;  
	...
	bne func_81BBFC                      ;81BBDD|D01D    |C1BBFC;  
	jsr.w func_81BE41                    ;81BBDF|2041BE  |C1BE41;  
	cmp.w #$00FF                         ;81BBE2|C9FF00  |      ;  
	bne func_81BBEA                      ;81BBE5|D003    |C1BBEA;  
	db $A9,$00,$80                       ;81BBE7|        |      ;  
...
func_81BBEA:
	...
	bne func_81BBF8                      ;81BBF3|D003    |C1BBF8;  
	db $A9,$00,$80                       ;81BBF5|        |      ;  
...
func_81BBFC:
	...
	bne func_81BC3E                      ;81BC39|D003    |C1BC3E;  
...
func_81BC3E:
	...
	sta.b $00                            ;81BC50|8500    |000000;  
	and.w #$000F                         ;81BC52|290F00  |      ;  
	asl a                                ;81BC55|0A      |      ;  
	tax                                  ;81BC56|AA      |      ;  
	lda.b $00                            ;81BC57|A500    |000000;  
...
func_81BE41:
	...
	inc.b $74                            ;81BE43|E674    |000074;  
	and.w #$00FF                         ;81BE45|29FF00  |      ;  
	rts                                  ;81BE48|60      |      ;  

func_81BE49:
	lda.b [$74]                          ;81BE49|A774    |000074;  
	inc.b $74                            ;81BE4B|E674    |000074;  
	inc.b $74                            ;81BE4D|E674    |000074;  
	rts                                  ;81BE4F|60      |      ;  
...
func_81BE50:
	...
	ora.b $03,s                          ;81BE5E|0303    |000003;  
	bit.w #$0020                         ;81BE60|892000  |      ;  
	bne func_81BE6A                      ;81BE63|D005    |C1BE6A;  
	and.w #$001F                         ;81BE65|291F00  |      ;  
	bra func_81BE6D                      ;81BE68|8003    |C1BE6D;  

func_81BE6A:
	ora.w #$FFC0                         ;81BE6A|09C0FF  |      ;  

func_81BE6D:
	sta.b $03,s                          ;81BE6D|8303    |000003;  
	pla                                  ;81BE6F|68      |      ;  
	bit.w #$0020                         ;81BE70|892000  |      ;  
	bne func_81BE7A                      ;81BE73|D005    |C1BE7A;  
	and.w #$001F                         ;81BE75|291F00  |      ;  
	bra func_81BE7D                      ;81BE78|8003    |C1BE7D;  
...
func_81BE7F:
	...
	beq func_81BE8A                      ;81BE85|F003    |C1BE8A;  
...
func_81BE8A:
	...
	beq func_81BE96                      ;81BE91|F003    |C1BE96;  
...
func_81BF32:
	...
	beq func_81BF53                      ;81BF3C|F015    |C1BF53;  
	bpl func_81BF42                      ;81BF3E|1002    |C1BF42;  
	plp                                  ;81BF40|28      |      ;  
	rtl                                  ;81BF41|6B      |      ;  
...
func_81BF50:
	pha                                  ;81BF50|48      |      ;  
	bra func_81BFBB                      ;81BF51|8068    |C1BFBB;  
...
func_81BF6D:
	...
	beq func_81BFAA                      ;81BF76|F032    |C1BFAA;  
	pha                                  ;81BF78|48      |      ;  
	jsl.l CODE_C627E6                    ;81BF79|22E627C6|C627E6;  
	pla                                  ;81BF7D|68      |      ;  
	ldx.b $00                            ;81BF7E|A600    |000000;  
	cpx.b #$08                           ;81BF80|E008    |      ;  
	beq func_81BFAA                      ;81BF82|F026    |C1BFAA;  
	pha                                  ;81BF84|48      |      ;  
	jsl.l CODE_C627DB                    ;81BF85|22DB27C6|C627DB;  
	pla                                  ;81BF89|68      |      ;  
	ldx.b $00                            ;81BF8A|A600    |000000;  
	cpx.b #$0A                           ;81BF8C|E00A    |      ;  
	bne func_81BF9C                      ;81BF8E|D00C    |C1BF9C;  
	pha                                  ;81BF90|48      |      ;  
	jsl.l CODE_C36BB0                    ;81BF91|22B06BC3|C36BB0;  
	pla                                  ;81BF95|68      |      ;  
	ldx.b $00                            ;81BF96|A600    |000000;  
	cpx.b #$30                           ;81BF98|E030    |      ;  
	beq func_81BFAA                      ;81BF9A|F00E    |C1BFAA;  

func_81BF9C:
	pha                                  ;81BF9C|48      |      ;  
	jsl.l CODE_C62B37                    ;81BF9D|22372BC6|C62B37;  
	pla                                  ;81BFA1|68      |      ;  
	ldx.b $00                            ;81BFA2|A600    |000000;  
	bne func_81BFAA                      ;81BFA4|D004    |C1BFAA;  
	lda.b #$20                           ;81BFA6|A920    |      ;  
	bra func_81BFB9                      ;81BFA8|800F    |C1BFB9;  

func_81BFAA:
	cmp.b #$FF                           ;81BFAA|C9FF    |      ;  
	beq func_81BFB8                      ;81BFAC|F00A    |C1BFB8;  
	sta.b $00                            ;81BFAE|8500    |000000;  
	phb                                  ;81BFB0|8B      |      ;  
...
func_81BFB9:
	sta.b $00                            ;81BFB9|8500    |000000;  

func_81BFBB:
	lda.w $342C                          ;81BFBB|AD2C34  |7E342C;  
	cmp.b #$42                           ;81BFBE|C942    |      ;  
	bcs func_81BFCF                      ;81BFC0|B00D    |C1BFCF;  
	cmp.b #$32                           ;81BFC2|C932    |      ;  
	bcc func_81BFCF                      ;81BFC4|9009    |C1BFCF;  
	sbc.b #$10                           ;81BFC6|E910    |      ;  
	sta.w $342C                          ;81BFC8|8D2C34  |7E342C;  
	lda.b #$11                           ;81BFCB|A911    |      ;  
	bra func_81BFE7                      ;81BFCD|8018    |C1BFE7;  

func_81BFCF:
	lda.b $00                            ;81BFCF|A500    |000000;  
	bne func_81BFE7                      ;81BFD1|D014    |C1BFE7;  
	rep #$20                             ;81BFD3|C220    |      ;  
...
func_81BFE7:
	...
	beq func_81C036                      ;81BFED|F047    |C1C036;  
	cmp.b #$20                           ;81BFEF|C920    |      ;  
	bne func_81C038                      ;81BFF1|D045    |C1C038;  
	lda.b #$FB                           ;81BFF3|A9FB    |      ;  
	sta.b rUnkPtrLo_02                   ;81BFF5|8502    |000002;  
	rep #$20                             ;81BFF7|C220    |      ;  
	...
	sta.b $00                            ;81C01C|8500    |000000;  
	lda.w #$38BC                         ;81C01E|A9BC38  |      ;  
	sta.b rUnkPtrHi_02                   ;81C021|8504    |000004;  
...
func_81C036:
	bra func_81C079                      ;81C036|8041    |C1C079;  

func_81C038:
	asl a                                ;81C038|0A      |      ;  
	tax                                  ;81C039|AA      |      ;  
	lda.b #$FB                           ;81C03A|A9FB    |      ;  
	sta.b rUnkPtrLo_02                   ;81C03C|8502    |000002;  
	rep #$20                             ;81C03E|C220    |      ;  
...
func_81C07C:
	pla                                  ;81C07C|68      |      ;  
	bne func_81C08C                      ;81C07D|D00D    |C1C08C;  
	rep #$20                             ;81C07F|C220    |      ;  
...
func_81C08C:
	...
	sta.b rUnkPtrLo_02                   ;81C0CD|8502    |000002;  
	ldx.b #$FB                           ;81C0CF|A2FB    |      ;  
	stx.b rUnkPtrHi_02                   ;81C0D1|8604    |000004;  
...
func_81C115:
	...
	sta.b rUnkPtrLo_02                   ;81C133|8502    |000002;  
	lda.w #$4080                         ;81C135|A98040  |      ;  
	sta.b rUnkPtrHi_02                   ;81C138|8504    |000004;  
	lda.w #$CC9A                         ;81C13A|A99ACC  |      ;  
	sta.b $00                            ;81C13D|8500    |000000;  
	...
	sta.b rUnkPtrLo_02                   ;81C150|8502    |000002;  
	lda.w $2F0A                          ;81C152|AD0A2F  |7E2F0A;  
	and.w #$0EFF                         ;81C155|29FF0E  |      ;  
	ora.b rUnkPtrLo_02                   ;81C158|0502    |000002;  
	...
	beq func_81C16C                      ;81C167|F003    |C1C16C;  
...
func_81C16C:
	...
	beq func_81C17E                      ;81C179|F003    |C1C17E;  
...
func_81C18E:
	...
	beq func_81C1A8                      ;81C1A0|F006    |C1C1A8;  
	clc                                  ;81C1A2|18      |      ;  
	adc.w $2854                          ;81C1A3|6D5428  |7E2854;  
	bra func_81C1AF                      ;81C1A6|8007    |C1C1AF;  
...
func_81C1AF:
	...
	sta.b rUnkPtrLo_02                   ;81C1E4|8502    |000002;  
	lda.w #$4080                         ;81C1E6|A98040  |      ;  
	sta.b rUnkPtrHi_02                   ;81C1E9|8504    |000004;  
	lda.w #$CC9A                         ;81C1EB|A99ACC  |      ;  
	sta.b $00                            ;81C1EE|8500    |000000;  
	...
	beq func_81C20C                      ;81C207|F003    |C1C20C;  
...
func_81C241:
	...
	beq func_81C27A                      ;81C275|F003    |C1C27A;  
...
func_81C27A:
	...
	beq func_81C28A                      ;81C285|F003    |C1C28A;  
...
func_81C29C:
	...
	beq func_81C2D6                      ;81C2B0|F024    |C1C2D6;  
	cmp.w #$0020                         ;81C2B2|C92000  |      ;  
	beq func_81C2D6                      ;81C2B5|F01F    |C1C2D6;  
	asl a                                ;81C2B7|0A      |      ;  
	asl a                                ;81C2B8|0A      |      ;  
	adc.l $7E2302                        ;81C2B9|6F02237E|7E2302;  
	asl a                                ;81C2BD|0A      |      ;  
	adc.l DATA8_81C2D8,x                 ;81C2BE|7FD8C281|81C2D8;  
	sta.b rUnkPtrLo_02                   ;81C2C2|8502    |000002;  
	ldx.w #$00FB                         ;81C2C4|A2FB00  |      ;  
	stx.b rUnkPtrHi_02                   ;81C2C7|8604    |000004;  
	lda.w #$A505                         ;81C2C9|A905A5  |      ;  
	sta.b $00                            ;81C2CC|8500    |000000;  
...
func_81C2DC:
	...
	dec a                                ;81C2FB|3A      |      ;  
	beq func_81C31B                      ;81C2FC|F01D    |C1C31B;  
	cmp.w #$0003                         ;81C2FE|C90300  |      ;  
	bcc func_81C306                      ;81C301|9003    |C1C306;  
...
func_81C322:
	...
	plb                                  ;81C328|AB      |      ;  
	tdc                                  ;81C329|7B      |      ;  
	lda.b $00                            ;81C32A|A500    |000000;  
	rep #$30                             ;81C32C|C230    |      ;  
	asl a                                ;81C32E|0A      |      ;  
	tay                                  ;81C32F|A8      |      ;  
	lda.w $22AE,y                        ;81C330|B9AE22  |7E22AE;  
	bne func_81C349                      ;81C333|D014    |C1C349;  
	...
	tsb.b rUnkPtrLo_02                   ;81C347|0402    |000002;  
...
func_81C35C:
	...
	beq func_81C378                      ;81C360|F016    |C1C378;  
...
func_81C378:
	lda.b rUnkPtrLo_02                   ;81C378|A502    |000002;  
	asl a                                ;81C37A|0A      |      ;  
	xba                                  ;81C37B|EB      |      ;  
	and.w #$000E                         ;81C37C|290E00  |      ;  
	ror a                                ;81C37F|6A      |      ;  
	sta.w $282E,y                        ;81C380|992E28  |7E282E;  
	lda.b rUnkPtrLo_02                   ;81C383|A502    |000002;  
...
UNREACH_C1C38D:
	...
	lda.b rUnkPtrHi_02                   ;81C395|A504    |000004;  
...
func_81C400:
	...
	lda.b rUnkPtrHi_02                   ;81C40C|A504    |000004;  
...
func_81C42A:
	lda.b rUnkPtrLo_02                   ;81C42A|A502    |000002;  
	bit.w #$0080                         ;81C42C|898000  |      ;  
	beq func_81C440                      ;81C42F|F00F    |C1C440;  
...
func_81C4C6:
	...
	pha                                  ;81C4CB|48      |      ;  
	plb                                  ;81C4CC|AB      |      ;  
	lda.b $00                            ;81C4CD|A500    |000000;  
	asl a                                ;81C4CF|0A      |      ;  
	tay                                  ;81C4D0|A8      |      ;  
	lda.b $03                            ;81C4D1|A503    |000003;  
	and.b #$07                           ;81C4D3|2907    |      ;  
	sta.w $282E,y                        ;81C4D5|992E28  |7E282E;  
	rep #$30                             ;81C4D8|C230    |      ;  
	lda.w $22AE,y                        ;81C4DA|B9AE22  |7E22AE;  
	beq func_81C51F                      ;81C4DD|F040    |C1C51F;  
	lda.b rUnkPtrLo_02                   ;81C4DF|A502    |000002;  
	bit.w #$0080                         ;81C4E1|898000  |      ;  
	beq func_81C4F5                      ;81C4E4|F00F    |C1C4F5;  
...
func_81C4F5:
	...
	beq func_81C51F                      ;81C50E|F00F    |C1C51F;  
...
func_81C545:
	...
	ply                                  ;81C55C|7A      |      ;  
	pla                                  ;81C55D|68      |      ;  
	sta.b rUnkPtrLo_02                   ;81C55E|8502    |000002;  
...
func_81C58B:
	...
	txa                                  ;81C5B4|8A      |      ;  
	sec                                  ;81C5B5|38      |      ;  
	sbc.b $6A                            ;81C5B6|E56A    |00006A;  
	sta.w $2A96,y                        ;81C5B8|99962A  |7E2A96;  
	lda.b $05                            ;81C5BB|A505    |000005;  
	and.w #$00FF                         ;81C5BD|29FF00  |      ;  
	sta.b $6A                            ;81C5C0|856A    |00006A;  
	xba                                  ;81C5C2|EB      |      ;  
	lsr a                                ;81C5C3|4A      |      ;  
	lsr a                                ;81C5C4|4A      |      ;  
	lsr a                                ;81C5C5|4A      |      ;  
	sta.w $298E,y                        ;81C5C6|998E29  |7E298E;  
	lda.b $07                            ;81C5C9|A507    |000007;  
	...
	txa                                  ;81C5D9|8A      |      ;  
	sec                                  ;81C5DA|38      |      ;  
	sbc.b $6A                            ;81C5DB|E56A    |00006A;  
	sta.w $2AEE,y                        ;81C5DD|99EE2A  |7E2AEE;  
	lda.b rUnkPtrLo_02                   ;81C5E0|A502    |000002;  
	bit.w #$0080                         ;81C5E2|898000  |      ;  
	beq func_81C614                      ;81C5E5|F02D    |C1C614;  
	bit.w #$0040                         ;81C5E7|894000  |      ;  
	beq func_81C5FF                      ;81C5EA|F013    |C1C5FF;  
	...
	bra func_81C63D                      ;81C5FD|803E    |C1C63D;  
...
func_81C5FF:
	...
	bra func_81C63D                      ;81C612|8029    |C1C63D;  

func_81C614:
	bit.w #$0040                         ;81C614|894000  |      ;  
	beq func_81C634                      ;81C617|F01B    |C1C634;  
	...
	bra func_81C63D                      ;81C632|8009    |C1C63D;  
...
func_81C670:
	...
	beq func_81C67D                      ;81C673|F008    |C1C67D;  
	dey                                  ;81C675|88      |      ;  
	dey                                  ;81C676|88      |      ;  
	dex                                  ;81C677|CA      |      ;  
	bpl func_81C670                      ;81C678|10F6    |C1C670;  
	db $28,$38,$6B                       ;81C67A|        |      ;  
...
func_81C67D:
	...
	bne func_81C692                      ;81C68D|D003    |C1C692;  
	db $28,$18,$6B                       ;81C68F|        |      ;  
...
func_81C696:
	...
	lda.b rUnkPtrHi_02                   ;81C6AB|A504    |000004;  
	and.w #$00FF                         ;81C6AD|29FF00  |      ;  
	sta.b $6A                            ;81C6B0|856A    |00006A;  
	xba                                  ;81C6B2|EB      |      ;  
	lsr a                                ;81C6B3|4A      |      ;  
	lsr a                                ;81C6B4|4A      |      ;  
	lsr a                                ;81C6B5|4A      |      ;  
	sta.w $2936,y                        ;81C6B6|993629  |7E2936;  
	lda.b $06                            ;81C6B9|A506    |000006;  
	...
	txa                                  ;81C6C9|8A      |      ;  
	sec                                  ;81C6CA|38      |      ;  
	sbc.b $6A                            ;81C6CB|E56A    |00006A;  
	sta.w $2A96,y                        ;81C6CD|99962A  |7E2A96;  
	lda.b $05                            ;81C6D0|A505    |000005;  
	and.w #$00FF                         ;81C6D2|29FF00  |      ;  
	sta.b $6A                            ;81C6D5|856A    |00006A;  
	xba                                  ;81C6D7|EB      |      ;  
	lsr a                                ;81C6D8|4A      |      ;  
	lsr a                                ;81C6D9|4A      |      ;  
	lsr a                                ;81C6DA|4A      |      ;  
	sta.w $298E,y                        ;81C6DB|998E29  |7E298E;  
	lda.b $07                            ;81C6DE|A507    |000007;  
...
func_81C705:
	lda.b rUnkPtrLo_02                   ;81C705|A502    |000002;  
	asl a                                ;81C707|0A      |      ;  
	xba                                  ;81C708|EB      |      ;  
	and.w #$000E                         ;81C709|290E00  |      ;  
	ror a                                ;81C70C|6A      |      ;  
	sta.w $282E,y                        ;81C70D|992E28  |7E282E;  
	lda.b rUnkPtrLo_02                   ;81C710|A502    |000002;  
	and.w #$007F                         ;81C712|297F00  |      ;  
	asl a                                ;81C715|0A      |      ;  
	bit.w #$0080                         ;81C716|898000  |      ;  
	beq func_81C72A                      ;81C719|F00F    |C1C72A;  
	...
	bra func_81C739                      ;81C728|800F    |C1C739;  
...
func_81C75E:
	...
	beq func_81C76B                      ;81C761|F008    |C1C76B;  
	dey                                  ;81C763|88      |      ;  
	dey                                  ;81C764|88      |      ;  
	dex                                  ;81C765|CA      |      ;  
	bpl func_81C75E                      ;81C766|10F6    |C1C75E;  
	db $28,$38,$6B                       ;81C768|        |      ;  
...
func_81C76B:
	...
	bne func_81C780                      ;81C77B|D003    |C1C780;  
	db $28,$18,$6B                       ;81C77D|        |      ;  
...
func_81C780:
	...
	lda.b rUnkPtrHi_02                   ;81C78F|A504    |000004;  
...
func_81C7FF:
	...
	beq func_81C80C                      ;81C802|F008    |C1C80C;  
	iny                                  ;81C804|C8      |      ;  
	iny                                  ;81C805|C8      |      ;  
	dex                                  ;81C806|CA      |      ;  
	bpl func_81C7FF                      ;81C807|10F6    |C1C7FF;  
	db $28,$38,$6B                       ;81C809|        |      ;  
...
func_81C80C:
	...
	bne func_81C821                      ;81C81C|D003    |C1C821;  
	db $28,$18,$6B                       ;81C81E|        |      ;  
...
func_81C874:
	...
	plb                                  ;81C87A|AB      |      ;  
	rep #$30                             ;81C87B|C230    |      ;  
	lda.b rUnkPtrHi_02                   ;81C87D|A504    |000004;  
	and.w #$00FF                         ;81C87F|29FF00  |      ;  
	sta.b $6A                            ;81C882|856A    |00006A;  
	xba                                  ;81C884|EB      |      ;  
	lsr a                                ;81C885|4A      |      ;  
	lsr a                                ;81C886|4A      |      ;  
	lsr a                                ;81C887|4A      |      ;  
	sta.w $2976                          ;81C888|8D7629  |7E2976;  
	lda.b $06                            ;81C88B|A506    |000006;  
	...
	txa                                  ;81C89B|8A      |      ;  
	sec                                  ;81C89C|38      |      ;  
	sbc.b $6A                            ;81C89D|E56A    |00006A;  
	sta.w $2AD6                          ;81C89F|8DD62A  |7E2AD6;  
	lda.b $05                            ;81C8A2|A505    |000005;  
	and.w #$00FF                         ;81C8A4|29FF00  |      ;  
	sta.b $6A                            ;81C8A7|856A    |00006A;  
	xba                                  ;81C8A9|EB      |      ;  
	lsr a                                ;81C8AA|4A      |      ;  
	lsr a                                ;81C8AB|4A      |      ;  
	lsr a                                ;81C8AC|4A      |      ;  
	sta.w $29CE                          ;81C8AD|8DCE29  |7E29CE;  
	lda.b $07                            ;81C8B0|A507    |000007;  
	...
	txa                                  ;81C8C0|8A      |      ;  
	sec                                  ;81C8C1|38      |      ;  
	sbc.b $6A                            ;81C8C2|E56A    |00006A;  
	sta.w $2B2E                          ;81C8C4|8D2E2B  |7E2B2E;  
	lda.b $03                            ;81C8C7|A503    |000003;  
	and.w #$0007                         ;81C8C9|290700  |      ;  
	sta.w $286E                          ;81C8CC|8D6E28  |7E286E;  
	lda.b rUnkPtrLo_02                   ;81C8CF|A502    |000002;  
	...
	bne func_81C911                      ;81C8F9|D016    |C1C911;  
...
func_81C913:
	...
	plb                                  ;81C919|AB      |      ;  
	rep #$30                             ;81C91A|C230    |      ;  
	lda.b [$00]                          ;81C91C|A700    |000000;  
	tax                                  ;81C91E|AA      |      ;  
	and.w #$003F                         ;81C91F|293F00  |      ;  
	bit.w #$0020                         ;81C922|892000  |      ;  
	beq func_81C92A                      ;81C925|F003    |C1C92A;  
...
func_81C92A:
	...
	xba                                  ;81C92F|EB      |      ;  
	asl a                                ;81C930|0A      |      ;  
	bcs func_81C97E                      ;81C931|B04B    |C1C97E;  
	bmi func_81C96D                      ;81C933|3038    |C1C96D;  
	lda.b $00                            ;81C935|A500    |000000;  
	inc a                                ;81C937|1A      |      ;  
	sta.b $00                            ;81C938|8500    |000000;  
	adc.w #$0100                         ;81C93A|690001  |      ;  
	sta.b $6A                            ;81C93D|856A    |00006A;  
	adc.w #$0100                         ;81C93F|690001  |      ;  
	lda.b rUnkPtrLo_02                   ;81C942|A502    |000002;  
	bcc func_81C94A                      ;81C944|9004    |C1C94A;  
	db $64,$6A,$1A,$18                   ;81C946|        |00006A;  

func_81C94A:
	sta.b $6C                            ;81C94A|856C    |00006C;  
	lda.w #$00FE                         ;81C94C|A9FE00  |      ;  
	tay                                  ;81C94F|A8      |      ;  
	adc.b rUnkPtrHi_02                   ;81C950|6504    |000004;  
	tax                                  ;81C952|AA      |      ;  

func_81C953:
	lda.b [$00],y                        ;81C953|B700    |000000;  
	sta.w $0000,x                        ;81C955|9D0000  |7E0000;  
	...
	dey                                  ;81C95F|88      |      ;  
	dey                                  ;81C960|88      |      ;  
	bpl func_81C953                      ;81C961|10F0    |C1C953;  
	lda.w #$0000                         ;81C963|A90000  |      ;  
	sta.b $00                            ;81C966|8500    |000000;  
	pla                                  ;81C968|68      |      ;  
	sta.b rUnkPtrLo_02                   ;81C969|8502    |000002;  
	plp                                  ;81C96B|28      |      ;  
	rtl                                  ;81C96C|6B      |      ;  
...
func_81C96D:
	...
	sta.b $00                            ;81C977|8500    |000000;  
	pla                                  ;81C979|68      |      ;  
	sta.b rUnkPtrLo_02                   ;81C97A|8502    |000002;  
	plp                                  ;81C97C|28      |      ;  
	rtl                                  ;81C97D|6B      |      ;  

func_81C97E:
	bmi func_81C994                      ;81C97E|3014    |C1C994;  
	lsr a                                ;81C980|4A      |      ;  
	...
	sta.b $00                            ;81C98D|8500    |000000;  
	pla                                  ;81C98F|68      |      ;  
	sta.b rUnkPtrLo_02                   ;81C990|8502    |000002;  
	plp                                  ;81C992|28      |      ;  
	rtl                                  ;81C993|6B      |      ;  
...
func_81C994:
	...
	sta.b $00                            ;81C9A4|8500    |000000;  
	pla                                  ;81C9A6|68      |      ;  
	sta.b rUnkPtrLo_02                   ;81C9A7|8502    |000002;  
	plp                                  ;81C9A9|28      |      ;  
	rtl                                  ;81C9AA|6B      |      ;  

func_81C9AB:
	lda.b [$00],y                        ;81C9AB|B700    |000000;  
	iny                                  ;81C9AD|C8      |      ;  
...
func_81C9AE:
	...
	ldx.b rUnkPtrHi_02                   ;81C9B7|A604    |000004;  
	lsr a                                ;81C9B9|4A      |      ;  
	bcs func_81C9C4                      ;81C9BA|B008    |C1C9C4;  
	lsr a                                ;81C9BC|4A      |      ;  
	sta.b $6A                            ;81C9BD|856A    |00006A;  
	bcc func_81C9D9                      ;81C9BF|9018    |C1C9D9;  
	jmp.w func_81CAD2                    ;81C9C1|4CD2CA  |C1CAD2;  

func_81C9C4:
	lsr a                                ;81C9C4|4A      |      ;  
	sta.b $6A                            ;81C9C5|856A    |00006A;  
	bcc func_81CA1B                      ;81C9C7|9052    |C1CA1B;  
	jmp.w func_81CB15                    ;81C9C9|4C15CB  |C1CB15;  
	lda.b rUnkPtrHi_02                   ;81C9CC|A504    |000004;  
	clc                                  ;81C9CE|18      |      ;  
	adc.w #$0200                         ;81C9CF|690002  |      ;  
	tax                                  ;81C9D2|AA      |      ;  
	lsr.b $6A                            ;81C9D3|466A    |00006A;  
	bcs func_81C9DE                      ;81C9D5|B007    |C1C9DE;  
	lsr.b $6A                            ;81C9D7|466A    |00006A;  
...
func_81C9DE:
	lsr.b $6A                            ;81C9DE|466A    |00006A;  
	bcc func_81CA1B                      ;81C9E0|9039    |C1CA1B;  
	jmp.w func_81CB15                    ;81C9E2|4C15CB  |C1CB15;  
	lda.b rUnkPtrHi_02                   ;81C9E5|A504    |000004;  
	clc                                  ;81C9E7|18      |      ;  
	adc.w #$0080                         ;81C9E8|698000  |      ;  
	tax                                  ;81C9EB|AA      |      ;  
	lsr.b $6A                            ;81C9EC|466A    |00006A;  
	bcs func_81C9F7                      ;81C9EE|B007    |C1C9F7;  
	lsr.b $6A                            ;81C9F0|466A    |00006A;  
	bcc func_81CA4C                      ;81C9F2|9058    |C1CA4C;  
	jmp.w func_81CAD2                    ;81C9F4|4CD2CA  |C1CAD2;  

func_81C9F7:
	lsr.b $6A                            ;81C9F7|466A    |00006A;  
	bcc func_81CA1B                      ;81C9F9|9020    |C1CA1B;  
	jmp.w func_81CB15                    ;81C9FB|4C15CB  |C1CB15;  
	lda.b rUnkPtrHi_02                   ;81C9FE|A504    |000004;  
	clc                                  ;81CA00|18      |      ;  
	adc.w #$0020                         ;81CA01|692000  |      ;  
	sta.b rUnkPtrHi_02                   ;81CA04|8504    |000004;  
	adc.w #$0260                         ;81CA06|696002  |      ;  
	tax                                  ;81CA09|AA      |      ;  
	lda.b $6A                            ;81CA0A|A56A    |00006A;  
	lsr a                                ;81CA0C|4A      |      ;  
	bcs func_81CA15                      ;81CA0D|B006    |C1CA15;  
	lsr a                                ;81CA0F|4A      |      ;  
...
func_81CA1B:
	stz.w $0000,x                        ;81CA1B|9E0000  |7E0000;  
	stz.w $0002,x                        ;81CA1E|9E0200  |7E0002;  
	stz.w $0004,x                        ;81CA21|9E0400  |7E0004;  
	stz.w $0006,x                        ;81CA24|9E0600  |7E0006;  
	stz.w $0008,x                        ;81CA27|9E0800  |7E0008;  
	stz.w $000A,x                        ;81CA2A|9E0A00  |7E000A;  
	stz.w $000C,x                        ;81CA2D|9E0C00  |7E000C;  
	stz.w $000E,x                        ;81CA30|9E0E00  |7E000E;  
	stz.w $0010,x                        ;81CA33|9E1000  |7E0010;  
	stz.w $0012,x                        ;81CA36|9E1200  |7E0012;  
	stz.w $0014,x                        ;81CA39|9E1400  |7E0014;  
	stz.w $0016,x                        ;81CA3C|9E1600  |7E0016;  
	stz.w $0018,x                        ;81CA3F|9E1800  |7E0018;  
	stz.w $001A,x                        ;81CA42|9E1A00  |7E001A;  
	stz.w $001C,x                        ;81CA45|9E1C00  |7E001C;  
	stz.w $001E,x                        ;81CA48|9E1E00  |7E001E;  
	rts                                  ;81CA4B|60      |      ;  

func_81CA4C:
	tya                                  ;81CA4C|98      |      ;  
	clc                                  ;81CA4D|18      |      ;  
	adc.b $00                            ;81CA4E|6500    |000000;  
	bcc func_81CA54                      ;81CA50|9002    |C1CA54;  
	inc.b rUnkPtrLo_02                   ;81CA52|E602    |000002;  
...
func_81CA54:
	...
	plb                                  ;81CA59|AB      |      ;  
	plb                                  ;81CA5A|AB      |      ;  
	lda.w DATA8_D30000,y                 ;81CA5B|B90000  |D30000;  
	sta.l $7E0000,x                      ;81CA5E|9F00007E|7E0000;  
	lda.w DATA8_D30002,y                 ;81CA62|B90200  |D30002;  
	sta.l $7E0002,x                      ;81CA65|9F02007E|7E0002;  
	lda.w DATA8_D30004,y                 ;81CA69|B90400  |D30004;  
	sta.l $7E0004,x                      ;81CA6C|9F04007E|7E0004;  
	lda.w DATA8_D30006,y                 ;81CA70|B90600  |D30006;  
	sta.l $7E0006,x                      ;81CA73|9F06007E|7E0006;  
	lda.w DATA8_D30008,y                 ;81CA77|B90800  |D30008;  
	sta.l $7E0008,x                      ;81CA7A|9F08007E|7E0008;  
	lda.w DATA8_D3000A,y                 ;81CA7E|B90A00  |D3000A;  
	sta.l $7E000A,x                      ;81CA81|9F0A007E|7E000A;  
	lda.w DATA8_D3000C,y                 ;81CA85|B90C00  |D3000C;  
	sta.l $7E000C,x                      ;81CA88|9F0C007E|7E000C;  
	lda.w DATA8_D3000E,y                 ;81CA8C|B90E00  |D3000E;  
	sta.l $7E000E,x                      ;81CA8F|9F0E007E|7E000E;  
	lda.w DATA8_D30010,y                 ;81CA93|B91000  |D30010;  
	sta.l $7E0010,x                      ;81CA96|9F10007E|7E0010;  
	lda.w DATA8_D30012,y                 ;81CA9A|B91200  |D30012;  
	sta.l $7E0012,x                      ;81CA9D|9F12007E|7E0012;  
	lda.w DATA8_D30014,y                 ;81CAA1|B91400  |D30014;  
	sta.l $7E0014,x                      ;81CAA4|9F14007E|7E0014;  
	lda.w DATA8_D30016,y                 ;81CAA8|B91600  |D30016;  
	sta.l $7E0016,x                      ;81CAAB|9F16007E|7E0016;  
	lda.w DATA8_D30018,y                 ;81CAAF|B91800  |D30018;  
	sta.l $7E0018,x                      ;81CAB2|9F18007E|7E0018;  
	lda.w DATA8_D3001A,y                 ;81CAB6|B91A00  |D3001A;  
	sta.l $7E001A,x                      ;81CAB9|9F1A007E|7E001A;  
	lda.w DATA8_D3001C,y                 ;81CABD|B91C00  |D3001C;  
	sta.l $7E001C,x                      ;81CAC0|9F1C007E|7E001C;  
	lda.w DATA8_D3001E,y                 ;81CAC4|B91E00  |D3001E;  
	sta.l $7E001E,x                      ;81CAC7|9F1E007E|7E001E;  
	sty.b $00                            ;81CACB|8400    |000000;  
...
func_81CAD2:
	...
	sta.b $6C                            ;81CAD7|856C    |00006C;  
	lda.b [$00],y                        ;81CAD9|B700    |000000;  
	iny                                  ;81CADB|C8      |      ;  
	iny                                  ;81CADC|C8      |      ;  
	lsr a                                ;81CADD|4A      |      ;  
	sta.b $6E                            ;81CADE|856E    |00006E;  
	bcs func_81CAF2                      ;81CAE0|B010    |C1CAF2;  

func_81CAE2:
	stz.w $0000,x                        ;81CAE2|9E0000  |7E0000;  
	lsr.b $6E                            ;81CAE5|466E    |00006E;  
	bcs func_81CAFD                      ;81CAE7|B014    |C1CAFD;  
	stz.w $0010,x                        ;81CAE9|9E1000  |7E0010;  
	bra func_81CB04                      ;81CAEC|8016    |C1CB04;  

func_81CAEE:
	lsr.b $6E                            ;81CAEE|466E    |00006E;  
	bcc func_81CAE2                      ;81CAF0|90F0    |C1CAE2;  

func_81CAF2:
	lda.b [$00],y                        ;81CAF2|B700    |000000;  
	iny                                  ;81CAF4|C8      |      ;  
	iny                                  ;81CAF5|C8      |      ;  
	sta.w $0000,x                        ;81CAF6|9D0000  |7E0000;  
	lsr.b $6E                            ;81CAF9|466E    |00006E;  
	bcc func_81CB0B                      ;81CAFB|900E    |C1CB0B;  

func_81CAFD:
	lda.b [$00],y                        ;81CAFD|B700    |000000;  
	iny                                  ;81CAFF|C8      |      ;  
	iny                                  ;81CB00|C8      |      ;  
	sta.w $0010,x                        ;81CB01|9D1000  |7E0010;  

func_81CB04:
	inx                                  ;81CB04|E8      |      ;  
	inx                                  ;81CB05|E8      |      ;  
	cpx.b $6C                            ;81CB06|E46C    |00006C;  
	bne func_81CAEE                      ;81CB08|D0E4    |C1CAEE;  
	rts                                  ;81CB0A|60      |      ;  

func_81CB0B:
	stz.w $0010,x                        ;81CB0B|9E1000  |7E0010;  
	inx                                  ;81CB0E|E8      |      ;  
	inx                                  ;81CB0F|E8      |      ;  
	cpx.b $6C                            ;81CB10|E46C    |00006C;  
	bne func_81CAEE                      ;81CB12|D0DA    |C1CAEE;  
	rts                                  ;81CB14|60      |      ;  
...
func_81CB15:
	...
	sta.b $6C                            ;81CB1A|856C    |00006C;  
	lda.b [$00],y                        ;81CB1C|B700    |000000;  
	iny                                  ;81CB1E|C8      |      ;  
	iny                                  ;81CB1F|C8      |      ;  
	lsr a                                ;81CB20|4A      |      ;  
	sta.b $6E                            ;81CB21|856E    |00006E;  
	bcs func_81CB2C                      ;81CB23|B007    |C1CB2C;  
	tdc                                  ;81CB25|7B      |      ;  
	bra func_81CB30                      ;81CB26|8008    |C1CB30;  

func_81CB28:
	lsr.b $6E                            ;81CB28|466E    |00006E;  
	bcc func_81CB30                      ;81CB2A|9004    |C1CB30;  

func_81CB2C:
	lda.b [$00],y                        ;81CB2C|B700    |000000;  
	iny                                  ;81CB2E|C8      |      ;  
	iny                                  ;81CB2F|C8      |      ;  

func_81CB30:
	sta.w $0000,x                        ;81CB30|9D0000  |7E0000;  
	inx                                  ;81CB33|E8      |      ;  
	inx                                  ;81CB34|E8      |      ;  
	lsr.b $6E                            ;81CB35|466E    |00006E;  
	bcc func_81CB3D                      ;81CB37|9004    |C1CB3D;  
	lda.b [$00],y                        ;81CB39|B700    |000000;  
	iny                                  ;81CB3B|C8      |      ;  
	iny                                  ;81CB3C|C8      |      ;  

func_81CB3D:
	sta.w $0000,x                        ;81CB3D|9D0000  |7E0000;  
	inx                                  ;81CB40|E8      |      ;  
	inx                                  ;81CB41|E8      |      ;  
	cpx.b $6C                            ;81CB42|E46C    |00006C;  
	bne func_81CB28                      ;81CB44|D0E2    |C1CB28;  
	rts                                  ;81CB46|60      |      ;  
...
func_81CB47:
	...
	pha                                  ;81CB5E|48      |      ;  
	pha                                  ;81CB5F|48      |      ;  
	lda.b rUnkPtrHi_02                   ;81CB60|A504    |000004;  
	tax                                  ;81CB62|AA      |      ;  
	clc                                  ;81CB63|18      |      ;  
	adc.w #$0020                         ;81CB64|692000  |      ;  
	sta.b rUnkPtrHi_02                   ;81CB67|8504    |000004;  
	lda.b [$00],y                        ;81CB69|B700    |000000;  
	iny                                  ;81CB6B|C8      |      ;  
	pea.w $CB87                          ;81CB6C|F487CB  |7ECB87;  
	pea.w $CB87                          ;81CB6F|F487CB  |7ECB87;  
	pea.w $CB87                          ;81CB72|F487CB  |7ECB87;  
	lsr a                                ;81CB75|4A      |      ;  
	bcs func_81CB80                      ;81CB76|B008    |C1CB80;  
	lsr a                                ;81CB78|4A      |      ;  
	sta.b $6A                            ;81CB79|856A    |00006A;  
	bcc func_81CBA3                      ;81CB7B|9026    |C1CBA3;  
	jmp.w func_81CAD2                    ;81CB7D|4CD2CA  |C1CAD2;  

func_81CB80:
	lsr a                                ;81CB80|4A      |      ;  
	sta.b $6A                            ;81CB81|856A    |00006A;  
	bcc func_81CBA6                      ;81CB83|9021    |C1CBA6;  
	jmp.w func_81CB15                    ;81CB85|4C15CB  |C1CB15;  
	lda.b rUnkPtrHi_02                   ;81CB88|A504    |000004;  
	tax                                  ;81CB8A|AA      |      ;  
	clc                                  ;81CB8B|18      |      ;  
	adc.w #$0020                         ;81CB8C|692000  |      ;  
	sta.b rUnkPtrHi_02                   ;81CB8F|8504    |000004;  
	lsr.b $6A                            ;81CB91|466A    |00006A;  
	bcs func_81CB9C                      ;81CB93|B007    |C1CB9C;  
	lsr.b $6A                            ;81CB95|466A    |00006A;  
	bcc func_81CBA3                      ;81CB97|900A    |C1CBA3;  
	jmp.w func_81CAD2                    ;81CB99|4CD2CA  |C1CAD2;  

func_81CB9C:
	lsr.b $6A                            ;81CB9C|466A    |00006A;  
	bcc func_81CBA6                      ;81CB9E|9006    |C1CBA6;  
...
func_81CBA6:
	...
	tya                                  ;81CBA9|98      |      ;  
	clc                                  ;81CBAA|18      |      ;  
	adc.b $00                            ;81CBAB|6500    |000000;  
	sta.b $00                            ;81CBAD|8500    |000000;  
	bcc func_81CBB3                      ;81CBAF|9002    |C1CBB3;  
	inc.b rUnkPtrLo_02                   ;81CBB1|E602    |000002;  
...
func_81CC29:
	php                                  ;81CC29|08      |      ;  
	rep #$20                             ;81CC2A|C220    |      ;  
	stz.b $03                            ;81CC2C|6403    |000003;  
	lda.b rUnkPtrLo_02                   ;81CC2E|A502    |000002;  
	asl a                                ;81CC30|0A      |      ;  
	asl a                                ;81CC31|0A      |      ;  
	asl a                                ;81CC32|0A      |      ;  
	asl a                                ;81CC33|0A      |      ;  
	sec                                  ;81CC34|38      |      ;  
	sbc.b rUnkPtrLo_02                   ;81CC35|E502    |000002;  
	asl a                                ;81CC37|0A      |      ;  
	adc.w #$C66D                         ;81CC38|696DC6  |      ;  
	sta.b rUnkPtrLo_02                   ;81CC3B|8502    |000002;  
	lda.w #$00FB                         ;81CC3D|A9FB00  |      ;  
	sta.b rUnkPtrHi_02                   ;81CC40|8504    |000004;  
...
func_81CD61:
	...
	plp                                  ;81CD68|28      |      ;  
	bcs func_81CD6F                      ;81CD69|B004    |C1CD6F;  
	jsl.l func_81D084                    ;81CD6B|2284D081|81D084;  

func_81CD6F:
	jsl.l CODE_C67E5A                    ;81CD6F|225A7EC6|C67E5A;  
	bcc func_81CD79                      ;81CD73|9004    |C1CD79;  
	jsl.l CODE_C67821                    ;81CD75|222178C6|C67821;  

func_81CD79:
	jsl.l CODE_C67EDB                    ;81CD79|22DB7EC6|C67EDB;  
	bcc func_81CD83                      ;81CD7D|9004    |C1CD83;  
	db $22,$21,$78,$C6                   ;81CD7F|        |C67821;  

func_81CD83:
	jsl.l CODE_C40000                    ;81CD83|220000C4|C40000;  
	rep #$20                             ;81CD87|C220    |      ;  
	tsc                                  ;81CD89|3B      |      ;  
...
func_81CDDD:
	...
	sta.b $00                            ;81CDE2|8500    |000000;  
	jsl.l func_818049                    ;81CDE4|22498081|818049;  
	jsl.l CODE_C4854E                    ;81CDE8|224E85C4|C4854E;  
	sep #$30                             ;81CDEC|E230    |      ;  
...
func_81CDF1:
	sty.b $00                            ;81CDF1|8400    |000000;  
	pha                                  ;81CDF3|48      |      ;  
	phy                                  ;81CDF4|5A      |      ;  
	jsl.l CODE_C3E5F2                    ;81CDF5|22F2E5C3|C3E5F2;  
	ply                                  ;81CDF9|7A      |      ;  
	pla                                  ;81CDFA|68      |      ;  
	clc                                  ;81CDFB|18      |      ;  
	ldx.b $00                            ;81CDFC|A600    |000000;  
	beq func_81CE01                      ;81CDFE|F001    |C1CE01;  
	sec                                  ;81CE00|38      |      ;  

func_81CE01:
	rol a                                ;81CE01|2A      |      ;  
	dey                                  ;81CE02|88      |      ;  
	bpl func_81CDF1                      ;81CE03|10EC    |C1CDF1;  
...
func_81CE34:
	...
	pha                                  ;81CE38|48      |      ;  
	lda.b rUnkPtrLo_02                   ;81CE39|A502    |000002;  
	beq func_81CE47                      ;81CE3B|F00A    |C1CE47;  
	jsl.l CODE_C3E131                    ;81CE3D|2231E1C3|C3E131;  
	stz.b $00                            ;81CE41|6400    |000000;  
	jsl.l CODE_C3E16A                    ;81CE43|226AE1C3|C3E16A;  

func_81CE47:
	jsl.l CODE_C48584                    ;81CE47|228485C4|C48584;  
	...
	pla                                  ;81CE7A|68      |      ;  
	sta.b $00                            ;81CE7B|8500    |000000;  
	jsl.l CODE_C3E571                    ;81CE7D|2271E5C3|C3E571;  
...
func_81CE97:
	...
	bcs UNREACH_C1CED6                   ;81CEBB|B019    |C1CED6;  
	jsl.l CODE_C48584                    ;81CEBD|228485C4|C48584;  
	jsr.w func_81CF37                    ;81CEC1|2037CF  |C1CF37;  
	jsl.l func_80DECB                    ;81CEC4|22CBDE80|80DECB;  
	pla                                  ;81CEC8|68      |      ;  
	sta.b $00                            ;81CEC9|8500    |000000;  
	jsl.l CODE_C63394                    ;81CECB|229433C6|C63394;  
...
func_81CEEF:
	...
	sta.b $00                            ;81CF06|8500    |000000;  
	lda.w #$0000                         ;81CF08|A90000  |      ;  
	sta.b rUnkPtrLo_02                   ;81CF0B|8502    |000002;  
	jsl.l CODE_C672FB                    ;81CF0D|22FB72C6|C672FB;  
	lda.w #$0800                         ;81CF11|A90008  |      ;  
	sta.b $00                            ;81CF14|8500    |000000;  
	lda.w #$0000                         ;81CF16|A90000  |      ;  
	sta.b rUnkPtrLo_02                   ;81CF19|8502    |000002;  
	jsl.l CODE_C6732E                    ;81CF1B|222E73C6|C6732E;  
	lda.w #$0002                         ;81CF1F|A90200  |      ;  
	sta.b $00                            ;81CF22|8500    |000000;  
	jsl.l func_808F59                    ;81CF24|22598F80|808F59;  
	lda.w #$0100                         ;81CF28|A90001  |      ;  
	sta.b $00                            ;81CF2B|8500    |000000;  
...
func_81CF49:
	php                                  ;81CF49|08      |      ;  
	sep #$30                             ;81CF4A|E230    |      ;  
	jsl.l CODE_C67E5A                    ;81CF4C|225A7EC6|C67E5A;  
	bcc func_81CF56                      ;81CF50|9004    |C1CF56;  
	db $22,$21,$78,$C6                   ;81CF52|        |C67821;  

func_81CF56:
	jsl.l CODE_C67EDB                    ;81CF56|22DB7EC6|C67EDB;  
	tdc                                  ;81CF5A|7B      |      ;  
...
func_81CF62:
	sty.b $00                            ;81CF62|8400    |000000;  
	pha                                  ;81CF64|48      |      ;  
	phy                                  ;81CF65|5A      |      ;  
	jsl.l CODE_C3E629                    ;81CF66|2229E6C3|C3E629;  
	ply                                  ;81CF6A|7A      |      ;  
	pla                                  ;81CF6B|68      |      ;  
	clc                                  ;81CF6C|18      |      ;  
	ldx.b $00                            ;81CF6D|A600    |000000;  
	beq func_81CF72                      ;81CF6F|F001    |C1CF72;  
	db $38                               ;81CF71|        |      ;  

func_81CF72:
	rol a                                ;81CF72|2A      |      ;  
	dey                                  ;81CF73|88      |      ;  
	bpl func_81CF62                      ;81CF74|10EC    |C1CF62;  
	tax                                  ;81CF76|AA      |      ;  
	beq func_81CFDE                      ;81CF77|F065    |C1CFDE;  
...
func_81CFE0:
	...
	tcs                                  ;81CFE6|1B      |      ;  
	lda.b $00                            ;81CFE7|A500    |000000;  
	pha                                  ;81CFE9|48      |      ;  
	jsr.w func_81CF37                    ;81CFEA|2037CF  |C1CF37;  
	jsl.l func_809D84                    ;81CFED|22849D80|809D84;  
	pla                                  ;81CFF1|68      |      ;  
	sta.b $00                            ;81CFF2|8500    |000000;  
	sep #$30                             ;81CFF4|E230    |      ;  
	lda.b $00                            ;81CFF6|A500    |000000;  
	...
	sta.b rUnkPtrLo_02                   ;81D004|8502    |000002;  
...
func_81D009:
	...
	rep #$20                             ;81D00D|C220    |      ;  
	sep #$10                             ;81D00F|E210    |      ;  
	ldx.b $00                            ;81D011|A600    |000000;  
	phx                                  ;81D013|DA      |      ;  
	lda.w #$0100                         ;81D014|A90001  |      ;  
	sta.b $00                            ;81D017|8500    |000000;  
...
func_81D084:
	...
	sta.b $00                            ;81D08A|8500    |000000;  
	jsl.l func_809664                    ;81D08C|22649680|809664;  
	jsl.l func_809684                    ;81D090|22849680|809684;  
	lda.w #$0000                         ;81D094|A90000  |      ;  
	sta.b $00                            ;81D097|8500    |000000;  
	jsl.l func_8081FA                    ;81D099|22FA8180|8081FA;  
	lda.w #$0027                         ;81D09D|A92700  |      ;  
	sta.b $00                            ;81D0A0|8500    |000000;  
	stz.b rUnkPtrLo_02                   ;81D0A2|6402    |000002;  
	lda.w #$1000                         ;81D0A4|A90010  |      ;  
	sta.b rUnkPtrHi_02                   ;81D0A7|8504    |000004;  
	jsl.l CODE_C46D0F                    ;81D0A9|220F6DC4|C46D0F;  
	stz.b $03                            ;81D0AD|6403    |000003;  
	lda.w #$0800                         ;81D0AF|A90008  |      ;  
	sta.b rUnkPtrHi_02                   ;81D0B2|8504    |000004;  
	jsl.l CODE_C484CB                    ;81D0B4|22CB84C4|C484CB;  
	lda.w #$0027                         ;81D0B8|A92700  |      ;  
	sta.b $00                            ;81D0BB|8500    |000000;  
	stz.b rUnkPtrLo_02                   ;81D0BD|6402    |000002;  
	jsl.l CODE_C48339                    ;81D0BF|223983C4|C48339;  
	jsl.l CODE_C483DC                    ;81D0C3|22DC83C4|C483DC;  
	jsl.l func_8085B1                    ;81D0C7|22B18580|8085B1;  
	lda.w #$0002                         ;81D0CB|A90200  |      ;  
	sta.b $00                            ;81D0CE|8500    |000000;  
	jsl.l func_808F59                    ;81D0D0|22598F80|808F59;  
	jsl.l func_80854A                    ;81D0D4|224A8580|80854A;  
	lda.w #$0080                         ;81D0D8|A98000  |      ;  
	sta.b $00                            ;81D0DB|8500    |000000;  
	jsl.l func_809650                    ;81D0DD|22509680|809650;  
	jsl.l func_80854A                    ;81D0E1|224A8580|80854A;  
	lda.w #$0000                         ;81D0E5|A90000  |      ;  
	sta.b $00                            ;81D0E8|8500    |000000;  
	lda.w #$00A6                         ;81D0EA|A9A600  |      ;  
	sta.b rUnkPtrLo_02                   ;81D0ED|8502    |000002;  
	jsl.l CODE_C4C422                    ;81D0EF|2222C4C4|C4C422;  
	sep #$10                             ;81D0F3|E210    |      ;  
	ldx.b rUnkPtrHi_02                   ;81D0F5|A604    |000004;  
	phx                                  ;81D0F7|DA      |      ;  
	cpx.b #$00                           ;81D0F8|E000    |      ;  
	bne func_81D117                      ;81D0FA|D01B    |C1D117;  
...
func_81D234:
	...
	stx.b $7B                            ;81D23E|867B    |00007B;  
	ldx.w #$00EC                         ;81D240|A2EC00  |      ;  
	stx.b $A0                            ;81D243|86A0    |0000A0;  
	lda.b #$09                           ;81D245|A909    |      ;  
	sta.b $79                            ;81D247|8579    |000079;  
	ldy.w #$0000                         ;81D249|A00000  |      ;  

func_81D24C:
	ldx.b $A0                            ;81D24C|A6A0    |0000A0;  
	stx.w VMADDL                          ;81D24E|8E1621  |812116;  
	lda.b #$08                           ;81D251|A908    |      ;  
	sta.b $7A                            ;81D253|857A    |00007A;  

func_81D255:
	lda.b ($7B),y                        ;81D255|B17B    |00007B;  
	sta.w VMDATAL                          ;81D257|8D1821  |812118;  
	iny                                  ;81D25A|C8      |      ;  
	dec.b $7A                            ;81D25B|C67A    |00007A;  
	bne func_81D255                      ;81D25D|D0F6    |C1D255;  
	rep #$20                             ;81D25F|C220    |      ;  
	lda.b $A0                            ;81D261|A5A0    |0000A0;  
	clc                                  ;81D263|18      |      ;  
	adc.w #$0020                         ;81D264|692000  |      ;  
	sta.b $A0                            ;81D267|85A0    |0000A0;  
	sep #$20                             ;81D269|E220    |      ;  
	dec.b $79                            ;81D26B|C679    |000079;  
	bne func_81D24C                      ;81D26D|D0DD    |C1D24C;  
	plp                                  ;81D26F|28      |      ;  
	rts                                  ;81D270|60      |      ;  
...
func_81D271:
	php                                  ;81D271|08      |      ;  
	sep #$30                             ;81D272|E230    |      ;  
	stz.b $A6                            ;81D274|64A6    |0000A6;  
	stz.b $A7                            ;81D276|64A7    |0000A7;  
...
func_81D29D:
	...
	inx                                  ;81D2C0|E8      |      ;  
	inx                                  ;81D2C1|E8      |      ;  
	inc.b $A8                            ;81D2C2|E6A8    |0000A8;  
	bra func_81D29D                      ;81D2C4|80D7    |C1D29D;  

func_81D2C6:
	jsr.w func_81DBCA                    ;81D2C6|20CADB  |C1DBCA;  
	inc.b $A6                            ;81D2C9|E6A6    |0000A6;  
	beq func_81D2CF                      ;81D2CB|F002    |C1D2CF;  
	inc.b $A7                            ;81D2CD|E6A7    |0000A7;  
...
func_81D2D1:
	...
	sta.b $79                            ;81D2DA|8579    |000079;  

func_81D2DC:
	lda.b $79                            ;81D2DC|A579    |000079;  
	sta.w $040C,x                        ;81D2DE|9D0C04  |81040C;  
	clc                                  ;81D2E1|18      |      ;  
	adc.b #$08                           ;81D2E2|6908    |      ;  
	sta.b $79                            ;81D2E4|8579    |000079;  
	...
	inx                                  ;81D2F8|E8      |      ;  
	dey                                  ;81D2F9|88      |      ;  
	bne func_81D2DC                      ;81D2FA|D0E0    |C1D2DC;  
	rep #$20                             ;81D2FC|C220    |      ;  
...
func_81D306:
	...
	sta.b $79                            ;81D30B|8579    |000079;  

func_81D30D:
	jsr.w func_81D157                    ;81D30D|2057D1  |C1D157;  
	bcc func_81D315                      ;81D310|9003    |C1D315;  
	db $28,$38,$60                       ;81D312|        |      ;  
...
func_81D319:
	...
	inx                                  ;81D323|E8      |      ;  
	dey                                  ;81D324|88      |      ;  
	bne func_81D319                      ;81D325|D0F2    |C1D319;  
	jsr.w func_81DB47                    ;81D327|2047DB  |C1DB47;  
	dec.b $79                            ;81D32A|C679    |000079;  
	bne func_81D30D                      ;81D32C|D0DF    |C1D30D;  
	plp                                  ;81D32E|28      |      ;  
	rts                                  ;81D32F|60      |      ;
...
func_81D3D6:
	...
	dex                                  ;81D3DC|CA      |      ;  
	bne func_81D3D6                      ;81D3DD|D0F7    |C1D3D6;  
...
func_81D3E2:
	...
	dex                                  ;81D3E8|CA      |      ;  
	bne func_81D3E2                      ;81D3E9|D0F7    |C1D3E2;  
...
func_81D3F4:
	...
	dex                                  ;81D3FA|CA      |      ;  
	bne func_81D3F4                      ;81D3FB|D0F7    |C1D3F4;  
...
func_81D400:
	...
	dex                                  ;81D406|CA      |      ;  
	bne func_81D400                      ;81D407|D0F7    |C1D400;  
	plp                                  ;81D409|28      |      ;  
	rts                                  ;81D40A|60      |      ;  
...
func_81D451:
	...
	iny                                  ;81D456|C8      |      ;  
	dex                                  ;81D457|CA      |      ;  
	bne func_81D451                      ;81D458|D0F7    |C1D451;  
...
func_81D45C:
	...
	sta.b $7D                            ;81D461|857D    |00007D;  
	sta.b $96                            ;81D463|8596    |000096;  

func_81D465:
	jsr.w func_81D157                    ;81D465|2057D1  |C1D157;  
	bcc func_81D46D                      ;81D468|9003    |C1D46D;  
	db $28,$38,$60                       ;81D46A|        |      ;  

func_81D46D:
	lda.b #$0E                           ;81D46D|A90E    |      ;  
	sta.b $92                            ;81D46F|8592    |000092;  
	sta.b $93                            ;81D471|8593    |000093;  
	stz.b $94                            ;81D473|6494    |000094;  
	ldx.b $96                            ;81D475|A696    |000096;  

func_81D477:
	cpx.b #$32                           ;81D477|E032    |      ;  
	bcs func_81D490                      ;81D479|B015    |C1D490;  
	rep #$20                             ;81D47B|C220    |      ;  
	ldy.b #$92                           ;81D47D|A092    |      ;  
	jsr.w func_81D72F                    ;81D47F|202FD7  |C1D72F;  
	cpx.b #$0A                           ;81D482|E00A    |      ;  
	bcc func_81D48B                      ;81D484|9005    |C1D48B;  
	sta.w $064A,x                        ;81D486|9D4A06  |00064A;  
	bra func_81D48E                      ;81D489|8003    |C1D48E;  
...
func_81D490:
	lda.b $94                            ;81D490|A594    |000094;  
	cmp.b #$11                           ;81D492|C911    |      ;  
	bcs func_81D49C                      ;81D494|B006    |C1D49C;  
	inc.b $92                            ;81D496|E692    |000092;  
	inc.b $93                            ;81D498|E693    |000093;  
	inc.b $94                            ;81D49A|E694    |000094;  

func_81D49C:
	dex                                  ;81D49C|CA      |      ;  
	dex                                  ;81D49D|CA      |      ;  
	bpl func_81D477                      ;81D49E|10D7    |C1D477;  
	lda.b $96                            ;81D4A0|A596    |000096;  
	cmp.b #$2A                           ;81D4A2|C92A    |      ;  
	bcc func_81D4A9                      ;81D4A4|9003    |C1D4A9;  
	jsr.w func_81D4D5                    ;81D4A6|20D5D4  |C1D4D5;  

func_81D4A9:
	jsr.w func_81D723                    ;81D4A9|2023D7  |C1D723;  
	jsr.w func_81DB47                    ;81D4AC|2047DB  |C1DB47;  
	inc.b $96                            ;81D4AF|E696    |000096;  
	inc.b $96                            ;81D4B1|E696    |000096;  
	lda.b $96                            ;81D4B3|A596    |000096;  
	cmp.b #$54                           ;81D4B5|C954    |      ;  
	bcc func_81D465                      ;81D4B7|90AC    |C1D465;  

func_81D4B9:
	jsr.w func_81D157                    ;81D4B9|2057D1  |C1D157;  
	bcc func_81D4C1                      ;81D4BC|9003    |C1D4C1;  
	db $28,$38,$60                       ;81D4BE|        |      ;  
...
func_81D4C1:
	...
	plp                                  ;81D4CB|28      |      ;  
	bcc func_81D4B9                      ;81D4CC|90EB    |C1D4B9;  
	plp                                  ;81D4CE|28      |      ;  
	clc                                  ;81D4CF|18      |      ;  
	rts                                  ;81D4D0|60      |      ;  
...
func_81D4D5:
	php                                  ;81D4D5|08      |      ;  
	sep #$30                             ;81D4D6|E230    |      ;  
	lda.b $7D                            ;81D4D8|A57D    |00007D;  
	cmp.b #$9E                           ;81D4DA|C99E    |      ;  
	bcs func_81D526                      ;81D4DC|B048    |C1D526;  
	lda.b #$14                           ;81D4DE|A914    |      ;  
	stz.b $79                            ;81D4E0|6479    |000079;  
	stz.b $7A                            ;81D4E2|647A    |00007A;  
	sta.b $7B                            ;81D4E4|857B    |00007B;  
	ldx.b $7D                            ;81D4E6|A67D    |00007D;  

func_81D4E8:
	cpx.b #$88                           ;81D4E8|E088    |      ;  
	bcs func_81D503                      ;81D4EA|B017    |C1D503;  
	rep #$20                             ;81D4EC|C220    |      ;  
	ldy.b #$79                           ;81D4EE|A079    |      ;  
	jsr.w func_81D72F                    ;81D4F0|202FD7  |C1D72F;  
	sta.w $067C,x                        ;81D4F3|9D7C06  |00067C;  
	cpx.b #$3C                           ;81D4F6|E03C    |      ;  
	bcc func_81D501                      ;81D4F8|9007    |C1D501;  
	cpx.b #$4A                           ;81D4FA|E04A    |      ;  
	bcs func_81D501                      ;81D4FC|B003    |C1D501;  
...
func_81D503:
	lda.b $79                            ;81D503|A579    |000079;  
	cmp.b #$0B                           ;81D505|C90B    |      ;  
	bcs func_81D50F                      ;81D507|B006    |C1D50F;  
	inc.b $79                            ;81D509|E679    |000079;  
	inc.b $7A                            ;81D50B|E67A    |00007A;  
	inc.b $7B                            ;81D50D|E67B    |00007B;  
...
func_81D50F:
	...
	tax                                  ;81D513|AA      |      ;  
	bcs func_81D4E8                      ;81D514|B0D2    |C1D4E8;  
	lda.b $7D                            ;81D516|A57D    |00007D;  
	cmp.b #$3C                           ;81D518|C93C    |      ;  
	bcc func_81D51F                      ;81D51A|9003    |C1D51F;  
	jsr.w func_81D27E                    ;81D51C|207ED2  |C1D27E;  

func_81D51F:
	inc.b $7D                            ;81D51F|E67D    |00007D;  
	inc.b $7D                            ;81D521|E67D    |00007D;  
	plp                                  ;81D523|28      |      ;  
	clc                                  ;81D524|18      |      ;  
	rts                                  ;81D525|60      |      ;  
...
func_81D529:
	...
	sta.b $9C                            ;81D52F|859C    |00009C;  
	sta.b $9E                            ;81D531|859E    |00009E;  
	...
	sta.b $92                            ;81D575|8592    |000092;  

func_81D577:
	jsr.w func_81D157                    ;81D577|2057D1  |C1D157;  
	bcc func_81D57F                      ;81D57A|9003    |C1D57F;  
	db $28,$38,$60                       ;81D57C|        |      ;  

func_81D57F:
	ldy.w #$0000                         ;81D57F|A00000  |      ;  
	stz.b $96                            ;81D582|6496    |000096;  
	stz.b $98                            ;81D584|6498    |000098;  
	stz.b $9A                            ;81D586|649A    |00009A;  

func_81D588:
	tyx                                  ;81D588|BB      |      ;  
	lda.l DATA8_81D671,x                 ;81D589|BF71D681|81D671;  
	tax                                  ;81D58D|AA      |      ;  
	sta.b $94                            ;81D58E|8594    |000094;  
	and.w #$001F                         ;81D590|291F00  |      ;  
	sta.b $79                            ;81D593|8579    |000079;  
	txa                                  ;81D595|8A      |      ;  
	...
	asl a                                ;81D59B|0A      |      ;  
	xba                                  ;81D59C|EB      |      ;  
	sta.b $7B                            ;81D59D|857B    |00007B;  
	txa                                  ;81D59F|8A      |      ;  
	and.w #$7C00                         ;81D5A0|29007C  |      ;  
	xba                                  ;81D5A3|EB      |      ;  
	lsr a                                ;81D5A4|4A      |      ;  
	lsr a                                ;81D5A5|4A      |      ;  
	sta.b $7D                            ;81D5A6|857D    |00007D;  
	lda.w $062C,y                        ;81D5A8|B92C06  |00062C;  
	tax                                  ;81D5AB|AA      |      ;  
	and.w #$001F                         ;81D5AC|291F00  |      ;  
	sta.b $7F                            ;81D5AF|857F    |00007F;  
	txa                                  ;81D5B1|8A      |      ;  
	...
	asl a                                ;81D5B7|0A      |      ;  
	xba                                  ;81D5B8|EB      |      ;  
	sta.b $81                            ;81D5B9|8581    |000081;  
	txa                                  ;81D5BB|8A      |      ;  
	and.w #$7C00                         ;81D5BC|29007C  |      ;  
	xba                                  ;81D5BF|EB      |      ;  
	lsr a                                ;81D5C0|4A      |      ;  
	lsr a                                ;81D5C1|4A      |      ;  
	sta.b $83                            ;81D5C2|8583    |000083;  
	txa                                  ;81D5C4|8A      |      ;  
	cmp.b $94                            ;81D5C5|C594    |000094;  
	bne func_81D5CC                      ;81D5C7|D003    |C1D5CC;  
	jmp.w func_81D63E                    ;81D5C9|4C3ED6  |C1D63E;  

func_81D5CC:
	stz.b $94                            ;81D5CC|6494    |000094;  
	lda.b $79                            ;81D5CE|A579    |000079;  
	cmp.b $7F                            ;81D5D0|C57F    |00007F;  
	beq func_81D5E2                      ;81D5D2|F00E    |C1D5E2;  
	bcs func_81D5DA                      ;81D5D4|B004    |C1D5DA;  
	dec.b $7F                            ;81D5D6|C67F    |00007F;  
	bra func_81D5DC                      ;81D5D8|8002    |C1D5DC;  

func_81D5DA:
	inc.b $7F                            ;81D5DA|E67F    |00007F;  

func_81D5DC:
	lda.b $79                            ;81D5DC|A579    |000079;  
	cmp.b $7F                            ;81D5DE|C57F    |00007F;  
	bne func_81D5EA                      ;81D5E0|D008    |C1D5EA;  

func_81D5E2:
	lda.b $96                            ;81D5E2|A596    |000096;  
	bne func_81D5E8                      ;81D5E4|D002    |C1D5E8;  
	inc.b $96                            ;81D5E6|E696    |000096;  

func_81D5E8:
	inc.b $94                            ;81D5E8|E694    |000094;  

func_81D5EA:
	lda.b $7B                            ;81D5EA|A57B    |00007B;  
	cmp.b $81                            ;81D5EC|C581    |000081;  
	beq func_81D5FE                      ;81D5EE|F00E    |C1D5FE;  
	bcs func_81D5F6                      ;81D5F0|B004    |C1D5F6;  
	dec.b $81                            ;81D5F2|C681    |000081;  
	bra func_81D5F8                      ;81D5F4|8002    |C1D5F8;  

func_81D5F6:
	inc.b $81                            ;81D5F6|E681    |000081;  

func_81D5F8:
	lda.b $7B                            ;81D5F8|A57B    |00007B;  
	cmp.b $81                            ;81D5FA|C581    |000081;  
	bne func_81D606                      ;81D5FC|D008    |C1D606;  

func_81D5FE:
	lda.b $98                            ;81D5FE|A598    |000098;  
	bne func_81D604                      ;81D600|D002    |C1D604;  
	inc.b $98                            ;81D602|E698    |000098;  

func_81D604:
	inc.b $94                            ;81D604|E694    |000094;  

func_81D606:
	lda.b $7D                            ;81D606|A57D    |00007D;  
	cmp.b $83                            ;81D608|C583    |000083;  
	beq func_81D61A                      ;81D60A|F00E    |C1D61A;  
	bcs func_81D612                      ;81D60C|B004    |C1D612;  
	dec.b $83                            ;81D60E|C683    |000083;  
	bra func_81D614                      ;81D610|8002    |C1D614;  

func_81D612:
	inc.b $83                            ;81D612|E683    |000083;  

func_81D614:
	lda.b $7D                            ;81D614|A57D    |00007D;  
	cmp.b $83                            ;81D616|C583    |000083;  
	bne func_81D622                      ;81D618|D008    |C1D622;  

func_81D61A:
	lda.b $9A                            ;81D61A|A59A    |00009A;  
	bne func_81D620                      ;81D61C|D002    |C1D620;  
	inc.b $9A                            ;81D61E|E69A    |00009A;  

func_81D620:
	inc.b $94                            ;81D620|E694    |000094;  

func_81D622:
	lda.b $94                            ;81D622|A594    |000094;  
	cmp.w #$0003                         ;81D624|C90300  |      ;  
	bne func_81D62B                      ;81D627|D002    |C1D62B;  
	inc.b $92                            ;81D629|E692    |000092;  
...
func_81D62B:
	...
	bne func_81D63E                      ;81D639|D003    |C1D63E;  
...
func_81D63E:
	...
	bcs func_81D648                      ;81D643|B003    |C1D648;  
...
func_81D648:
	...
	lda.b $92                            ;81D657|A592    |000092;  
	cmp.w #$0014                         ;81D659|C91400  |      ;  
	bcs func_81D661                      ;81D65C|B003    |C1D661;  
...
func_81D661:
	...
	plp                                  ;81D668|28      |      ;  
	bcc func_81D661                      ;81D669|90F6    |C1D661;  
	plp                                  ;81D66B|28      |      ;  
	clc                                  ;81D66C|18      |      ;  
	rts                                  ;81D66D|60      |      ;  
	db $28,$38,$60                       ;81D66E|        |      ;
...
func_81D6CC:
	...
	dey                                  ;81D6D2|88      |      ;  
	dey                                  ;81D6D3|88      |      ;  
	bpl func_81D6CC                      ;81D6D4|10F6    |C1D6CC;  
	rts                                  ;81D6D6|60      |      ;  
...
func_81D6DA:
	...
	beq func_81D6FB                      ;81D6DD|F01C    |C1D6FB;  
	clc                                  ;81D6DF|18      |      ;  
	adc.w #$0004                         ;81D6E0|690400  |      ;  
	cpx.w #$0020                         ;81D6E3|E02000  |      ;  
	bne func_81D6EF                      ;81D6E6|D007    |C1D6EF;  
	pha                                  ;81D6E8|48      |      ;  
	and.w #$FE00                         ;81D6E9|2900FE  |      ;  
	bne func_81D71A                      ;81D6EC|D02C    |C1D71A;  
	pla                                  ;81D6EE|68      |      ;  

func_81D6EF:
	and.w #$01FF                         ;81D6EF|29FF01  |      ;  
	bra func_81D6F8                      ;81D6F2|8004    |C1D6F8;  
...
func_81D6FB:
	...
	beq func_81D711                      ;81D700|F00F    |C1D711;  
	sec                                  ;81D702|38      |      ;  
	sbc.w #$0004                         ;81D703|E90400  |      ;  
	and.w #$01FF                         ;81D706|29FF01  |      ;  
	bra func_81D70E                      ;81D709|8003    |C1D70E;  
	db $A9,$00,$00                       ;81D70B|        |      ;  
...
func_81D711:
	...
	bcc func_81D6DA                      ;81D716|90C2    |C1D6DA;  
	clc                                  ;81D718|18      |      ;  
	rts                                  ;81D719|60      |      ;  
...
func_81D723:
	...
	tsb.b $88                            ;81D72B|0488    |000088;  
	plp                                  ;81D72D|28      |      ;  
	rts                                  ;81D72E|60      |      ;  

func_81D72F:
	lda.w $0002,y                        ;81D72F|B90200  |000002;  
	and.w #$001F                         ;81D732|291F00  |      ;  
	xba                                  ;81D735|EB      |      ;  
	asl a                                ;81D736|0A      |      ;  
	asl a                                ;81D737|0A      |      ;  
	sta.b $85                            ;81D738|8585    |000085;  
	lda.w $0001,y                        ;81D73A|B90100  |000001;  
	and.w #$001F                         ;81D73D|291F00  |      ;  
	xba                                  ;81D740|EB      |      ;  
	lsr a                                ;81D741|4A      |      ;  
	lsr a                                ;81D742|4A      |      ;  
	lsr a                                ;81D743|4A      |      ;  
	ora.b $85                            ;81D744|0585    |000085;  
	sta.b $85                            ;81D746|8585    |000085;  
	lda.w $0000,y                        ;81D748|B90000  |000000;  
	and.w #$001F                         ;81D74B|291F00  |      ;  
	ora.b $85                            ;81D74E|0585    |000085;  
	rts                                  ;81D750|60      |      ;  

func_81D751:
	lda.w $0004,y                        ;81D751|B90400  |000004;  
	and.w #$001F                         ;81D754|291F00  |      ;  
	xba                                  ;81D757|EB      |      ;  
	asl a                                ;81D758|0A      |      ;  
	asl a                                ;81D759|0A      |      ;  
	sta.b $85                            ;81D75A|8585    |000085;  
	lda.w $0002,y                        ;81D75C|B90200  |000002;  
	and.w #$001F                         ;81D75F|291F00  |      ;  
	xba                                  ;81D762|EB      |      ;  
	lsr a                                ;81D763|4A      |      ;  
	lsr a                                ;81D764|4A      |      ;  
	lsr a                                ;81D765|4A      |      ;  
	ora.b $85                            ;81D766|0585    |000085;  
	sta.b $85                            ;81D768|8585    |000085;  
	lda.w $0000,y                        ;81D76A|B90000  |000000;  
	and.w #$001F                         ;81D76D|291F00  |      ;  
	ora.b $85                            ;81D770|0585    |000085;  
	rts                                  ;81D772|60      |      ;  
...
func_81D773:
	...
	sta.b $91                            ;81D778|8591    |000091;  
	lda.b #$0D                           ;81D77A|A90D    |      ;  
	sta.w $008D                          ;81D77C|8D8D00  |00008D;  
	rep #$30                             ;81D77F|C230    |      ;  
...
func_81D78E:
	...
	dex                                  ;81D791|CA      |      ;  
	bpl func_81D78E                      ;81D792|10FA    |C1D78E;  
...
func_81D797:
	...
	bpl func_81D7B1                      ;81D79E|1011    |C1D7B1;  
	iny                                  ;81D7A0|C8      |      ;  
	iny                                  ;81D7A1|C8      |      ;  
...
func_81D7A4:
	...
	bcc func_81D7A4                      ;81D7AB|90F7    |C1D7A4;  
	inx                                  ;81D7AD|E8      |      ;  
	dey                                  ;81D7AE|88      |      ;  
	bra func_81D797                      ;81D7AF|80E6    |C1D797;  
...
func_81D7B1:
	...
	bne func_81D797                      ;81D7B7|D0DE    |C1D797;  
	rep #$30                             ;81D7B9|C230    |      ;  
...
func_81D7CA:
	...
	bcc func_81D7CA                      ;81D7D2|90F6    |C1D7CA;  
	plp                                  ;81D7D4|28      |      ;  
	rts                                  ;81D7D5|60      |      ;
...
func_81D7E1:
	...
	sta.b $89                            ;81D7EB|8589    |000089;  
	sta.w INIDISP                          ;81D7ED|8D0021  |002100;  
	ldx.w #$0079                         ;81D7F0|A27900  |      ;  

func_81D7F3:
	stz.b $00,x                          ;81D7F3|7400    |000000;  
	inx                                  ;81D7F5|E8      |      ;  
	cpx.w #$00A9                         ;81D7F6|E0A900  |      ;  
	bne func_81D7F3                      ;81D7F9|D0F8    |C1D7F3;  
	ldx.w #$1040                         ;81D7FB|A24010  |      ;  

func_81D7FE:
	stz.b $00,x                          ;81D7FE|7400    |000000;  
	inx                                  ;81D800|E8      |      ;  
	cpx.w #$1144                         ;81D801|E04411  |      ;  
	bne func_81D7FE                      ;81D804|D0F8    |C1D7FE;  
...
func_81D814:
	...
	dex                                  ;81D81A|CA      |      ;  
	bpl func_81D814                      ;81D81B|10F7    |C1D814;  
	ldx.w #$0010                         ;81D81D|A21000  |      ;  

func_81D820:
	stz.w W12SEL,x                        ;81D820|9E2321  |002123;  
	dex                                  ;81D823|CA      |      ;  
	bpl func_81D820                      ;81D824|10FA    |C1D820;  
...
func_81D892:
	...
	pha                                  ;81D89F|48      |      ;  
	plb                                  ;81D8A0|AB      |      ;  
	lda.b $88                            ;81D8A1|A588    |000088;  
	lsr a                                ;81D8A3|4A      |      ;  
	bcc func_81D8CA                      ;81D8A4|9024    |C1D8CA;  
	lda.b $88                            ;81D8A6|A588    |000088;  
	and.b #$FE                           ;81D8A8|29FE    |      ;  
	sta.b $88                            ;81D8AA|8588    |000088;  
	bit.b $88                            ;81D8AC|2488    |000088;  
	bmi func_81D8CA                      ;81D8AE|301A    |C1D8CA;  
	jsr.w func_81D8D5                    ;81D8B0|20D5D8  |C1D8D5;  
	jsr.w func_81D8F3                    ;81D8B3|20F3D8  |C1D8F3;  
	jsr.w func_81D9EB                    ;81D8B6|20EBD9  |C1D9EB;  
	stz.b $88                            ;81D8B9|6488    |000088;  
	jsr.w func_81D9F4                    ;81D8BB|20F4D9  |C1D9F4;  
	lda.b $89                            ;81D8BE|A589    |000089;  
	sta.w INIDISP                          ;81D8C0|8D0021  |002100;  
	lda.b $8A                            ;81D8C3|A58A    |00008A;  
...
func_81D901:
	...
	sta.b $8B                            ;81D905|858B    |00008B;  
	inx                                  ;81D907|E8      |      ;  
	lda.l $7E34BC,x                      ;81D908|BFBC347E|7E34BC;  
	inx                                  ;81D90C|E8      |      ;  
	bit.b $8B                            ;81D90D|248B    |00008B;  
	bvs func_81D988                      ;81D90F|7077    |C1D988;  
...
func_81D97A:
	...
	bne func_81D901                      ;81D97F|D080    |C1D901;  
...
func_81D988:
	...
	bit.b $8B                            ;81D98E|248B    |00008B;  
	bpl func_81D99D                      ;81D990|100B    |C1D99D;  
	rep #$20                             ;81D992|C220    |      ;  
...
func_81D99D:
	lda.b $8B                            ;81D99D|A58B    |00008B;  
	and.b #$10                           ;81D99F|2910    |      ;  
	bne UNREACH_C1D9BD                   ;81D9A1|D01A    |C1D9BD;  
	jsr.w func_81D9D4                    ;81D9A3|20D4D9  |C1D9D4;  
	lda.b $8B                            ;81D9A6|A58B    |00008B;  
	lsr a                                ;81D9A8|4A      |      ;  
	...
	bra func_81D97A                      ;81D9BB|80BD    |C1D97A;  
...
func_81D9D4:
	php                                  ;81D9D4|08      |      ;  
	rep #$20                             ;81D9D5|C220    |      ;  
	stx.b $8C                            ;81D9D7|868C    |00008C;  
	lda.w #$34BC                         ;81D9D9|A9BC34  |      ;  
	clc                                  ;81D9DC|18      |      ;  
	adc.b $8C                            ;81D9DD|658C    |00008C;  
...
func_81DA31:
	...
	php                                  ;81DA32|08      |      ;  
	sep #$20                             ;81DA33|E220    |      ;  
	lda.b $89                            ;81DA35|A589    |000089;  
	and.b #$7F                           ;81DA37|297F    |      ;  

func_81DA39:
	sta.b $89                            ;81DA39|8589    |000089;  
...
func_81DA41:
	...
	php                                  ;81DA42|08      |      ;  
	sep #$20                             ;81DA43|E220    |      ;  
	lda.b $89                            ;81DA45|A589    |000089;  
	and.b #$0F                           ;81DA47|290F    |      ;  
	bcc func_81DA50                      ;81DA49|9005    |C1DA50;  
	beq func_81DA57                      ;81DA4B|F00A    |C1DA57;  
	dec a                                ;81DA4D|3A      |      ;  
	bra func_81DA57                      ;81DA4E|8007    |C1DA57;  

func_81DA50:
	inc a                                ;81DA50|1A      |      ;  
	cmp.b #$0F                           ;81DA51|C90F    |      ;  
	bcc func_81DA57                      ;81DA53|9002    |C1DA57;  
...
func_81DA7A:
	...
	dey                                  ;81DA80|88      |      ;  
	bne func_81DA7A                      ;81DA81|D0F7    |C1DA7A;  
	plp                                  ;81DA83|28      |      ;  
	ply                                  ;81DA84|7A      |      ;  
	plx                                  ;81DA85|FA      |      ;  
	pla                                  ;81DA86|68      |      ;  
...
func_81DA96:
	...
	dex                                  ;81DA9E|CA      |      ;  
	dex                                  ;81DA9F|CA      |      ;  
	bpl func_81DA96                      ;81DAA0|10F4    |C1DA96;  
...
func_81DAA5:
	...
	bcc func_81DAA5                      ;81DAAD|90F6    |C1DAA5;  
	plp                                  ;81DAAF|28      |      ;  
	ply                                  ;81DAB0|7A      |      ;  
	plx                                  ;81DAB1|FA      |      ;  
	pla                                  ;81DAB2|68      |      ;  
...
func_81DAB4:
	...
	sta.b $86                            ;81DAC4|8586    |000086;  
	inx                                  ;81DAC6|E8      |      ;  
	lda.b $8D                            ;81DAC7|A58D    |00008D;  
	sta.l $7E34BC,x                      ;81DAC9|9FBC347E|7E34BC;  
	inx                                  ;81DACD|E8      |      ;  
	bit.b $86                            ;81DACE|2486    |000086;  
	bvs func_81DAD9                      ;81DAD0|7007    |C1DAD9;  
	db $A5,$8E,$9F,$BC,$34,$7E,$E8       ;81DAD2|        |00008E;  

func_81DAD9:
	bit.b $86                            ;81DAD9|2486    |000086;  
	bpl UNREACH_C1DB09                   ;81DADB|102C    |C1DB09;  
	rep #$20                             ;81DADD|C220    |      ;  
	tya                                  ;81DADF|98      |      ;  
	...
	inx                                  ;81DAE5|E8      |      ;  
	sep #$20                             ;81DAE6|E220    |      ;  
	lda.b $86                            ;81DAE8|A586    |000086;  
	and.b #$10                           ;81DAEA|2910    |      ;  
	bne UNREACH_C1DB09                   ;81DAEC|D01B    |C1DB09;  
	sty.b $87                            ;81DAEE|8487    |000087;  
	lda.b $91                            ;81DAF0|A591    |000091;  
	pha                                  ;81DAF2|48      |      ;  
	plb                                  ;81DAF3|AB      |      ;  
	rep #$20                             ;81DAF4|C220    |      ;  
...
func_81DAF9:
	...
	iny                                  ;81DAFF|C8      |      ;  
	inx                                  ;81DB00|E8      |      ;  
	dec.b $87                            ;81DB01|C687    |000087;  
	bne func_81DAF9                      ;81DB03|D0F4    |C1DAF9;  
	sep #$20                             ;81DB05|E220    |      ;  
	bra func_81DB17                      ;81DB07|800E    |C1DB17;  
...
func_81DB29:
	...
	sep #$20                             ;81DB2D|E220    |      ;  
	rep #$10                             ;81DB2F|C210    |      ;  
	stz.b $8D                            ;81DB31|648D    |00008D;  
	ldx.w #$062C                         ;81DB33|A22C06  |      ;  
	stx.b $8F                            ;81DB36|868F    |00008F;  
	stz.b $91                            ;81DB38|6491    |000091;  
...
func_81DB5E:
	...
	bcs func_81DB69                      ;81DB61|B006    |C1DB69;  
	jsr.w func_81DB47                    ;81DB63|2047DB  |C1DB47;  
	dex                                  ;81DB66|CA      |      ;  
	bne func_81DB5E                      ;81DB67|D0F5    |C1DB5E;  
...
func_81DB6B:
	...
	and.b $8A                            ;81DB84|258A    |00008A;  
	sta.b $8A                            ;81DB86|858A    |00008A;  
	sta.w HDMAEN                          ;81DB88|8D0C42  |00420C;  
	rep #$20                             ;81DB8B|C220    |      ;  
	pla                                  ;81DB8D|68      |      ;  
	sep #$20                             ;81DB8E|E220    |      ;  
	sta.w DMAP0,y                        ;81DB90|990043  |004300;  
	lda.b $91                            ;81DB93|A591    |000091;  
	sta.w A1B0,y                        ;81DB95|990443  |004304;  
	lda.b $8D                            ;81DB98|A58D    |00008D;  
...
func_81DBC3:
	rol a                                ;81DBC3|2A      |      ;  
	dex                                  ;81DBC4|CA      |      ;  
	bpl func_81DBC3                      ;81DBC5|10FC    |C1DBC3;  
	plp                                  ;81DBC7|28      |      ;  
	plx                                  ;81DBC8|FA      |      ;  
	rts                                  ;81DBC9|60      |      ;  
